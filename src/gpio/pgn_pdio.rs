#[doc = "Register `PGn_PDIO` reader"]
pub struct R(crate::R<PGN_PDIO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PGN_PDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PGN_PDIO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PGN_PDIO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PGn_PDIO` writer"]
pub struct W(crate::W<PGN_PDIO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PGN_PDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PGN_PDIO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PGN_PDIO_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPIO PG.n Pin Data Input/Output Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pgn_pdio](index.html) module"]
pub struct PGN_PDIO_SPEC;
impl crate::RegisterSpec for PGN_PDIO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pgn_pdio::R](R) reader structure"]
impl crate::Readable for PGN_PDIO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pgn_pdio::W](W) writer structure"]
impl crate::Writable for PGN_PDIO_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PGn_PDIO to value 0"]
impl crate::Resettable for PGN_PDIO_SPEC {
    #[inline(always)]
