...
impl From<crate::R<GPIO_DBCTL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<GPIO_DBCTL_SPEC>> for W {
    #[inline(always)]
...
pub enum DBCLKSRC_A {
    ...
    _0 = 0,
    #[doc = "1: De-bounce counter clock source is the 38.4 kHz internal low speed RC oscillator (LIRC)"]
    _1 = 1,
}
...
impl<'a> DBCLKSRC_W<'a> {
    ...
    #[doc = "De-bounce counter clock source is the 38.4 kHz internal low speed RC oscillator (LIRC)"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 5 - Interrupt Clock on Mode Note: It is recommended to disable this bit to save system power if no special application concern."]
    #[inline(always)]
