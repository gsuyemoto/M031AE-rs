#[doc = "Register `PC_INTTYPE` reader"]
pub struct R(crate::R<PC_INTTYPE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PC_INTTYPE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PC_INTTYPE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PC_INTTYPE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PC_INTTYPE` writer"]
pub struct W(crate::W<PC_INTTYPE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PC_INTTYPE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PC_INTTYPE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PC_INTTYPE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Port A-H Pin\\[n\\]
...
#[doc = "Field `TYPE0` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE0` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE1` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE1` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE2` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE2` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE3` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE3` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE4` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE4` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE5` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE5` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE6` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE6` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE7` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE7` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE8` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE8` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE9` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE9` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE10` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE10` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE11` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE11` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE12` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE12` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE13` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE13` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE14` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE14` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE15` reader - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `TYPE15` writer - Port A-H Pin\\[n\\]
Edge or Level Detection Interrupt Trigger Type Control\nTYPE (Px_INTTYPE\\[n\\]) bit is used to control the triggered interrupt is by level trigger or by edge trigger. If the interrupt is by edge trigger, the trigger source can be controlled by de-bounce. If the interrupt is by level trigger, the input source is sampled by one HCLK clock and generates the interrupt.\nIf the pin is set as the level trigger interrupt, only one level can be set on the registers RHIEN (Px_INTEN\\[n+16\\])/FLIEN (Px_INTEN\\[n\\]). If both levels to trigger interrupt are set, the setting is ignored and no interrupt will occur.\nThe de-bounce function is valid only for edge triggered interrupt. If the interrupt mode is level triggered, the de-bounce enable bit is ignored.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "PC Interrupt Trigger Type Control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pc_inttype](index.html) module"]
pub struct PC_INTTYPE_SPEC;
impl crate::RegisterSpec for PC_INTTYPE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pc_inttype::R](R) reader structure"]
impl crate::Readable for PC_INTTYPE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pc_inttype::W](W) writer structure"]
impl crate::Writable for PC_INTTYPE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PC_INTTYPE to value 0"]
impl crate::Resettable for PC_INTTYPE_SPEC {
    #[inline(always)]
