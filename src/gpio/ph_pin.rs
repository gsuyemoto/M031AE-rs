#[doc = "Register `PH_PIN` reader"]
pub struct R(crate::R<PH_PIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PH_PIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PH_PIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PH_PIN_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "PH Pin Value\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ph_pin](index.html) module"]
pub struct PH_PIN_SPEC;
impl crate::RegisterSpec for PH_PIN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ph_pin::R](R) reader structure"]
impl crate::Readable for PH_PIN_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PH_PIN to value 0"]
impl crate::Resettable for PH_PIN_SPEC {
    #[inline(always)]
