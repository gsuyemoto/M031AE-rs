#[doc = "Register `PE_PIN` reader"]
pub struct R(crate::R<PE_PIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PE_PIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PE_PIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PE_PIN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `PIN0` reader - Port A-H Pin\\[n\\]
...
#[doc = "Field `PIN1` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN2` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN3` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN4` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN5` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN6` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN7` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN8` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN9` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN10` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN11` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN12` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN13` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN14` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
#[doc = "Field `PIN15` reader - Port A-H Pin\\[n\\]
Pin Value\nEach bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low.\nNote: \nThe PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
...
Pin Value Each bit of the register reflects the actual status of the respective Px.n pin. If the bit is 1, it indicates the corresponding pin status is high; else the pin status is low. Note: The PC.15/PF.12~13/PG.0~1,5~8/PH.0~3,12~15 pin is ignored."]
    #[inline(always)]
...
#[doc = "PE Pin Value\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pe_pin](index.html) module"]
pub struct PE_PIN_SPEC;
impl crate::RegisterSpec for PE_PIN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pe_pin::R](R) reader structure"]
impl crate::Readable for PE_PIN_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PE_PIN to value 0"]
impl crate::Resettable for PE_PIN_SPEC {
    #[inline(always)]
