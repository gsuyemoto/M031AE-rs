#[doc = "Register `PF_PIN` reader"]
pub struct R(crate::R<PF_PIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PF_PIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PF_PIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PF_PIN_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "PF Pin Value\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pf_pin](index.html) module"]
pub struct PF_PIN_SPEC;
impl crate::RegisterSpec for PF_PIN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pf_pin::R](R) reader structure"]
impl crate::Readable for PF_PIN_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PF_PIN to value 0"]
impl crate::Resettable for PF_PIN_SPEC {
    #[inline(always)]
