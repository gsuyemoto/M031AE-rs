#[doc = "Register `PC_MODE` reader"]
pub struct R(crate::R<PC_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PC_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PC_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PC_MODE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PC_MODE` writer"]
pub struct W(crate::W<PC_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PC_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PC_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PC_MODE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PC I/O Mode Control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pc_mode](index.html) module"]
pub struct PC_MODE_SPEC;
impl crate::RegisterSpec for PC_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pc_mode::R](R) reader structure"]
impl crate::Readable for PC_MODE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pc_mode::W](W) writer structure"]
impl crate::Writable for PC_MODE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PC_MODE to value 0"]
impl crate::Resettable for PC_MODE_SPEC {
    #[inline(always)]
