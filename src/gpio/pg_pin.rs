#[doc = "Register `PG_PIN` reader"]
pub struct R(crate::R<PG_PIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PG_PIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PG_PIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PG_PIN_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "PG Pin Value\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pg_pin](index.html) module"]
pub struct PG_PIN_SPEC;
impl crate::RegisterSpec for PG_PIN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pg_pin::R](R) reader structure"]
impl crate::Readable for PG_PIN_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PG_PIN to value 0"]
impl crate::Resettable for PG_PIN_SPEC {
    #[inline(always)]
