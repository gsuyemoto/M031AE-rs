#[doc = "Register `PA4_PDIO` reader"]
pub struct R(crate::R<PA4_PDIO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PA4_PDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PA4_PDIO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PA4_PDIO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PA4_PDIO` writer"]
pub struct W(crate::W<PA4_PDIO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PA4_PDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PA4_PDIO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PA4_PDIO_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPIO PA.n Pin Data Input/Output Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pa4_pdio](index.html) module"]
pub struct PA4_PDIO_SPEC;
impl crate::RegisterSpec for PA4_PDIO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pa4_pdio::R](R) reader structure"]
impl crate::Readable for PA4_PDIO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pa4_pdio::W](W) writer structure"]
impl crate::Writable for PA4_PDIO_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PA4_PDIO to value 0"]
impl crate::Resettable for PA4_PDIO_SPEC {
    #[inline(always)]
