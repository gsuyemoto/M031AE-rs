#[doc = "Register `PF_MODE` reader"]
pub struct R(crate::R<PF_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PF_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PF_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PF_MODE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PF_MODE` writer"]
pub struct W(crate::W<PF_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PF_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PF_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PF_MODE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PF I/O Mode Control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pf_mode](index.html) module"]
pub struct PF_MODE_SPEC;
impl crate::RegisterSpec for PF_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pf_mode::R](R) reader structure"]
impl crate::Readable for PF_MODE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pf_mode::W](W) writer structure"]
impl crate::Writable for PF_MODE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PF_MODE to value 0"]
impl crate::Resettable for PF_MODE_SPEC {
    #[inline(always)]
