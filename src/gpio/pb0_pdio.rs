#[doc = "Register `PB0_PDIO` reader"]
pub struct R(crate::R<PB0_PDIO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PB0_PDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PB0_PDIO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PB0_PDIO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PB0_PDIO` writer"]
pub struct W(crate::W<PB0_PDIO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PB0_PDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PB0_PDIO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PB0_PDIO_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPIO PB.n Pin Data Input/Output Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pb0_pdio](index.html) module"]
pub struct PB0_PDIO_SPEC;
impl crate::RegisterSpec for PB0_PDIO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pb0_pdio::R](R) reader structure"]
impl crate::Readable for PB0_PDIO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pb0_pdio::W](W) writer structure"]
impl crate::Writable for PB0_PDIO_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PB0_PDIO to value 0"]
impl crate::Resettable for PB0_PDIO_SPEC {
    #[inline(always)]
