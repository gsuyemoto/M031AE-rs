#[doc = "Register `PD_MODE` reader"]
pub struct R(crate::R<PD_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PD_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PD_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PD_MODE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PD_MODE` writer"]
pub struct W(crate::W<PD_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PD_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PD_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PD_MODE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PD I/O Mode Control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pd_mode](index.html) module"]
pub struct PD_MODE_SPEC;
impl crate::RegisterSpec for PD_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pd_mode::R](R) reader structure"]
impl crate::Readable for PD_MODE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pd_mode::W](W) writer structure"]
impl crate::Writable for PD_MODE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PD_MODE to value 0"]
impl crate::Resettable for PD_MODE_SPEC {
    #[inline(always)]
