#[doc = "Register `PB_MODE` reader"]
pub struct R(crate::R<PB_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PB_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PB_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PB_MODE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PB_MODE` writer"]
pub struct W(crate::W<PB_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PB_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PB_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PB_MODE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PB I/O Mode Control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pb_mode](index.html) module"]
pub struct PB_MODE_SPEC;
impl crate::RegisterSpec for PB_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pb_mode::R](R) reader structure"]
impl crate::Readable for PB_MODE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pb_mode::W](W) writer structure"]
impl crate::Writable for PB_MODE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PB_MODE to value 0"]
impl crate::Resettable for PB_MODE_SPEC {
    #[inline(always)]
