#[doc = "Register `PE_MODE` reader"]
pub struct R(crate::R<PE_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PE_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PE_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PE_MODE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PE_MODE` writer"]
pub struct W(crate::W<PE_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PE_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PE_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PE_MODE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PE I/O Mode Control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pe_mode](index.html) module"]
pub struct PE_MODE_SPEC;
impl crate::RegisterSpec for PE_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pe_mode::R](R) reader structure"]
impl crate::Readable for PE_MODE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pe_mode::W](W) writer structure"]
impl crate::Writable for PE_MODE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PE_MODE to value 0"]
impl crate::Resettable for PE_MODE_SPEC {
    #[inline(always)]
