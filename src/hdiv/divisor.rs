...
#[doc = "Field `DIVISOR` writer - Divisor Source\nThis register is provided with the divisor of divider before calculation starts.\nNote: When this register is written, hardware divider will start calculation."]
...
impl R {
    #[doc = "Bits 0:15 - Divisor Source This register is provided with the divisor of divider before calculation starts. Note: When this register is written, hardware divider will start calculation."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DIVISOR to value 0xffff"]
