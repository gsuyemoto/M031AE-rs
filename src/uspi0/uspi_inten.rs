#[doc = "Register `USPI_INTEN` reader"]
pub struct R(crate::R<USPI_INTEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USPI_INTEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USPI_INTEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USPI_INTEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USPI_INTEN` writer"]
pub struct W(crate::W<USPI_INTEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USPI_INTEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USPI_INTEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USPI_INTEN_SPEC>) -> Self {
        W(writer)
    }
}
...
impl R {
    #[doc = "Bit 1 - Transmit Start Interrupt Enable Bit This bit enables the interrupt generation in case of a transmit start event. Note: The transmit start event happens when hardware starts to move TX data from data buffer to shift data unit."]
    #[inline(always)]
    pub fn txstien(&self) -> TXSTIEN_R {
        TXSTIEN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Transmit End Interrupt Enable Bit This bit enables the interrupt generation in case of a transmit finish event. Note: The transmit finish event happens when hardware sends the last bit of TX data from shift data unit."]
    #[inline(always)]
    pub fn txendien(&self) -> TXENDIEN_R {
        TXENDIEN_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - Receive Start Interrupt Enable Bit This bit enables the interrupt generation in case of a receive start event. Note: For SPI master mode, the receive start event happens when SPI master sends slave select active and spi clock to the external SPI slave. For SPI slave mode, the receive start event happens when slave select of SPI slave is active and spi clock of SPI slave is inputed from the external SPI master."]
    #[inline(always)]
    pub fn rxstien(&self) -> RXSTIEN_R {
        RXSTIEN_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - Receive End Interrupt Enable Bit This bit enables the interrupt generation in case of a receive finish event. Note: The receive finish event happens when hardware receives the last bit of RX data into shift data unit."]
    #[inline(always)]
...
#[doc = "USCI Interrupt Enable Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uspi_inten](index.html) module"]
pub struct USPI_INTEN_SPEC;
impl crate::RegisterSpec for USPI_INTEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uspi_inten::R](R) reader structure"]
impl crate::Readable for USPI_INTEN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uspi_inten::W](W) writer structure"]
impl crate::Writable for USPI_INTEN_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USPI_INTEN to value 0"]
impl crate::Resettable for USPI_INTEN_SPEC {
    #[inline(always)]
