...
impl From<crate::R<SYS_RSTSTS_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SYS_RSTSTS_SPEC>> for W {
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SYSRF_A {
    #[doc = "0: No reset from Cortex-M0"]
    _0 = 0,
    #[doc = "1: The Cortex- M0 had issued the reset signal to reset the system by writing 1 to the bit SYSRESETREQ(AIRCR\\[2\\], Application Interrupt and Reset Control Register, address = 0xE000ED0C) in system control registers of Cortex-M0 core"]
    _1 = 1,
}
...
impl<'a> SYSRF_W<'a> {
    ...
    #[doc = "No reset from Cortex-M0"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SYSRF_A::_0)
    }
    #[doc = "The Cortex- M0 had issued the reset signal to reset the system by writing 1 to the bit SYSRESETREQ(AIRCR\\[2\\], Application Interrupt and Reset Control Register, address = 0xE000ED0C) in system control registers of Cortex-M0 core"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
pub enum CPURF_A {
    ...
    _0 = 0,
    #[doc = "1: The Cortex-M0 Core and FMC are reset by software setting CPURST to 1"]
    _1 = 1,
}
...
impl<'a> CPURF_W<'a> {
    ...
    #[doc = "The Cortex-M0 Core and FMC are reset by software setting CPURST to 1"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
pub enum CPULKRF_A {
    ...
    _0 = 0,
    #[doc = "1: The Cortex-M0 lockup happened and chip is reset"]
    _1 = 1,
}
...
#[doc = "Field `CPULKRF` reader - CPU Lockup Reset Flag\nNote: Write 1 to clear this bit to 0.\nNote 2: When CPU lockup happened under ICE is connected, This flag will set to 1 but chip will not reset."]
...
#[doc = "Field `CPULKRF` writer - CPU Lockup Reset Flag\nNote: Write 1 to clear this bit to 0.\nNote 2: When CPU lockup happened under ICE is connected, This flag will set to 1 but chip will not reset."]
...
impl<'a> CPULKRF_W<'a> {
    ...
    #[doc = "The Cortex-M0 lockup happened and chip is reset"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - POR Reset Flag The POR reset flag is set by the 'Reset Signal' from the Power-on Reset (POR) Controller or bit CHIPRST (SYS_IPRST0\\[0\\]) to indicate the previous reset source. Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn porf(&self) -> PORF_R {
        PORF_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - NRESET Pin Reset Flag The nRESET pin reset flag is set by the 'Reset Signal' from the nRESET Pin to indicate the previous reset source. Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn pinrf(&self) -> PINRF_R {
        PINRF_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - WDT Reset Flag The WDT reset flag is set by the 'Reset Signal' from the Watchdog Timer or Window Watchdog Timer to indicate the previous reset source. Note 1: Write 1 to clear this bit to 0. Note 2: Watchdog Timer register RSTF(WDT_CTL\\[2\\]) bit is set if the system has been reset by WDT time-out reset. Window Watchdog Timer register WWDTRF(WWDT_STATUS\\[1\\]) bit is set if the system has been reset by WWDT time-out reset."]
    #[inline(always)]
    pub fn wdtrf(&self) -> WDTRF_R {
        WDTRF_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - LVR Reset Flag The LVR reset flag is set by the 'Reset Signal' from the Low Voltage Reset Controller to indicate the previous reset source. Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn lvrf(&self) -> LVRF_R {
        LVRF_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - BOD Reset Flag The BOD reset flag is set by the 'Reset Signal' from the Brown-Out Detector to indicate the previous reset source. Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn bodrf(&self) -> BODRF_R {
        BODRF_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - System Reset Flag The system reset flag is set by the 'Reset Signal' from the Cortex-M0 Core to indicate the previous reset source. Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn sysrf(&self) -> SYSRF_R {
        SYSRF_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 7 - CPU Reset Flag The CPU reset flag is set by hardware if software writes CPURST (SYS_IPRST0\\[1\\]) 1 to reset Cortex- M0 Core and Flash Memory Controller (FMC). Note: Write to clear this bit to 0."]
    #[inline(always)]
    pub fn cpurf(&self) -> CPURF_R {
        CPURF_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    #[doc = "Bit 8 - CPU Lockup Reset Flag Note: Write 1 to clear this bit to 0. Note 2: When CPU lockup happened under ICE is connected, This flag will set to 1 but chip will not reset."]
    #[inline(always)]
