...
impl From<crate::R<SYS_BODCTL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SYS_BODCTL_SPEC>> for W {
    #[inline(always)]
...
#[repr(u8)]
pub enum BODDGSEL_A {
    #[doc = "0: BOD output is sampled by LIRC/4 clock"]
    _0 = 0,
    #[doc = "1: 64 system clock (HCLK)"]
    _1 = 1,
    #[doc = "2: 128 system clock (HCLK)"]
    _2 = 2,
    #[doc = "3: 256 system clock (HCLK)"]
    _3 = 3,
    #[doc = "4: 512 system clock (HCLK)"]
    _4 = 4,
    #[doc = "5: 1024 system clock (HCLK)"]
    _5 = 5,
    #[doc = "6: 2048 system clock (HCLK)"]
    _6 = 6,
    #[doc = "7: 4096 system clock (HCLK)"]
    _7 = 7,
}
...
impl<'a> BODDGSEL_W<'a> {
    ...
    #[doc = "BOD output is sampled by LIRC/4 clock"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
    ...
    #[doc = "512 system clock (HCLK)"]
    #[inline(always)]
    pub fn _4(self) -> &'a mut W {
        self.variant(BODDGSEL_A::_4)
    }
    #[doc = "1024 system clock (HCLK)"]
    #[inline(always)]
    pub fn _5(self) -> &'a mut W {
        self.variant(BODDGSEL_A::_5)
    }
    #[doc = "2048 system clock (HCLK)"]
    #[inline(always)]
    pub fn _6(self) -> &'a mut W {
        self.variant(BODDGSEL_A::_6)
    }
    #[doc = "4096 system clock (HCLK)"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BODVL_A {
    #[doc = "0: Brown-Out Detector threshold voltage is 2.0V"]
    _0 = 0,
    #[doc = "1: Brown-Out Detector threshold voltage is 2.5V"]
    _1 = 1,
}
impl From<BODVL_A> for bool {
    #[inline(always)]
...
pub struct BODVL_R(crate::FieldReader<bool, BODVL_A>);
impl BODVL_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for BODVL_R {
    type Target = crate::FieldReader<bool, BODVL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> BODVL_W<'a> {
    ...
    #[doc = "Brown-Out Detector threshold voltage is 2.0V"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(BODVL_A::_0)
    }
    #[doc = "Brown-Out Detector threshold voltage is 2.5V"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "LVR Detector Threshold Voltage Selection (Write Protect)\nThe default value is set by Flash controller user configuration register LVRLVSEL (CONFIG0 \\[29\\]).\nNote 1: This bit is write protected. Refer to the SYS_REGLCTL register.\nNote 2: This bit is only for special case.\nNote 3: reset by powr on reset\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LVRVL_A {
    #[doc = "0: LVR-Out Detector threshold voltage is 1.6V"]
    _0 = 0,
    #[doc = "1: LVR-Out Detector threshold voltage is 1.7V"]
    _1 = 1,
}
impl From<LVRVL_A> for bool {
    #[inline(always)]
    fn from(variant: LVRVL_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `LVRVL` reader - LVR Detector Threshold Voltage Selection (Write Protect)\nThe default value is set by Flash controller user configuration register LVRLVSEL (CONFIG0 \\[29\\]).\nNote 1: This bit is write protected. Refer to the SYS_REGLCTL register.\nNote 2: This bit is only for special case.\nNote 3: reset by powr on reset"]
pub struct LVRVL_R(crate::FieldReader<bool, LVRVL_A>);
impl LVRVL_R {
    pub(crate) fn new(bits: bool) -> Self {
        LVRVL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> LVRVL_A {
        match self.bits {
            false => LVRVL_A::_0,
            true => LVRVL_A::_1,
        }
...
impl core::ops::Deref for LVRVL_R {
    type Target = crate::FieldReader<bool, LVRVL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `LVRVL` writer - LVR Detector Threshold Voltage Selection (Write Protect)\nThe default value is set by Flash controller user configuration register LVRLVSEL (CONFIG0 \\[29\\]).\nNote 1: This bit is write protected. Refer to the SYS_REGLCTL register.\nNote 2: This bit is only for special case.\nNote 3: reset by powr on reset"]
pub struct LVRVL_W<'a> {
    w: &'a mut W,
}
impl<'a> LVRVL_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LVRVL_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "LVR-Out Detector threshold voltage is 1.6V"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(LVRVL_A::_0)
    }
    #[doc = "LVR-Out Detector threshold voltage is 1.7V"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(LVRVL_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - Brown-out Detector Enable Bit (Write Protect) The default value is set by Flash controller user configuration register CBODEN (CONFIG0 \\[19\\]). Note 1: This bit is write protected. Refer to the SYS_REGLCTL register. Note 2: Reset by powr on reset"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Brown-out Detector Interrupt Flag Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn bodif(&self) -> BODIF_R {
        BODIF_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Brown-out Detector Low Power Mode (Write Protect) Note 1: The BOD consumes about 100uA in normal mode, the low power mode can reduce the current to about 1/10 but slow the BOD response. Note 2: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn bodlpm(&self) -> BODLPM_R {
        BODLPM_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - Brown-out Detector Output Status It means the detected voltage is lower than BODVL setting. If the BODEN is 0, BOD function disabled , this bit always responds 0000."]
    #[inline(always)]
    ...
    #[doc = "Bits 8:10 - Brown-out Detector Output De-glitch Time Select (Write Protect) Note: These bits are write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn boddgsel(&self) -> BODDGSEL_R {
        BODDGSEL_R::new(((self.bits >> 8) & 0x07) as u8)
    }
    #[doc = "Bits 12:14 - LVR Output De-glitch Time Select (Write Protect) Note: These bits are write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn lvrdgsel(&self) -> LVRDGSEL_R {
        LVRDGSEL_R::new(((self.bits >> 12) & 0x07) as u8)
    }
    #[doc = "Bit 16 - Brown-out Detector Threshold Voltage Selection (Write Protect) The default value is set by Flash controller user configuration register CBOV (CONFIG0 \\[21\\]). Note: This bit is write protected. Refer to the SYS_REGLCTL register. Note : reset by powr on reset"]
    #[inline(always)]
    pub fn bodvl(&self) -> BODVL_R {
        BODVL_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 20 - LVR Detector Threshold Voltage Selection (Write Protect) The default value is set by Flash controller user configuration register LVRLVSEL (CONFIG0 \\[29\\]). Note 1: This bit is write protected. Refer to the SYS_REGLCTL register. Note 2: This bit is only for special case. Note 3: reset by powr on reset"]
    #[inline(always)]
    pub fn lvrvl(&self) -> LVRVL_R {
        LVRVL_R::new(((self.bits >> 20) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Brown-out Detector Enable Bit (Write Protect) The default value is set by Flash controller user configuration register CBODEN (CONFIG0 \\[19\\]). Note 1: This bit is write protected. Refer to the SYS_REGLCTL register. Note 2: Reset by powr on reset"]
