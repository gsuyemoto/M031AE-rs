...
impl From<crate::R<SYS_PDID_SPEC>> for R {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:31 - Part Device Identification Number (Read Only) This register reflects device part number code. Software can read this register to identify which device is used."]
    #[inline(always)]
