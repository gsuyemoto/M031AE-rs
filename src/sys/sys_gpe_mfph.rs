...
impl From<crate::R<SYS_GPE_MFPH_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SYS_GPE_MFPH_SPEC>> for W {
    #[inline(always)]
...
#[doc = "Field `PE14MFP` reader - PE.14 Multi-function Pin Selection"]
pub struct PE14MFP_R(crate::FieldReader<u8, u8>);
impl PE14MFP_R {
    pub(crate) fn new(bits: u8) -> Self {
        PE14MFP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PE14MFP_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `PE14MFP` writer - PE.14 Multi-function Pin Selection"]
pub struct PE14MFP_W<'a> {
    w: &'a mut W,
}
impl<'a> PE14MFP_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
#[doc = "Field `PE15MFP` reader - PE.15 Multi-function Pin Selection"]
pub struct PE15MFP_R(crate::FieldReader<u8, u8>);
impl PE15MFP_R {
    pub(crate) fn new(bits: u8) -> Self {
        PE15MFP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PE15MFP_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `PE15MFP` writer - PE.15 Multi-function Pin Selection"]
pub struct PE15MFP_W<'a> {
    w: &'a mut W,
}
impl<'a> PE15MFP_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl R {
    ...
    #[inline(always)]
    pub fn pe14mfp(&self) -> PE14MFP_R {
        PE14MFP_R::new(((self.bits >> 24) & 0x0f) as u8)
    }
    #[doc = "Bits 28:31 - PE.15 Multi-function Pin Selection"]
    #[inline(always)]
    pub fn pe15mfp(&self) -> PE15MFP_R {
        PE15MFP_R::new(((self.bits >> 28) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - PE.8 Multi-function Pin Selection"]
    ...
    #[doc = "Bits 24:27 - PE.14 Multi-function Pin Selection"]
    #[inline(always)]
    pub fn pe14mfp(&mut self) -> PE14MFP_W {
        PE14MFP_W { w: self }
    }
    #[doc = "Bits 28:31 - PE.15 Multi-function Pin Selection"]
    #[inline(always)]
    pub fn pe15mfp(&mut self) -> PE15MFP_W {
        PE15MFP_W { w: self }
    }
