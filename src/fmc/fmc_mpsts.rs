...
impl From<crate::R<FMC_MPSTS_SPEC>> for R {
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - ISP Multi-word Program Busy Flag (Read Only) Write 1 to start ISP Multi-Word program operation and this bit will be cleared to 0 by hardware automatically when ISP Multi-Word program operation is finished. This bit is the mirror of ISPGO(FMC_ISPTRG\\[0\\])."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - ISP Fail Flag (Read Only) This bit is the mirror of ISPFF (FMC_ISPCTL\\[6\\]), it needs to be cleared by writing 1 to FMC_ISPCTL\\[6\\]
or FMC_ISPSTS\\[6\\]. This bit is set by hardware when a triggered ISP meets any of the following conditions: APROM writes to itself if APUEN is set to 0. LDROM writes to itself if LDUEN is set to 0. CONFIG is erased/programmed if CFGUEN is set to 0. Page Erase command at LOCK mode with ICE connection Erase or Program command at brown-out detected Destination address is illegal, such as over an available range. Invalid ISP commands"]
    ...
    #[doc = "Bit 4 - ISP DATA 0 Flag (Read Only) This bit is set when FMC_MPDAT0 is written and auto cleared to 0 when the FMC_MPDAT0 data is programmed to Flash complete."]
    #[inline(always)]
    pub fn d0(&self) -> D0_R {
        D0_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - ISP DATA 1 Flag (Read Only) This bit is set when FMC_MPDAT1 is written and auto cleared to 0 when the FMC_MPDAT1 data is programmed to Flash complete."]
    #[inline(always)]
    pub fn d1(&self) -> D1_R {
        D1_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - ISP DATA 2 Flag (Read Only) This bit is set when FMC_MPDAT2 is written and auto cleared to 0 when the FMC_MPDAT2 data is programmed to Flash complete."]
    #[inline(always)]
    pub fn d2(&self) -> D2_R {
        D2_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 7 - ISP DATA 3 Flag (Read Only) This bit is set when FMC_MPDAT3 is written and auto cleared to 0 when the FMC_MPDAT3 data is programmed to Flash complete."]
    #[inline(always)]
    pub fn d3(&self) -> D3_R {
