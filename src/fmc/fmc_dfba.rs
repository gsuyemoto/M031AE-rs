...
impl From<crate::R<FMC_DFBA_SPEC>> for R {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:31 - Data Flash Base Address This register indicates Data Flash start address. It is a read only register. The Data Flash is shared with APROM. the content of this register is loaded from CONFIG1"]
    #[inline(always)]
