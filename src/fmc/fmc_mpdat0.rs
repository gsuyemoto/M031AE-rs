...
impl From<crate::R<FMC_MPDAT0_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<FMC_MPDAT0_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:31 - ISP Data 0 This register is the first 32-bit data for 32-bit/64-bit/multi-word programming, and it is also the mirror of FMC_ISPDAT, both registers keep the same data."]
    #[inline(always)]
