...
impl From<crate::R<FMC_ISPTRG_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<FMC_ISPTRG_SPEC>> for W {
    #[inline(always)]
...
pub enum ISPGO_A {
    ...
    _0 = 0,
    #[doc = "1: ISP is progressed.Note: This bit is write-protected. Refer to the SYS_REGLCTL register"]
    _1 = 1,
}
...
impl<'a> ISPGO_W<'a> {
    ...
    #[doc = "ISP is progressed.Note: This bit is write-protected. Refer to the SYS_REGLCTL register"]
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - ISP Start Trigger (Write Protect) Write 1 to start ISP operation and this bit will be cleared to 0 by hardware automatically when ISP operation is finished."]
    #[inline(always)]
