...
impl From<crate::R<FMC_MPADDR_SPEC>> for R {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:31 - ISP Multi-word Program Address MPADDR is the address of ISP multi-word program operation when ISPGO flag is 1. MPADDR will keep the final ISP address when ISP multi-word program is complete."]
    #[inline(always)]
