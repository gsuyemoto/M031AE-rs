...
impl From<crate::R<SYST_CTRL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SYST_CTRL_SPEC>> for W {
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 16 - System Tick Counter Flag Returns 1 if timer counted to 0 since last time this register was read. COUNTFLAG is set by a count transition from 1 to 0. COUNTFLAG is cleared on read or by a write to the Current Value register."]
    #[inline(always)]
