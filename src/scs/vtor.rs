...
#[doc = "Field `TBLOFF` writer - Table Offset Bits\nThe vector table address for the selected Security state."]
...
impl R {
    #[doc = "Bits 7:31 - Table Offset Bits The vector table address for the selected Security state."]
    #[inline(always)]
