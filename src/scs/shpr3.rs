...
impl R {
    #[doc = "Bits 22:23 - Priority of System Handler 14 - PendSV '0' denotes the highest priority and '3' denotes the lowest priority."]
    #[inline(always)]
    pub fn pri_14(&self) -> PRI_14_R {
        PRI_14_R::new(((self.bits >> 22) & 0x03) as u8)
    }
    #[doc = "Bits 30:31 - Priority of System Handler 15 - SysTick '0' denotes the highest priority and '3' denotes the lowest priority."]
    #[inline(always)]
