...
impl From<crate::R<UART_MODEMSTS_SPEC>> for R {
    #[inline(always)]
...
#[doc = "Field `CTSDETF` reader - Detect nCTS State Change Flag\nThis bit is set whenever nCTS input has change state, and it will generate Modem interrupt to CPU when MODEMIEN (UART_INTEN \\[3\\]) is set to 1.\nNote: This bit can be cleared by writing '1' to it."]
...
#[doc = "Field `CTSDETF` writer - Detect nCTS State Change Flag\nThis bit is set whenever nCTS input has change state, and it will generate Modem interrupt to CPU when MODEMIEN (UART_INTEN \\[3\\]) is set to 1.\nNote: This bit can be cleared by writing '1' to it."]
pub struct CTSDETF_W<'a> {
    w: &'a mut W,
}
impl<'a> CTSDETF_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CTSDETF_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "nCTS input has not change state"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(CTSDETF_A::_0)
    }
    #[doc = "nCTS input has change state"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(CTSDETF_A::_1)
    }
...
impl R {
    #[doc = "Bit 0 - Detect nCTS State Change Flag This bit is set whenever nCTS input has change state, and it will generate Modem interrupt to CPU when MODEMIEN (UART_INTEN \\[3\\]) is set to 1. Note: This bit can be cleared by writing '1' to it."]
    #[inline(always)]
    pub fn ctsdetf(&self) -> CTSDETF_R {
        CTSDETF_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 4 - nCTS Pin Status (Read Only) This bit mirror from nCTS pin input of voltage logic status. Note: This bit echoes when UART controller peripheral clock is enabled, and nCTS multi-function port is selected."]
    #[inline(always)]
    pub fn ctssts(&self) -> CTSSTS_R {
        CTSSTS_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 8 - nCTS Pin Active Level This bit defines the active level state of nCTS pin input. Note: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller."]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Detect nCTS State Change Flag This bit is set whenever nCTS input has change state, and it will generate Modem interrupt to CPU when MODEMIEN (UART_INTEN \\[3\\]) is set to 1. Note: This bit can be cleared by writing '1' to it."]
    #[inline(always)]
    pub fn ctsdetf(&mut self) -> CTSDETF_W {
        CTSDETF_W { w: self }
    }
    #[doc = "Bit 8 - nCTS Pin Active Level This bit defines the active level state of nCTS pin input. Note: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller."]
    #[inline(always)]
