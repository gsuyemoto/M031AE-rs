...
impl From<crate::R<I2C_BUSTOUT_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<I2C_BUSTOUT_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Bus Management Time-out Value Indicates the bus time-out value in bus is IDLE or SCLK low. Note: If the user wants to revise the value of BUSTOUT, the TORSTEN (I2C_BUSTCTL\\[4\\]) bit shall be set to 1 and clear to 0 first in the BUSEN(I2C_BUSCTL\\[7\\]) is set."]
    #[inline(always)]
