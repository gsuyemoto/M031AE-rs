...
impl From<crate::R<I2C_TOCTL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<I2C_TOCTL_SPEC>> for W {
    #[inline(always)]
...
pub enum TOCDIV4_A {
    #[doc = "0: Time-out period is extend 4 times Disabled"]
    _0 = 0,
    #[doc = "1: Time-out period is extend 4 times Enabled"]
    _1 = 1,
}
...
impl<'a> TOCDIV4_W<'a> {
    ...
    #[doc = "Time-out period is extend 4 times Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(TOCDIV4_A::_0)
    }
    #[doc = "Time-out period is extend 4 times Enabled"]
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Time-out Flag This bit is set by hardware when I2C time-out happened and it can interrupt CPU if I2C interrupt enable bit (INTEN) is set to 1. Note: Software can write 1 to clear this bit."]
    #[inline(always)]
    pub fn toif(&self) -> TOIF_R {
        TOIF_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Time-out Counter Input Clock Divided by 4 When enabled, the time-out period is extended 4 times."]
    #[inline(always)]
    pub fn tocdiv4(&self) -> TOCDIV4_R {
        TOCDIV4_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Time-out Counter Enable Bit When enabled, the 14-bit time-out counter will start counting when SI is cleared. Setting flag SI to '1' will reset counter and re-start up counting after SI is cleared."]
    #[inline(always)]
