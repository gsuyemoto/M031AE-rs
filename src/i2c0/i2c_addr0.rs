#[doc = "Register `I2C_ADDR0` reader"]
pub struct R(crate::R<I2C_ADDR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2C_ADDR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2C_ADDR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2C_ADDR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2C_ADDR0` writer"]
pub struct W(crate::W<I2C_ADDR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2C_ADDR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2C_ADDR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2C_ADDR0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "I2C Slave Address Register0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2c_addr0](index.html) module"]
pub struct I2C_ADDR0_SPEC;
impl crate::RegisterSpec for I2C_ADDR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2c_addr0::R](R) reader structure"]
impl crate::Readable for I2C_ADDR0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2c_addr0::W](W) writer structure"]
impl crate::Writable for I2C_ADDR0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets I2C_ADDR0 to value 0"]
impl crate::Resettable for I2C_ADDR0_SPEC {
    #[inline(always)]
