...
impl From<crate::R<I2C_CLKTOUT_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<I2C_CLKTOUT_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Bus Clock Low Timer The field is used to configure the cumulative clock extension time-out. Note: If the user wants to revise the value of CLKLTOUT, the TORSTEN bit shall be set to 1 and clear to 0 first in the BUSEN is set."]
    #[inline(always)]
