...
impl From<crate::R<USBD_SE0_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<USBD_SE0_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Drive Single Ended Zero in USB Bus The Single Ended Zero (SE0) is when both lines (USB_D+ and USB_D-) are being pulled low."]
    #[inline(always)]
