#[doc = "Register `USBD_BUFSEG0` reader"]
pub struct R(crate::R<USBD_BUFSEG0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBD_BUFSEG0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBD_BUFSEG0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBD_BUFSEG0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USBD_BUFSEG0` writer"]
pub struct W(crate::W<USBD_BUFSEG0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBD_BUFSEG0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USBD_BUFSEG0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USBD_BUFSEG0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Endpoint 0 Buffer Segmentation Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbd_bufseg0](index.html) module"]
pub struct USBD_BUFSEG0_SPEC;
impl crate::RegisterSpec for USBD_BUFSEG0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbd_bufseg0::R](R) reader structure"]
impl crate::Readable for USBD_BUFSEG0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usbd_bufseg0::W](W) writer structure"]
impl crate::Writable for USBD_BUFSEG0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USBD_BUFSEG0 to value 0"]
impl crate::Resettable for USBD_BUFSEG0_SPEC {
    #[inline(always)]
