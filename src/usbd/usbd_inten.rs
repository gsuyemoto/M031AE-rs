#[doc = "Register `USBD_INTEN` reader"]
pub struct R(crate::R<USBD_INTEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBD_INTEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBD_INTEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBD_INTEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USBD_INTEN` writer"]
pub struct W(crate::W<USBD_INTEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBD_INTEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USBD_INTEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USBD_INTEN_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Start of Frame Interrupt Enable Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SOFIEN_A {
    #[doc = "0: SOF Interrupt Disabled"]
    _0 = 0,
    #[doc = "1: SOF Interrupt Enabled"]
    _1 = 1,
}
impl From<SOFIEN_A> for bool {
    #[inline(always)]
    fn from(variant: SOFIEN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SOFIEN` reader - Start of Frame Interrupt Enable Bit"]
pub struct SOFIEN_R(crate::FieldReader<bool, SOFIEN_A>);
impl SOFIEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        SOFIEN_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SOFIEN_A {
        match self.bits {
            false => SOFIEN_A::_0,
            true => SOFIEN_A::_1,
        }
...
impl core::ops::Deref for SOFIEN_R {
    type Target = crate::FieldReader<bool, SOFIEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `SOFIEN` writer - Start of Frame Interrupt Enable Bit"]
pub struct SOFIEN_W<'a> {
    w: &'a mut W,
}
impl<'a> SOFIEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: SOFIEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "SOF Interrupt Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SOFIEN_A::_0)
    }
    #[doc = "SOF Interrupt Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(SOFIEN_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum INNAKEN_A {
    #[doc = "0: When device responds NAK after receiving IN token, IN NAK status will not be updated to USBD_EPSTS0 register, so that the USB interrupt event will not be asserted"]
    _0 = 0,
    #[doc = "1: IN NAK status will be updated to USBD_EPSTS0 register and the USB interrupt event will be asserted, when the device responds NAK after receiving IN token"]
    _1 = 1,
}
...
impl<'a> INNAKEN_W<'a> {
    ...
    #[doc = "When device responds NAK after receiving IN token, IN NAK status will not be updated to USBD_EPSTS0 register, so that the USB interrupt event will not be asserted"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(INNAKEN_A::_0)
    }
    #[doc = "IN NAK status will be updated to USBD_EPSTS0 register and the USB interrupt event will be asserted, when the device responds NAK after receiving IN token"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 4 - Start of Frame Interrupt Enable Bit"]
    #[inline(always)]
    pub fn sofien(&self) -> SOFIEN_R {
        SOFIEN_R::new(((self.bits >> 4) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 4 - Start of Frame Interrupt Enable Bit"]
    #[inline(always)]
    pub fn sofien(&mut self) -> SOFIEN_W {
        SOFIEN_W { w: self }
    }
    #[doc = "Bit 8 - Wake-up Function Enable Bit"]
    #[inline(always)]
...
#[doc = "USB Device Interrupt Enable Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbd_inten](index.html) module"]
pub struct USBD_INTEN_SPEC;
impl crate::RegisterSpec for USBD_INTEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbd_inten::R](R) reader structure"]
impl crate::Readable for USBD_INTEN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usbd_inten::W](W) writer structure"]
impl crate::Writable for USBD_INTEN_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USBD_INTEN to value 0"]
impl crate::Resettable for USBD_INTEN_SPEC {
    #[inline(always)]
