#[doc = "Register `USBD_CFGP6` reader"]
pub struct R(crate::R<USBD_CFGP6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBD_CFGP6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBD_CFGP6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBD_CFGP6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USBD_CFGP6` writer"]
pub struct W(crate::W<USBD_CFGP6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBD_CFGP6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USBD_CFGP6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USBD_CFGP6_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Endpoint 6 Set Stall and Clear In/Out Ready Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbd_cfgp6](index.html) module"]
pub struct USBD_CFGP6_SPEC;
impl crate::RegisterSpec for USBD_CFGP6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbd_cfgp6::R](R) reader structure"]
impl crate::Readable for USBD_CFGP6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usbd_cfgp6::W](W) writer structure"]
impl crate::Writable for USBD_CFGP6_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USBD_CFGP6 to value 0"]
impl crate::Resettable for USBD_CFGP6_SPEC {
    #[inline(always)]
