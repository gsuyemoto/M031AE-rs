#[doc = "Register `USBD_VBUSDET` reader"]
pub struct R(crate::R<USBD_VBUSDET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBD_VBUSDET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBD_VBUSDET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBD_VBUSDET_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "USB Device VBUS Detection Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbd_vbusdet](index.html) module"]
pub struct USBD_VBUSDET_SPEC;
impl crate::RegisterSpec for USBD_VBUSDET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbd_vbusdet::R](R) reader structure"]
impl crate::Readable for USBD_VBUSDET_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets USBD_VBUSDET to value 0"]
impl crate::Resettable for USBD_VBUSDET_SPEC {
    #[inline(always)]
