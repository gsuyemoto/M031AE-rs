#[doc = "Register `USBD_BUFSEG2` reader"]
pub struct R(crate::R<USBD_BUFSEG2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBD_BUFSEG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBD_BUFSEG2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBD_BUFSEG2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USBD_BUFSEG2` writer"]
pub struct W(crate::W<USBD_BUFSEG2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBD_BUFSEG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USBD_BUFSEG2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USBD_BUFSEG2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Endpoint 2 Buffer Segmentation Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbd_bufseg2](index.html) module"]
pub struct USBD_BUFSEG2_SPEC;
impl crate::RegisterSpec for USBD_BUFSEG2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbd_bufseg2::R](R) reader structure"]
impl crate::Readable for USBD_BUFSEG2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usbd_bufseg2::W](W) writer structure"]
impl crate::Writable for USBD_BUFSEG2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USBD_BUFSEG2 to value 0"]
impl crate::Resettable for USBD_BUFSEG2_SPEC {
    #[inline(always)]
