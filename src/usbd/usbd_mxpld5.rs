#[doc = "Register `USBD_MXPLD5` reader"]
pub struct R(crate::R<USBD_MXPLD5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBD_MXPLD5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBD_MXPLD5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBD_MXPLD5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USBD_MXPLD5` writer"]
pub struct W(crate::W<USBD_MXPLD5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBD_MXPLD5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USBD_MXPLD5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USBD_MXPLD5_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Endpoint 5 Maximal Payload Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbd_mxpld5](index.html) module"]
pub struct USBD_MXPLD5_SPEC;
impl crate::RegisterSpec for USBD_MXPLD5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbd_mxpld5::R](R) reader structure"]
impl crate::Readable for USBD_MXPLD5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usbd_mxpld5::W](W) writer structure"]
impl crate::Writable for USBD_MXPLD5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USBD_MXPLD5 to value 0"]
impl crate::Resettable for USBD_MXPLD5_SPEC {
    #[inline(always)]
