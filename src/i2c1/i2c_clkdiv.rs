...
impl From<crate::R<I2C_CLKDIV_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<I2C_CLKDIV_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:9 - I2C Clock Divided Note: The minimum value of I2C_CLKDIV is 4."]
    #[inline(always)]
    pub fn divider(&self) -> DIVIDER_R {
        DIVIDER_R::new((self.bits & 0x03ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:9 - I2C Clock Divided Note: The minimum value of I2C_CLKDIV is 4."]
