...
impl From<crate::R<I2C_BUSCTL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<I2C_BUSCTL_SPEC>> for W {
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BUSEN_A {
    #[doc = "0: The system management function Disabled"]
    _0 = 0,
    #[doc = "1: The system management function Enabled"]
    _1 = 1,
}
...
impl<'a> BUSEN_W<'a> {
    ...
    #[doc = "The system management function Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(BUSEN_A::_0)
    }
    #[doc = "The system management function Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
pub enum PECTXEN_A {
    ...
    _0 = 0,
    #[doc = "1: PEC transmission is requested"]
    _1 = 1,
}
...
impl<'a> PECTXEN_W<'a> {
    ...
    #[doc = "PEC transmission is requested"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TIDLE_A {
    #[doc = "0: BUSTOUT is used to calculate the clock low period in bus active"]
    _0 = 0,
    #[doc = "1: BUSTOUT is used to calculate the IDLE period in bus Idle"]
    _1 = 1,
}
...
impl<'a> TIDLE_W<'a> {
    ...
    #[doc = "BUSTOUT is used to calculate the clock low period in bus active"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(TIDLE_A::_0)
    }
    #[doc = "BUSTOUT is used to calculate the IDLE period in bus Idle"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PECCLR_A {
    #[doc = "0: PEC calculation is cleared by 'Repeat Start' function Disabled"]
    _0 = 0,
    #[doc = "1: PEC calculation is cleared by 'Repeat Start' function Enabled"]
    _1 = 1,
}
...
impl<'a> PECCLR_W<'a> {
    ...
    #[doc = "PEC calculation is cleared by 'Repeat Start' function Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(PECCLR_A::_0)
    }
    #[doc = "PEC calculation is cleared by 'Repeat Start' function Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BCDIEN_A {
    #[doc = "0: Byte count done interrupt Disabled"]
    _0 = 0,
    #[doc = "1: Byte count done interrupt Enabled"]
    _1 = 1,
}
impl From<BCDIEN_A> for bool {
    #[inline(always)]
    fn from(variant: BCDIEN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `BCDIEN` reader - Packet Error Checking Byte Count Done Interrupt Enable Bit"]
pub struct BCDIEN_R(crate::FieldReader<bool, BCDIEN_A>);
impl BCDIEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        BCDIEN_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> BCDIEN_A {
        match self.bits {
            false => BCDIEN_A::_0,
            true => BCDIEN_A::_1,
        }
...
impl core::ops::Deref for BCDIEN_R {
    type Target = crate::FieldReader<bool, BCDIEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `BCDIEN` writer - Packet Error Checking Byte Count Done Interrupt Enable Bit"]
pub struct BCDIEN_W<'a> {
    w: &'a mut W,
}
impl<'a> BCDIEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: BCDIEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Byte count done interrupt Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(BCDIEN_A::_0)
    }
    #[doc = "Byte count done interrupt Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(BCDIEN_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
#[doc = "Packet Error Checking Byte Transfer Done Interrupt Enable Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PECDIEN_A {
    #[doc = "0: PEC transfer done interrupt Disabled"]
    _0 = 0,
    #[doc = "1: PEC transfer done interrupt Enabled"]
    _1 = 1,
}
impl From<PECDIEN_A> for bool {
    #[inline(always)]
    fn from(variant: PECDIEN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `PECDIEN` reader - Packet Error Checking Byte Transfer Done Interrupt Enable Bit"]
pub struct PECDIEN_R(crate::FieldReader<bool, PECDIEN_A>);
impl PECDIEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        PECDIEN_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PECDIEN_A {
        match self.bits {
            false => PECDIEN_A::_0,
            true => PECDIEN_A::_1,
        }
...
impl core::ops::Deref for PECDIEN_R {
    type Target = crate::FieldReader<bool, PECDIEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `PECDIEN` writer - Packet Error Checking Byte Transfer Done Interrupt Enable Bit"]
pub struct PECDIEN_W<'a> {
    w: &'a mut W,
}
impl<'a> PECDIEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PECDIEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "PEC transfer done interrupt Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(PECDIEN_A::_0)
    }
    #[doc = "PEC transfer done interrupt Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(PECDIEN_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - Acknowledge Control by Manual In order to allow ACK control in slave reception including the command and data, slave byte control mode must be enabled by setting the ACKMEN bit."]
    #[inline(always)]
    pub fn ackmen(&self) -> ACKMEN_R {
        ACKMEN_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Packet Error Checking Calculation Enable Bit Note: When I2C enter powerdown mode, the bit should be enabled after wake-up if needed PEC calculation."]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - BUS Enable Bit Note: When the bit is enabled, the internal 14-bit counter is used to calculate the time out event of clock low condition."]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - Timer Check in Idle State The BUSTOUT is used to calculate the time-out of clock low in bus active and the idle period in bus Idle. This bit is used to define which condition is enabled. Note: The BUSY (I2C_BUSSTS\\[0\\]) indicate the current bus state."]
    #[inline(always)]
    pub fn tidle(&self) -> TIDLE_R {
        TIDLE_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 10 - PEC Clear at Repeat Start The calculation of PEC starts when PECEN is set to 1 and it is cleared when the STA or STO bit is detected. This PECCLR bit is used to enable the condition of REPEAT START can clear the PEC calculation."]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Packet Error Checking Byte Count Done Interrupt Enable Bit"]
    #[inline(always)]
    pub fn bcdien(&self) -> BCDIEN_R {
        BCDIEN_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 13 - Packet Error Checking Byte Transfer Done Interrupt Enable Bit"]
    #[inline(always)]
    pub fn pecdien(&self) -> PECDIEN_R {
        PECDIEN_R::new(((self.bits >> 13) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Acknowledge Control by Manual In order to allow ACK control in slave reception including the command and data, slave byte control mode must be enabled by setting the ACKMEN bit."]
    ...
    #[doc = "Bit 12 - Packet Error Checking Byte Count Done Interrupt Enable Bit"]
    #[inline(always)]
    pub fn bcdien(&mut self) -> BCDIEN_W {
        BCDIEN_W { w: self }
    }
    #[doc = "Bit 13 - Packet Error Checking Byte Transfer Done Interrupt Enable Bit"]
    #[inline(always)]
    pub fn pecdien(&mut self) -> PECDIEN_W {
        PECDIEN_W { w: self }
    }
