...
impl From<crate::R<PWM_BNF_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PWM_BNF_SPEC>> for W {
    #[inline(always)]
...
#[doc = "Field `BK0SRC` reader - Brake 0 Pin Source Select\nFor PWM0 setting:"]
...
#[doc = "Field `BK0SRC` writer - Brake 0 Pin Source Select\nFor PWM0 setting:"]
...
#[doc = "Field `BK1SRC` reader - Brake 1 Pin Source Select\nFor PWM0 setting:"]
...
#[doc = "Field `BK1SRC` writer - Brake 1 Pin Source Select\nFor PWM0 setting:"]
...
impl R {
    ...
    #[doc = "Bits 4:6 - Brake 0 Edge Detector Filter Count The register bits control the Brake0 filter counter to count from 0 to BRK1FCNT."]
    #[inline(always)]
    ...
    #[doc = "Bits 12:14 - Brake 1 Edge Detector Filter Count The register bits control the Brake1 filter counter to count from 0 to BRK1FCNT."]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - Brake 0 Pin Source Select For PWM0 setting:"]
    #[inline(always)]
    pub fn bk0src(&self) -> BK0SRC_R {
        BK0SRC_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 24 - Brake 1 Pin Source Select For PWM0 setting:"]
    #[inline(always)]
