...
impl From<crate::R<PWM_INTEN1_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PWM_INTEN1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWM_INTEN1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "PWM Edge-detect Brake Interrupt Enable for Channel0/1 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
...
#[doc = "Field `BRKEIEN0_1` reader - PWM Edge-detect Brake Interrupt Enable for Channel0/1 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKEIEN0_1` writer - PWM Edge-detect Brake Interrupt Enable for Channel0/1 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "PWM Edge-detect Brake Interrupt Enable for Channel2/3 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[doc = "Field `BRKEIEN2_3` reader - PWM Edge-detect Brake Interrupt Enable for Channel2/3 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKEIEN2_3` writer - PWM Edge-detect Brake Interrupt Enable for Channel2/3 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "PWM Edge-detect Brake Interrupt Enable for Channel4/5 (Write Protect)\nNote: This bitr is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[doc = "Field `BRKEIEN4_5` reader - PWM Edge-detect Brake Interrupt Enable for Channel4/5 (Write Protect)\nNote: This bitr is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKEIEN4_5` writer - PWM Edge-detect Brake Interrupt Enable for Channel4/5 (Write Protect)\nNote: This bitr is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "PWM Level-detect Brake Interrupt Enable for Channel0/1 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[doc = "Field `BRKLIEN0_1` reader - PWM Level-detect Brake Interrupt Enable for Channel0/1 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKLIEN0_1` writer - PWM Level-detect Brake Interrupt Enable for Channel0/1 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "PWM Level-detect Brake Interrupt Enable for Channel2/3 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[doc = "Field `BRKLIEN2_3` reader - PWM Level-detect Brake Interrupt Enable for Channel2/3 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKLIEN2_3` writer - PWM Level-detect Brake Interrupt Enable for Channel2/3 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "PWM Level-detect Brake Interrupt Enable for Channel4/5 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[doc = "Field `BRKLIEN4_5` reader - PWM Level-detect Brake Interrupt Enable for Channel4/5 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKLIEN4_5` writer - PWM Level-detect Brake Interrupt Enable for Channel4/5 (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
impl R {
    #[doc = "Bit 0 - PWM Edge-detect Brake Interrupt Enable for Channel0/1 (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brkeien0_1(&self) -> BRKEIEN0_1_R {
        BRKEIEN0_1_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - PWM Edge-detect Brake Interrupt Enable for Channel2/3 (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brkeien2_3(&self) -> BRKEIEN2_3_R {
        BRKEIEN2_3_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - PWM Edge-detect Brake Interrupt Enable for Channel4/5 (Write Protect) Note: This bitr is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brkeien4_5(&self) -> BRKEIEN4_5_R {
        BRKEIEN4_5_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 8 - PWM Level-detect Brake Interrupt Enable for Channel0/1 (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brklien0_1(&self) -> BRKLIEN0_1_R {
        BRKLIEN0_1_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - PWM Level-detect Brake Interrupt Enable for Channel2/3 (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brklien2_3(&self) -> BRKLIEN2_3_R {
        BRKLIEN2_3_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 10 - PWM Level-detect Brake Interrupt Enable for Channel4/5 (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
