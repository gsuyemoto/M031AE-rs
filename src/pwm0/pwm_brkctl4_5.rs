#[doc = "Register `PWM_BRKCTL4_5` reader"]
pub struct R(crate::R<PWM_BRKCTL4_5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM_BRKCTL4_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWM_BRKCTL4_5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWM_BRKCTL4_5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PWM_BRKCTL4_5` writer"]
pub struct W(crate::W<PWM_BRKCTL4_5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWM_BRKCTL4_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PWM_BRKCTL4_5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWM_BRKCTL4_5_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Enable ACMP0_O Digital Output As Edge-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
...
#[doc = "Field `CPO0EBEN` reader - Enable ACMP0_O Digital Output As Edge-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `CPO0EBEN` writer - Enable ACMP0_O Digital Output As Edge-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Enable ACMP1_O Digital Output As Edge-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CPO1EBEN_A {
...
#[doc = "Field `CPO1EBEN` reader - Enable ACMP1_O Digital Output As Edge-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `CPO1EBEN` writer - Enable ACMP1_O Digital Output As Edge-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Enable PWMx_BRAKE0 Pin As Edge-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BRKP0EEN_A {
...
#[doc = "Field `BRKP0EEN` reader - Enable PWMx_BRAKE0 Pin As Edge-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKP0EEN` writer - Enable PWMx_BRAKE0 Pin As Edge-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Enable PWMx_BRAKE1 Pin As Edge-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BRKP1EEN_A {
...
#[doc = "Field `BRKP1EEN` reader - Enable PWMx_BRAKE1 Pin As Edge-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKP1EEN` writer - Enable PWMx_BRAKE1 Pin As Edge-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Enable System Fail As Edge-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SYSEBEN_A {
...
#[doc = "Field `SYSEBEN` reader - Enable System Fail As Edge-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `SYSEBEN` writer - Enable System Fail As Edge-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Enable ACMP0_O Digital Output As Level-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CPO0LBEN_A {
...
#[doc = "Field `CPO0LBEN` reader - Enable ACMP0_O Digital Output As Level-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `CPO0LBEN` writer - Enable ACMP0_O Digital Output As Level-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Enable ACMP1_O Digital Output As Level-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CPO1LBEN_A {
...
#[doc = "Field `CPO1LBEN` reader - Enable ACMP1_O Digital Output As Level-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `CPO1LBEN` writer - Enable ACMP1_O Digital Output As Level-detect Brake Source (Write Protect)\nNote: This register is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Enable BKP0 Pin As Level-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BRKP0LEN_A {
...
#[doc = "Field `BRKP0LEN` reader - Enable BKP0 Pin As Level-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKP0LEN` writer - Enable BKP0 Pin As Level-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Enable BKP1 Pin As Level-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BRKP1LEN_A {
...
#[doc = "Field `BRKP1LEN` reader - Enable BKP1 Pin As Level-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `BRKP1LEN` writer - Enable BKP1 Pin As Level-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Enable System Fail As Level-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SYSLBEN_A {
...
#[doc = "Field `SYSLBEN` reader - Enable System Fail As Level-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `SYSLBEN` writer - Enable System Fail As Level-detect Brake Source (Write Protect)\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
impl R {
    #[doc = "Bit 0 - Enable ACMP0_O Digital Output As Edge-detect Brake Source (Write Protect) Note: This register is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn cpo0eben(&self) -> CPO0EBEN_R {
        CPO0EBEN_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Enable ACMP1_O Digital Output As Edge-detect Brake Source (Write Protect) Note: This register is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn cpo1eben(&self) -> CPO1EBEN_R {
        CPO1EBEN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 4 - Enable PWMx_BRAKE0 Pin As Edge-detect Brake Source (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brkp0een(&self) -> BRKP0EEN_R {
        BRKP0EEN_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Enable PWMx_BRAKE1 Pin As Edge-detect Brake Source (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brkp1een(&self) -> BRKP1EEN_R {
        BRKP1EEN_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 7 - Enable System Fail As Edge-detect Brake Source (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn syseben(&self) -> SYSEBEN_R {
        SYSEBEN_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    #[doc = "Bit 8 - Enable ACMP0_O Digital Output As Level-detect Brake Source (Write Protect) Note: This register is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn cpo0lben(&self) -> CPO0LBEN_R {
        CPO0LBEN_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - Enable ACMP1_O Digital Output As Level-detect Brake Source (Write Protect) Note: This register is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn cpo1lben(&self) -> CPO1LBEN_R {
        CPO1LBEN_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 12 - Enable BKP0 Pin As Level-detect Brake Source (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brkp0len(&self) -> BRKP0LEN_R {
        BRKP0LEN_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 13 - Enable BKP1 Pin As Level-detect Brake Source (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brkp1len(&self) -> BRKP1LEN_R {
        BRKP1LEN_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    #[doc = "Bit 15 - Enable System Fail As Level-detect Brake Source (Write Protect) Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn syslben(&self) -> SYSLBEN_R {
        SYSLBEN_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    #[doc = "Bits 16:17 - PWM Brake Action Select for Even Channel (Write Protect) Note: These bits are write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    pub fn brkaeven(&self) -> BRKAEVEN_R {
        BRKAEVEN_R::new(((self.bits >> 16) & 0x03) as u8)
    }
    #[doc = "Bits 18:19 - PWM Brake Action Select for Odd Channel (Write Protect) Note: These bits are write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
...
#[doc = "PWM Brake Edge Detect Control Register 4/5\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm_brkctl4_5](index.html) module"]
pub struct PWM_BRKCTL4_5_SPEC;
impl crate::RegisterSpec for PWM_BRKCTL4_5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm_brkctl4_5::R](R) reader structure"]
impl crate::Readable for PWM_BRKCTL4_5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwm_brkctl4_5::W](W) writer structure"]
impl crate::Writable for PWM_BRKCTL4_5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PWM_BRKCTL4_5 to value 0"]
impl crate::Resettable for PWM_BRKCTL4_5_SPEC {
    #[inline(always)]
