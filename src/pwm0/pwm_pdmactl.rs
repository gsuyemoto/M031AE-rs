...
impl From<crate::R<PWM_PDMACTL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PWM_PDMACTL_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Channel 0/1 PDMA Enable Bit Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn chen0_1(&self) -> CHEN0_1_R {
        CHEN0_1_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bits 1:2 - Select PWM_RCAPDAT0/1 or PWM_FCAPDAT0/1 to Do PDMA Transfer Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn capmod0_1(&self) -> CAPMOD0_1_R {
        CAPMOD0_1_R::new(((self.bits >> 1) & 0x03) as u8)
    }
    #[doc = "Bit 3 - Capture Channel 0/1 Rising/Falling Order Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn capord0_1(&self) -> CAPORD0_1_R {
        CAPORD0_1_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - Select Channel 0/1 to Do PDMA Transfer Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn chsel0_1(&self) -> CHSEL0_1_R {
        CHSEL0_1_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 8 - Channel 2/3 PDMA Enable Bit Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn chen2_3(&self) -> CHEN2_3_R {
        CHEN2_3_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bits 9:10 - Select PWM_RCAPDAT2/3 or PWM_FCAODAT2/3 to Do PDMA Transfer Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn capmod2_3(&self) -> CAPMOD2_3_R {
        CAPMOD2_3_R::new(((self.bits >> 9) & 0x03) as u8)
    }
    #[doc = "Bit 11 - Capture Channel 2/3 Rising/Falling Order Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn capord2_3(&self) -> CAPORD2_3_R {
        CAPORD2_3_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 12 - Select Channel 2/3 to Do PDMA Transfer Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn chsel2_3(&self) -> CHSEL2_3_R {
        CHSEL2_3_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 16 - Channel 4/5 PDMA Enable Bit Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn chen4_5(&self) -> CHEN4_5_R {
        CHEN4_5_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bits 17:18 - Select PWM_RCAPDAT4/5 or PWM_FCAPDAT4/5 to Do PDMA Transfer Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn capmod4_5(&self) -> CAPMOD4_5_R {
        CAPMOD4_5_R::new(((self.bits >> 17) & 0x03) as u8)
    }
    #[doc = "Bit 19 - Capture Channel 4/5 Rising/Falling Order Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn capord4_5(&self) -> CAPORD4_5_R {
        CAPORD4_5_R::new(((self.bits >> 19) & 0x01) != 0)
    }
    #[doc = "Bit 20 - Select Channel 4/5 to Do PDMA Transfer Note: If the PDMA function is not supported, this bit field will become invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
