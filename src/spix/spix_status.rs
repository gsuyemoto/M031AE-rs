#[doc = "Register `SPIx_STATUS` reader"]
pub struct R(crate::R<SPIX_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPIX_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPIX_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPIX_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPIx_STATUS` writer"]
pub struct W(crate::W<SPIX_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPIX_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPIX_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPIX_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum RXTOIF_A {
    ...
    _0 = 0,
    #[doc = "1: Receive FIFO buffer is not empty and no read operation on receive FIFO buffer over 64 SPI peripheral clock periods in Master mode or over 576 SPI peripheral clock periods in Slave mode. When the received FIFO buffer is read by software, the time-out status will be cleared automatically"]
    _1 = 1,
}
...
impl<'a> RXTOIF_W<'a> {
    ...
    #[doc = "Receive FIFO buffer is not empty and no read operation on receive FIFO buffer over 64 SPI peripheral clock periods in Master mode or over 576 SPI peripheral clock periods in Slave mode. When the received FIFO buffer is read by software, the time-out status will be cleared automatically"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SPIENSTS_A {
    #[doc = "0: SPI controller Disabled"]
    _0 = 0,
    #[doc = "1: SPI controller Enabled"]
    _1 = 1,
}
...
impl R {
    ...
    #[doc = "Bit 4 - Slave Select Line Bus Status (Read Only) Note: This bit is only available in Slave mode. If SSACTPOL (SPIx_SSCTL\\[2\\]) is set 0, and the SSLINE is 1, the SPI slave select is in inactive status."]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - SPI Enable Status (Read Only) Note: The SPI peripheral clock is asynchronous with the system clock. In order to make sure the SPI control logic is disabled, this bit indicates the real status of SPI controller."]
    #[inline(always)]
...
#[doc = "SPI Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spix_status](index.html) module"]
pub struct SPIX_STATUS_SPEC;
impl crate::RegisterSpec for SPIX_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spix_status::R](R) reader structure"]
impl crate::Readable for SPIX_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spix_status::W](W) writer structure"]
impl crate::Writable for SPIX_STATUS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPIx_STATUS to value 0x0005_0110"]
impl crate::Resettable for SPIX_STATUS_SPEC {
    #[inline(always)]
