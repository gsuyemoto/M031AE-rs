#[doc = "Register `SPIx_PDMACTL` reader"]
pub struct R(crate::R<SPIX_PDMACTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPIX_PDMACTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPIX_PDMACTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPIX_PDMACTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPIx_PDMACTL` writer"]
pub struct W(crate::W<SPIX_PDMACTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPIX_PDMACTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPIX_PDMACTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPIX_PDMACTL_SPEC>) -> Self {
        W(writer)
    }
}
...
impl R {
    #[doc = "Bit 0 - Transmit PDMA Enable Bit Note: In SPI Master mode with full duplex transfer, if both TX and RX PDMA functions are enabled, RX PDMA function cannot be enabled prior to TX PDMA function. User can enable TX PDMA function firstly or enable both functions simultaneously."]
    #[inline(always)]
...
#[doc = "SPI PDMA Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spix_pdmactl](index.html) module"]
pub struct SPIX_PDMACTL_SPEC;
impl crate::RegisterSpec for SPIX_PDMACTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spix_pdmactl::R](R) reader structure"]
impl crate::Readable for SPIX_PDMACTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spix_pdmactl::W](W) writer structure"]
impl crate::Writable for SPIX_PDMACTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPIx_PDMACTL to value 0"]
impl crate::Resettable for SPIX_PDMACTL_SPEC {
    #[inline(always)]
