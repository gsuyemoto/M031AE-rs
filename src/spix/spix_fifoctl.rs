#[doc = "Register `SPIx_FIFOCTL` reader"]
pub struct R(crate::R<SPIX_FIFOCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPIX_FIFOCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPIX_FIFOCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPIX_FIFOCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPIx_FIFOCTL` writer"]
pub struct W(crate::W<SPIX_FIFOCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPIX_FIFOCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPIX_FIFOCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPIX_FIFOCTL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Receive Reset\n\nValue on reset: 0"]
...
impl R {
    ...
    #[doc = "Bit 1 - Transmit Reset Note: If TX underflow event occurs in SPI Slave mode, this bit can be used to make SPI return to idle state."]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - TX Underflow Data Polarity Note 1: The TX underflow event occurs if there is no any data in TX FIFO when the slave selection signal is active. Note 2: This bit should be set as 0 in I2S mode. Note 3: When TX underflow event occurs, SPIx_MISO pin state will be determined by this setting even though TX FIFO is not empty afterward. Data stored in TX FIFO will be sent through SPIx_MISO pin in the next transfer frame."]
    #[inline(always)]
    pub fn txufpol(&self) -> TXUFPOL_R {
        TXUFPOL_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 7 - TX Underflow Interrupt Enable Bit When TX underflow event occurs in Slave mode, TXUFIF (SPIx_STATUS\\[19\\]) will be set to 1. This bit is used to enable the TX underflow interrupt."]
    #[inline(always)]
    ...
    #[doc = "Bits 24:26 - Receive FIFO Threshold If the valid data count of the receive FIFO buffer is larger than the RXTH setting, the RXTHIF bit will be set to 1, else the RXTHIF bit will be cleared to 0. The MSB of this bit field is only meaningful while SPI mode 8~16 bits of data length."]
    #[inline(always)]
    pub fn rxth(&self) -> RXTH_R {
        RXTH_R::new(((self.bits >> 24) & 0x07) as u8)
    }
    #[doc = "Bits 28:30 - Transmit FIFO Threshold If the valid data count of the transmit FIFO buffer is less than or equal to the TXTH setting, the TXTHIF bit will be set to 1, else the TXTHIF bit will be cleared to 0. The MSB of this bit field is only meaningful while SPI mode 8~16 bits of data length."]
    #[inline(always)]
...
#[doc = "SPI FIFO Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spix_fifoctl](index.html) module"]
pub struct SPIX_FIFOCTL_SPEC;
impl crate::RegisterSpec for SPIX_FIFOCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spix_fifoctl::R](R) reader structure"]
impl crate::Readable for SPIX_FIFOCTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spix_fifoctl::W](W) writer structure"]
impl crate::Writable for SPIX_FIFOCTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPIx_FIFOCTL to value 0x2200_0000"]
impl crate::Resettable for SPIX_FIFOCTL_SPEC {
    #[inline(always)]
