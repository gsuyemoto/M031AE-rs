#[doc = "Register `SPIx_I2SCTL` reader"]
pub struct R(crate::R<SPIX_I2SCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPIX_I2SCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPIX_I2SCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPIX_I2SCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPIx_I2SCTL` writer"]
pub struct W(crate::W<SPIX_I2SCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPIX_I2SCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPIX_I2SCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPIX_I2SCTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum I2SEN_A {
    #[doc = "0: I2S mode Disabled"]
    _0 = 0,
    #[doc = "1: I2S mode Enabled"]
    _1 = 1,
}
...
impl<'a> I2SEN_W<'a> {
    ...
    #[doc = "I2S mode Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(I2SEN_A::_0)
    }
    #[doc = "I2S mode Enabled"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MUTE_A {
    #[doc = "0: Transmit data is shifted from buffer"]
    _0 = 0,
    #[doc = "1: Transmit channel zero"]
    _1 = 1,
}
...
impl<'a> MUTE_W<'a> {
    ...
    #[doc = "Transmit data is shifted from buffer"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(MUTE_A::_0)
    }
    #[doc = "Transmit channel zero"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "Bit Clock Loss Interrupt Enable Bit for Slave Mode\nInterrupt occurs if this bit is set to 1 and bit clock loss event occurs.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SLVERRIEN_A {
    #[doc = "0: Interrupt Disabled"]
    _0 = 0,
    #[doc = "1: Interrupt Enabled"]
    _1 = 1,
}
impl From<SLVERRIEN_A> for bool {
    #[inline(always)]
    fn from(variant: SLVERRIEN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SLVERRIEN` reader - Bit Clock Loss Interrupt Enable Bit for Slave Mode\nInterrupt occurs if this bit is set to 1 and bit clock loss event occurs."]
pub struct SLVERRIEN_R(crate::FieldReader<bool, SLVERRIEN_A>);
impl SLVERRIEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        SLVERRIEN_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SLVERRIEN_A {
        match self.bits {
            false => SLVERRIEN_A::_0,
            true => SLVERRIEN_A::_1,
        }
    }
    #[doc = "Checks if the value of the field is `_0`"]
...
impl core::ops::Deref for SLVERRIEN_R {
    type Target = crate::FieldReader<bool, SLVERRIEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `SLVERRIEN` writer - Bit Clock Loss Interrupt Enable Bit for Slave Mode\nInterrupt occurs if this bit is set to 1 and bit clock loss event occurs."]
pub struct SLVERRIEN_W<'a> {
    w: &'a mut W,
}
impl<'a> SLVERRIEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: SLVERRIEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Interrupt Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SLVERRIEN_A::_0)
    }
    #[doc = "Interrupt Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(SLVERRIEN_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - I2S Controller Enable Bit Note 1: If enabling this bit, I2Sx_BCLK will start to output in Master mode. Note 2: Before changing the configurations of SPIx_I2SCTL, SPIx_I2SCLK, and SPIx_FIFOCTL registers, user shall clear the I2SEN (SPIx_I2SCTL\\[0\\]) and confirm the I2SENSTS (SPIx_I2SSTS\\[15\\]) is 0."]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - Master Clock Enable Bit If MCLKEN is set to 1, I2S controller will generate master clock on SPIx_I2SMCLK pin for external audio devices."]
    #[inline(always)]
    pub fn mclken(&self) -> MCLKEN_R {
        MCLKEN_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    #[doc = "Bit 16 - Right Channel Zero Cross Detection Enable Bit If this bit is set to 1, when right channel data sign bit change or next shift data bits are all 0 then RZCIF flag in SPIx_I2SSTS register is set to 1. This function is only available in transmit operation."]
    #[inline(always)]
    pub fn rzcen(&self) -> RZCEN_R {
        RZCEN_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 17 - Left Channel Zero Cross Detection Enable Bit If this bit is set to 1, when left channel data sign bit changes or next shift data bits are all 0 then LZCIF flag in SPIx_I2SSTS register is set to 1. This function is only available in transmit operation."]
    #[inline(always)]
    ...
    #[doc = "Bit 24 - Right Channel Zero Cross Interrupt Enable Bit Interrupt occurs if this bit is set to 1 and right channel zero cross event occurs."]
    #[inline(always)]
    pub fn rzcien(&self) -> RZCIEN_R {
        RZCIEN_R::new(((self.bits >> 24) & 0x01) != 0)
    }
    #[doc = "Bit 25 - Left Channel Zero Cross Interrupt Enable Bit Interrupt occurs if this bit is set to 1 and left channel zero cross event occurs."]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - Bit Clock Loss Interrupt Enable Bit for Slave Mode Interrupt occurs if this bit is set to 1 and bit clock loss event occurs."]
    #[inline(always)]
    pub fn slverrien(&self) -> SLVERRIEN_R {
        SLVERRIEN_R::new(((self.bits >> 31) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - I2S Controller Enable Bit Note 1: If enabling this bit, I2Sx_BCLK will start to output in Master mode. Note 2: Before changing the configurations of SPIx_I2SCTL, SPIx_I2SCLK, and SPIx_FIFOCTL registers, user shall clear the I2SEN (SPIx_I2SCTL\\[0\\]) and confirm the I2SENSTS (SPIx_I2SSTS\\[15\\]) is 0."]
    ...
    #[doc = "Bit 31 - Bit Clock Loss Interrupt Enable Bit for Slave Mode Interrupt occurs if this bit is set to 1 and bit clock loss event occurs."]
    #[inline(always)]
    pub fn slverrien(&mut self) -> SLVERRIEN_W {
        SLVERRIEN_W { w: self }
    }
...
#[doc = "I2S Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spix_i2sctl](index.html) module"]
pub struct SPIX_I2SCTL_SPEC;
impl crate::RegisterSpec for SPIX_I2SCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spix_i2sctl::R](R) reader structure"]
impl crate::Readable for SPIX_I2SCTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spix_i2sctl::W](W) writer structure"]
impl crate::Writable for SPIX_I2SCTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPIx_I2SCTL to value 0"]
impl crate::Resettable for SPIX_I2SCTL_SPEC {
    #[inline(always)]
