#[doc = "Register `SPIx_CLKDIV` reader"]
pub struct R(crate::R<SPIX_CLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPIX_CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPIX_CLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPIX_CLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPIx_CLKDIV` writer"]
pub struct W(crate::W<SPIX_CLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPIX_CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPIX_CLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPIX_CLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "SPI Clock Divider Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spix_clkdiv](index.html) module"]
pub struct SPIX_CLKDIV_SPEC;
impl crate::RegisterSpec for SPIX_CLKDIV_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spix_clkdiv::R](R) reader structure"]
impl crate::Readable for SPIX_CLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spix_clkdiv::W](W) writer structure"]
impl crate::Writable for SPIX_CLKDIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPIx_CLKDIV to value 0"]
impl crate::Resettable for SPIX_CLKDIV_SPEC {
    #[inline(always)]
