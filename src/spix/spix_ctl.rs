#[doc = "Register `SPIx_CTL` reader"]
pub struct R(crate::R<SPIX_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPIX_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPIX_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPIX_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPIx_CTL` writer"]
pub struct W(crate::W<SPIX_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPIX_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPIX_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPIX_CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Field `HALFDPX` reader - SPI Half-duplex Transfer Enable Bit\nThis bit is used to select full-duplex or half-duplex for SPI transfer. The bit field DATDIR (SPIx_CTL\\[20\\]) can be used to set the data direction in half-duplex transfer."]
...
#[doc = "Field `HALFDPX` writer - SPI Half-duplex Transfer Enable Bit\nThis bit is used to select full-duplex or half-duplex for SPI transfer. The bit field DATDIR (SPIx_CTL\\[20\\]) can be used to set the data direction in half-duplex transfer."]
...
impl<'a> HALFDPX_W<'a> {
    ...
    #[doc = "SPI operates in full-duplex transfer"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(HALFDPX_A::_0)
    }
    #[doc = "SPI operates in half-duplex transfer"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DATDIR_A {
    #[doc = "0: SPI data is input direction"]
    _0 = 0,
    #[doc = "1: SPI data is output direction"]
    _1 = 1,
}
...
impl<'a> DATDIR_W<'a> {
    ...
    #[doc = "SPI data is input direction"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(DATDIR_A::_0)
    }
    #[doc = "SPI data is output direction"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - SPI Transfer Control Enable Bit In Master mode, the transfer will start when there is data in the FIFO buffer after this bit is set to 1. In Slave mode, this device is ready to receive data when this bit is set to 1. Note: Before changing the configurations of SPIx_CTL, SPIx_CLKDIV, SPIx_SSCTL and SPIx_FIFOCTL registers, user shall clear the SPIEN (SPIx_CTL\\[0\\]) and confirm the SPIENSTS (SPIx_STATUS\\[15\\]) is 0."]
    #[inline(always)]
...
+ 0.5) * period of SPICLK clock cycle Example:"]
    ...
    #[doc = "Bit 14 - SPI Half-duplex Transfer Enable Bit This bit is used to select full-duplex or half-duplex for SPI transfer. The bit field DATDIR (SPIx_CTL\\[20\\]) can be used to set the data direction in half-duplex transfer."]
    #[inline(always)]
    pub fn halfdpx(&self) -> HALFDPX_R {
        HALFDPX_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    #[doc = "Bit 15 - Receive-only Mode Enable Bit (Master Only) This bit field is only available in Master mode. In receive-only mode, SPI Master will generate SPI bus clock continuously for receiving data bit from SPI slave device and assert the BUSY status."]
    #[inline(always)]
...
#[doc = "SPI Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spix_ctl](index.html) module"]
pub struct SPIX_CTL_SPEC;
impl crate::RegisterSpec for SPIX_CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spix_ctl::R](R) reader structure"]
impl crate::Readable for SPIX_CTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spix_ctl::W](W) writer structure"]
impl crate::Writable for SPIX_CTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPIx_CTL to value 0x34"]
impl crate::Resettable for SPIX_CTL_SPEC {
    #[inline(always)]
