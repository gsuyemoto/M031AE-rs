#[doc = "Register `SPIx_I2SSTS` reader"]
pub struct R(crate::R<SPIX_I2SSTS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPIX_I2SSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPIX_I2SSTS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPIX_I2SSTS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPIx_I2SSTS` writer"]
pub struct W(crate::W<SPIX_I2SSTS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPIX_I2SSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPIX_I2SSTS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPIX_I2SSTS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum RXTOIF_A {
    ...
    _0 = 0,
    #[doc = "1: Receive FIFO buffer is not empty and no read operation on receive FIFO buffer over 64 SPI peripheral clock period in Master mode or over 576 SPI peripheral clock period in Slave mode. When the received FIFO buffer is read by software, the time-out status will be cleared automatically"]
    _1 = 1,
}
...
impl<'a> RXTOIF_W<'a> {
    ...
    #[doc = "Receive FIFO buffer is not empty and no read operation on receive FIFO buffer over 64 SPI peripheral clock period in Master mode or over 576 SPI peripheral clock period in Slave mode. When the received FIFO buffer is read by software, the time-out status will be cleared automatically"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum I2SENSTS_A {
    #[doc = "0: SPI/I2S control logic Disabled"]
    _0 = 0,
    #[doc = "1: SPI/I2S control logic Enabled"]
    _1 = 1,
}
...
#[doc = "Bit Clock Loss Interrupt Flag for Slave Mode\nNote: This bit will be cleared by writing 1 to it.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SLVERRIF_A {
    #[doc = "0: No bit clock loss event occurred"]
    _0 = 0,
    #[doc = "1: Bit clock loss event occurred"]
    _1 = 1,
}
impl From<SLVERRIF_A> for bool {
    #[inline(always)]
    fn from(variant: SLVERRIF_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SLVERRIF` reader - Bit Clock Loss Interrupt Flag for Slave Mode\nNote: This bit will be cleared by writing 1 to it."]
pub struct SLVERRIF_R(crate::FieldReader<bool, SLVERRIF_A>);
impl SLVERRIF_R {
    pub(crate) fn new(bits: bool) -> Self {
        SLVERRIF_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SLVERRIF_A {
        match self.bits {
            false => SLVERRIF_A::_0,
            true => SLVERRIF_A::_1,
        }
...
impl core::ops::Deref for SLVERRIF_R {
    type Target = crate::FieldReader<bool, SLVERRIF_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `SLVERRIF` writer - Bit Clock Loss Interrupt Flag for Slave Mode\nNote: This bit will be cleared by writing 1 to it."]
pub struct SLVERRIF_W<'a> {
    w: &'a mut W,
}
impl<'a> SLVERRIF_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: SLVERRIF_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "No bit clock loss event occurred"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SLVERRIF_A::_0)
    }
    #[doc = "Bit clock loss event occurred"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(SLVERRIF_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 4 - Right Channel (Read Only) This bit indicates the current transmit data is belong to which channel."]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - I2S Enable Status (Read Only) Note: The SPI peripheral clock is asynchronous with the system clock. In order to make sure the SPI/I2S control logic is disabled, this bit indicates the real status of SPI/I2S control logic for user."]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - Transmit FIFO Underflow Interrupt Flag When the transmit FIFO buffer is empty and there is no datum written into the FIFO buffer, if there is more bus clock input, this bit will be set to 1. Note: This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    ...
    #[doc = "Bit 22 - Bit Clock Loss Interrupt Flag for Slave Mode Note: This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    pub fn slverrif(&self) -> SLVERRIF_R {
        SLVERRIF_R::new(((self.bits >> 22) & 0x01) != 0)
    }
    ...
    #[doc = "Bits 24:26 - Receive FIFO Data Count (Read Only) This bit field indicates the valid data count of receive FIFO buffer."]
    #[inline(always)]
    pub fn rxcnt(&self) -> RXCNT_R {
        RXCNT_R::new(((self.bits >> 24) & 0x07) as u8)
    }
    #[doc = "Bits 28:30 - Transmit FIFO Data Count (Read Only) This bit field indicates the valid data count of transmit FIFO buffer."]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 22 - Bit Clock Loss Interrupt Flag for Slave Mode Note: This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    pub fn slverrif(&mut self) -> SLVERRIF_W {
        SLVERRIF_W { w: self }
    }
...
#[doc = "I2S Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spix_i2ssts](index.html) module"]
pub struct SPIX_I2SSTS_SPEC;
impl crate::RegisterSpec for SPIX_I2SSTS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spix_i2ssts::R](R) reader structure"]
impl crate::Readable for SPIX_I2SSTS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spix_i2ssts::W](W) writer structure"]
impl crate::Writable for SPIX_I2SSTS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPIx_I2SSTS to value 0x0005_0100"]
impl crate::Resettable for SPIX_I2SSTS_SPEC {
    #[inline(always)]
