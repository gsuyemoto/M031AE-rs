...
impl From<crate::R<ACMP_STATUS_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<ACMP_STATUS_SPEC>> for W {
    #[inline(always)]
...
#[doc = "Field `ACMPS0` reader - Comparator 0 Status \nSynchronized to the PCLK to allow reading by software. Cleared when the comparator 0 is disabled, i.e. ACMPEN (ACMP_CTL0\\[0\\]) is cleared to 0."]
pub struct ACMPS0_R(crate::FieldReader<bool, bool>);
impl ACMPS0_R {
    pub(crate) fn new(bits: bool) -> Self {
        ACMPS0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ACMPS0_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `ACMPS0` writer - Comparator 0 Status \nSynchronized to the PCLK to allow reading by software. Cleared when the comparator 0 is disabled, i.e. ACMPEN (ACMP_CTL0\\[0\\]) is cleared to 0."]
pub struct ACMPS0_W<'a> {
    w: &'a mut W,
}
impl<'a> ACMPS0_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Field `ACMPS1` reader - Comparator 1 Status\nSynchronized to the PCLK to allow reading by software. Cleared when the comparator 1 is disabled, i.e. ACMPEN (ACMP_CTL1\\[0\\]) is cleared to 0."]
pub struct ACMPS1_R(crate::FieldReader<bool, bool>);
impl ACMPS1_R {
    pub(crate) fn new(bits: bool) -> Self {
        ACMPS1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ACMPS1_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `ACMPS1` writer - Comparator 1 Status\nSynchronized to the PCLK to allow reading by software. Cleared when the comparator 1 is disabled, i.e. ACMPEN (ACMP_CTL1\\[0\\]) is cleared to 0."]
pub struct ACMPS1_W<'a> {
    w: &'a mut W,
}
impl<'a> ACMPS1_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Comparator Window Output\nThis bit shows the output status of window compare mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ACMPWO_A {
    #[doc = "0: The positive input voltage is outside the window"]
    _0 = 0,
    #[doc = "1: The positive input voltage is in the window"]
    _1 = 1,
}
impl From<ACMPWO_A> for bool {
    #[inline(always)]
    fn from(variant: ACMPWO_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ACMPWO` reader - Comparator Window Output\nThis bit shows the output status of window compare mode"]
pub struct ACMPWO_R(crate::FieldReader<bool, ACMPWO_A>);
impl ACMPWO_R {
    pub(crate) fn new(bits: bool) -> Self {
        ACMPWO_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> ACMPWO_A {
        match self.bits {
            false => ACMPWO_A::_0,
            true => ACMPWO_A::_1,
        }
...
impl core::ops::Deref for ACMPWO_R {
    type Target = crate::FieldReader<bool, ACMPWO_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `ACMPWO` writer - Comparator Window Output\nThis bit shows the output status of window compare mode"]
pub struct ACMPWO_W<'a> {
    w: &'a mut W,
}
impl<'a> ACMPWO_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: ACMPWO_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "The positive input voltage is outside the window"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ACMPWO_A::_0)
    }
    #[doc = "The positive input voltage is in the window"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(ACMPWO_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - Comparator 0 Interrupt Flag This bit is set by hardware when the edge condition defined by INTPOL (ACMP_CTL0\\[9:8\\]) is detected on comparator 0 output. This will generate an interrupt if ACMPIE (ACMP_CTL0\\[1\\]) is set to 1. Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn acmpif0(&self) -> ACMPIF0_R {
        ACMPIF0_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Comparator 1 Interrupt Flag This bit is set by hardware when the edge condition defined by INTPOL (ACMP_CTL1\\[9:8\\]) is detected on comparator 1 output. This will cause an interrupt if ACMPIE (ACMP_CTL1\\[1\\]) is set to 1. Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn acmpif1(&self) -> ACMPIF1_R {
        ACMPIF1_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 4 - Comparator 0 Output Synchronized to the PCLK to allow reading by software. Cleared when the comparator 0 is disabled, i.e. ACMPEN (ACMP_CTL0\\[0\\]) is cleared to 0."]
    #[inline(always)]
    pub fn acmpo0(&self) -> ACMPO0_R {
        ACMPO0_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Comparator 1 Output Synchronized to the PCLK to allow reading by software. Cleared when the comparator 1 is disabled, i.e. ACMPEN (ACMP_CTL1\\[0\\]) is cleared to 0."]
    #[inline(always)]
    pub fn acmpo1(&self) -> ACMPO1_R {
        ACMPO1_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 8 - Comparator 0 Power-down Wake-up Interrupt Flag This bit will be set to 1 when ACMP0 wake-up interrupt event occurs. Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn wkif0(&self) -> WKIF0_R {
        WKIF0_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - Comparator 1 Power-down Wake-up Interrupt Flag This bit will be set to 1 when ACMP1 wake-up interrupt event occurs. Note: Write 1 to clear this bit to 0."]
    #[inline(always)]
    pub fn wkif1(&self) -> WKIF1_R {
        WKIF1_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 12 - Comparator 0 Status Synchronized to the PCLK to allow reading by software. Cleared when the comparator 0 is disabled, i.e. ACMPEN (ACMP_CTL0\\[0\\]) is cleared to 0."]
    #[inline(always)]
    pub fn acmps0(&self) -> ACMPS0_R {
        ACMPS0_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 13 - Comparator 1 Status Synchronized to the PCLK to allow reading by software. Cleared when the comparator 1 is disabled, i.e. ACMPEN (ACMP_CTL1\\[0\\]) is cleared to 0."]
    #[inline(always)]
    pub fn acmps1(&self) -> ACMPS1_R {
        ACMPS1_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    #[doc = "Bit 16 - Comparator Window Output This bit shows the output status of window compare mode"]
    #[inline(always)]
    pub fn acmpwo(&self) -> ACMPWO_R {
        ACMPWO_R::new(((self.bits >> 16) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Comparator 0 Interrupt Flag This bit is set by hardware when the edge condition defined by INTPOL (ACMP_CTL0\\[9:8\\]) is detected on comparator 0 output. This will generate an interrupt if ACMPIE (ACMP_CTL0\\[1\\]) is set to 1. Note: Write 1 to clear this bit to 0."]
    ...
    #[doc = "Bit 12 - Comparator 0 Status Synchronized to the PCLK to allow reading by software. Cleared when the comparator 0 is disabled, i.e. ACMPEN (ACMP_CTL0\\[0\\]) is cleared to 0."]
    #[inline(always)]
    pub fn acmps0(&mut self) -> ACMPS0_W {
        ACMPS0_W { w: self }
    }
    #[doc = "Bit 13 - Comparator 1 Status Synchronized to the PCLK to allow reading by software. Cleared when the comparator 1 is disabled, i.e. ACMPEN (ACMP_CTL1\\[0\\]) is cleared to 0."]
    #[inline(always)]
    pub fn acmps1(&mut self) -> ACMPS1_W {
        ACMPS1_W { w: self }
    }
    #[doc = "Bit 16 - Comparator Window Output This bit shows the output status of window compare mode"]
    #[inline(always)]
    pub fn acmpwo(&mut self) -> ACMPWO_W {
        ACMPWO_W { w: self }
    }
