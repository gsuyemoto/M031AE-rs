...
impl From<crate::R<ACMP_CTL1_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<ACMP_CTL1_SPEC>> for W {
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 8:9 - Interrupt Condition Polarity Selection ACMPIF1 will be set to 1 when comparator output edge condition is detected."]
    #[inline(always)]
