#[doc = "Register `ACMP_CTL0` reader"]
pub struct R(crate::R<ACMP_CTL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ACMP_CTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ACMP_CTL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ACMP_CTL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ACMP_CTL0` writer"]
pub struct W(crate::W<ACMP_CTL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ACMP_CTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ACMP_CTL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ACMP_CTL0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ACMPIE_A {
    #[doc = "0: Comparator 0 interrupt Disabled"]
    _0 = 0,
    #[doc = "1: Comparator 0 interrupt Enabled. If WKEN (ACMP_CTL0\\[16\\]) is set to 1, the wake-up interrupt function will be enabled as well"]
    _1 = 1,
}
...
impl<'a> ACMPIE_W<'a> {
    ...
    #[doc = "Comparator 0 interrupt Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ACMPIE_A::_0)
    }
    #[doc = "Comparator 0 interrupt Enabled. If WKEN (ACMP_CTL0\\[16\\]) is set to 1, the wake-up interrupt function will be enabled as well"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "Comparator Output Inverse\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ACMPOINV_A {
    #[doc = "0: Comparator 0 output inverse Disabled"]
    _0 = 0,
    #[doc = "1: Comparator 0 output inverse Enabled"]
    _1 = 1,
}
...
#[doc = "Field `ACMPOINV` reader - Comparator Output Inverse"]
...
#[doc = "Field `ACMPOINV` writer - Comparator Output Inverse"]
...
impl<'a> ACMPOINV_W<'a> {
    ...
    #[doc = "Comparator 0 output inverse Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ACMPOINV_A::_0)
    }
    #[doc = "Comparator 0 output inverse Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[repr(u8)]
pub enum POSSEL_A {
    #[doc = "0: Input from ACMP0_P0"]
    _0 = 0,
    #[doc = "1: Input from ACMP0_P1"]
    _1 = 1,
    #[doc = "2: Input from ACMP0_P2"]
    _2 = 2,
    #[doc = "3: Input from ACMP0_P3"]
    _3 = 3,
}
...
impl<'a> POSSEL_W<'a> {
    ...
    #[doc = "Input from ACMP0_P0"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(POSSEL_A::_0)
    }
    #[doc = "Input from ACMP0_P1"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(POSSEL_A::_1)
    }
    #[doc = "Input from ACMP0_P2"]
    #[inline(always)]
    pub fn _2(self) -> &'a mut W {
        self.variant(POSSEL_A::_2)
    }
    #[doc = "Input from ACMP0_P3"]
    #[inline(always)]
    pub fn _3(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OUTSEL_A {
    #[doc = "0: Comparator 0 output to ACMP0_O pin is unfiltered comparator output"]
    _0 = 0,
    #[doc = "1: Comparator 0 output to ACMP0_O pin is from filter output"]
    _1 = 1,
}
...
impl<'a> OUTSEL_W<'a> {
    ...
    #[doc = "Comparator 0 output to ACMP0_O pin is unfiltered comparator output"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(OUTSEL_A::_0)
    }
    #[doc = "Comparator 0 output to ACMP0_O pin is from filter output"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
pub enum FILTSEL_A {
    ...
    _0 = 0,
    #[doc = "1: ACMP0 output is sampled 1 consecutive PCLK"]
    _1 = 1,
    #[doc = "2: ACMP0 output is sampled 2 consecutive PCLKs"]
    _2 = 2,
    #[doc = "3: ACMP0 output is sampled 4 consecutive PCLKs"]
    _3 = 3,
    #[doc = "4: ACMP0 output is sampled 8 consecutive PCLKs"]
    _4 = 4,
    #[doc = "5: ACMP0 output is sampled 16 consecutive PCLKs"]
    _5 = 5,
    #[doc = "6: ACMP0 output is sampled 32 consecutive PCLKs"]
    _6 = 6,
    #[doc = "7: ACMP0 output is sampled 64 consecutive PCLKs"]
    _7 = 7,
}
...
impl<'a> FILTSEL_W<'a> {
    ...
    #[doc = "ACMP0 output is sampled 1 consecutive PCLK"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(FILTSEL_A::_1)
    }
    #[doc = "ACMP0 output is sampled 2 consecutive PCLKs"]
    #[inline(always)]
    pub fn _2(self) -> &'a mut W {
        self.variant(FILTSEL_A::_2)
    }
    #[doc = "ACMP0 output is sampled 4 consecutive PCLKs"]
    #[inline(always)]
    pub fn _3(self) -> &'a mut W {
        self.variant(FILTSEL_A::_3)
    }
    #[doc = "ACMP0 output is sampled 8 consecutive PCLKs"]
    #[inline(always)]
    pub fn _4(self) -> &'a mut W {
        self.variant(FILTSEL_A::_4)
    }
    #[doc = "ACMP0 output is sampled 16 consecutive PCLKs"]
    #[inline(always)]
    pub fn _5(self) -> &'a mut W {
        self.variant(FILTSEL_A::_5)
    }
    #[doc = "ACMP0 output is sampled 32 consecutive PCLKs"]
    #[inline(always)]
    pub fn _6(self) -> &'a mut W {
        self.variant(FILTSEL_A::_6)
    }
    #[doc = "ACMP0 output is sampled 64 consecutive PCLKs"]
    #[inline(always)]
...
#[doc = "Power-down Wake-up Enable Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum WKEN_A {
...
#[doc = "Field `WKEN` reader - Power-down Wake-up Enable Bit"]
...
#[doc = "Field `WKEN` writer - Power-down Wake-up Enable Bit"]
pub struct WKEN_W<'a> {
    w: &'a mut W,
}
impl<'a> WKEN_W<'a> {
...
#[doc = "Window Latch Mode Enable Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum WLATEN_A {
    #[doc = "0: Window Latch Mode Disabled"]
    _0 = 0,
    #[doc = "1: Window Latch Mode Enabled"]
    _1 = 1,
}
impl From<WLATEN_A> for bool {
    #[inline(always)]
    fn from(variant: WLATEN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `WLATEN` reader - Window Latch Mode Enable Bit"]
pub struct WLATEN_R(crate::FieldReader<bool, WLATEN_A>);
impl WLATEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        WLATEN_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> WLATEN_A {
        match self.bits {
            false => WLATEN_A::_0,
            true => WLATEN_A::_1,
        }
...
impl core::ops::Deref for WLATEN_R {
    type Target = crate::FieldReader<bool, WLATEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `WLATEN` writer - Window Latch Mode Enable Bit"]
pub struct WLATEN_W<'a> {
    w: &'a mut W,
}
impl<'a> WLATEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: WLATEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Window Latch Mode Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(WLATEN_A::_0)
    }
    #[doc = "Window Latch Mode Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(WLATEN_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
#[doc = "Window Compare Mode Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum WCMPSEL_A {
    #[doc = "0: Window Compare Mode Disabled"]
    _0 = 0,
    #[doc = "1: Window Compare Mode Selected"]
    _1 = 1,
}
impl From<WCMPSEL_A> for bool {
    #[inline(always)]
    fn from(variant: WCMPSEL_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `WCMPSEL` reader - Window Compare Mode Selection"]
pub struct WCMPSEL_R(crate::FieldReader<bool, WCMPSEL_A>);
impl WCMPSEL_R {
    pub(crate) fn new(bits: bool) -> Self {
        WCMPSEL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> WCMPSEL_A {
        match self.bits {
            false => WCMPSEL_A::_0,
            true => WCMPSEL_A::_1,
        }
...
impl core::ops::Deref for WCMPSEL_R {
    type Target = crate::FieldReader<bool, WCMPSEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `WCMPSEL` writer - Window Compare Mode Selection"]
pub struct WCMPSEL_W<'a> {
    w: &'a mut W,
}
impl<'a> WCMPSEL_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: WCMPSEL_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Window Compare Mode Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(WCMPSEL_A::_0)
    }
    #[doc = "Window Compare Mode Selected"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(WCMPSEL_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 3 - Comparator Output Inverse"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:9 - Interrupt Condition Polarity Selection ACMPIF0 will be set to 1 when comparator output edge condition is detected."]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - Power-down Wake-up Enable Bit"]
    #[inline(always)]
    pub fn wken(&self) -> WKEN_R {
        WKEN_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 17 - Window Latch Mode Enable Bit"]
    #[inline(always)]
    pub fn wlaten(&self) -> WLATEN_R {
        WLATEN_R::new(((self.bits >> 17) & 0x01) != 0)
    }
    #[doc = "Bit 18 - Window Compare Mode Selection"]
    #[inline(always)]
    pub fn wcmpsel(&self) -> WCMPSEL_R {
        WCMPSEL_R::new(((self.bits >> 18) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Comparator Enable Bit"]
    ...
    #[doc = "Bit 17 - Window Latch Mode Enable Bit"]
    #[inline(always)]
    pub fn wlaten(&mut self) -> WLATEN_W {
        WLATEN_W { w: self }
    }
    #[doc = "Bit 18 - Window Compare Mode Selection"]
    #[inline(always)]
    pub fn wcmpsel(&mut self) -> WCMPSEL_W {
        WCMPSEL_W { w: self }
    }
...
#[doc = "Analog Comparator 0 Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [acmp_ctl0](index.html) module"]
pub struct ACMP_CTL0_SPEC;
impl crate::RegisterSpec for ACMP_CTL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [acmp_ctl0::R](R) reader structure"]
impl crate::Readable for ACMP_CTL0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [acmp_ctl0::W](W) writer structure"]
impl crate::Writable for ACMP_CTL0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ACMP_CTL0 to value 0"]
impl crate::Resettable for ACMP_CTL0_SPEC {
    #[inline(always)]
