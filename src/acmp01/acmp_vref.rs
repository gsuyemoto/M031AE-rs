...
impl From<crate::R<ACMP_VREF_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<ACMP_VREF_SPEC>> for W {
    #[inline(always)]
...
pub enum CRVSSEL_A {
    ...
    _0 = 0,
    #[doc = "1: VREF is selected as as CRV source voltage"]
    _1 = 1,
}
...
impl<'a> CRVSSEL_W<'a> {
    ...
    #[doc = "VREF is selected as as CRV source voltage"]
    #[inline(always)]
