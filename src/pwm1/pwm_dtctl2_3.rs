#[doc = "Register `PWM_DTCTL2_3` reader"]
pub struct R(crate::R<PWM_DTCTL2_3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM_DTCTL2_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWM_DTCTL2_3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWM_DTCTL2_3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PWM_DTCTL2_3` writer"]
pub struct W(crate::W<PWM_DTCTL2_3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWM_DTCTL2_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PWM_DTCTL2_3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWM_DTCTL2_3_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Enable Dead-time Insertion for PWM Pair (PWM_CH0, PWM_CH1) (PWM_CH2, PWM_CH3) (PWM_CH4, PWM_CH5) (Write Protect)\nDead-time insertion is only active when this pair of complementary PWM is enabled. If dead- time insertion is inactive, the outputs of pin pair are complementary without any delay.\nNote: This bit is write protected. Refer to SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DTEN_A {
    #[doc = "0: Dead-time insertion Disabled on the pin pair"]
    _0 = 0,
    #[doc = "1: Dead-time insertion Enabled on the pin pair"]
    _1 = 1,
}
...
#[doc = "Field `DTEN` reader - Enable Dead-time Insertion for PWM Pair (PWM_CH0, PWM_CH1) (PWM_CH2, PWM_CH3) (PWM_CH4, PWM_CH5) (Write Protect)\nDead-time insertion is only active when this pair of complementary PWM is enabled. If dead- time insertion is inactive, the outputs of pin pair are complementary without any delay.\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
...
#[doc = "Field `DTEN` writer - Enable Dead-time Insertion for PWM Pair (PWM_CH0, PWM_CH1) (PWM_CH2, PWM_CH3) (PWM_CH4, PWM_CH5) (Write Protect)\nDead-time insertion is only active when this pair of complementary PWM is enabled. If dead- time insertion is inactive, the outputs of pin pair are complementary without any delay.\nNote: This bit is write protected. Refer to SYS_REGLCTL register."]
pub struct DTEN_W<'a> {
    w: &'a mut W,
}
impl<'a> DTEN_W<'a> {
    ...
    #[doc = "Dead-time insertion Disabled on the pin pair"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(DTEN_A::_0)
    }
    #[doc = "Dead-time insertion Enabled on the pin pair"]
    #[inline(always)]
...
#[doc = "Field `DTCKSEL` reader - Dead-time Clock Select (Write Protect)\nNote: This bit is write protected. Refer to REGWRPROT register."]
...
#[doc = "Field `DTCKSEL` writer - Dead-time Clock Select (Write Protect)\nNote: This bit is write protected. Refer to REGWRPROT register."]
...
impl R {
    #[doc = "Bits 0:11 - Dead-time Counter (Write Protect) The dead-time can be calculated from the following formula: Note: This bit is write protected. Refer to SYS_REGLCTL register."]
    #[inline(always)]
    ...
    #[doc = "Bit 24 - Dead-time Clock Select (Write Protect) Note: This bit is write protected. Refer to REGWRPROT register."]
    #[inline(always)]
...
#[doc = "PWM Dead-time Control Register 2/3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm_dtctl2_3](index.html) module"]
pub struct PWM_DTCTL2_3_SPEC;
impl crate::RegisterSpec for PWM_DTCTL2_3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm_dtctl2_3::R](R) reader structure"]
impl crate::Readable for PWM_DTCTL2_3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwm_dtctl2_3::W](W) writer structure"]
impl crate::Writable for PWM_DTCTL2_3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PWM_DTCTL2_3 to value 0"]
impl crate::Resettable for PWM_DTCTL2_3_SPEC {
    #[inline(always)]
