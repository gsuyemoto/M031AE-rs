#[doc = "Register `PWM_RCAPDAT5` reader"]
pub struct R(crate::R<PWM_RCAPDAT5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM_RCAPDAT5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWM_RCAPDAT5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWM_RCAPDAT5_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "PWM Rising Capture Data Register 5\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm_rcapdat5](index.html) module"]
pub struct PWM_RCAPDAT5_SPEC;
impl crate::RegisterSpec for PWM_RCAPDAT5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm_rcapdat5::R](R) reader structure"]
impl crate::Readable for PWM_RCAPDAT5_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PWM_RCAPDAT5 to value 0"]
impl crate::Resettable for PWM_RCAPDAT5_SPEC {
    #[inline(always)]
