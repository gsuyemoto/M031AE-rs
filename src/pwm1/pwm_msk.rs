...
impl From<crate::R<PWM_MSK_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PWM_MSK_SPEC>> for W {
    #[inline(always)]
...
pub enum MSKDAT0_A {
    #[doc = "0: Output logic low to PWM channel n"]
    _0 = 0,
    #[doc = "1: Output logic high to PWM channel n"]
    _1 = 1,
}
...
#[doc = "Field `MSKDAT0` reader - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT0` writer - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
impl<'a> MSKDAT0_W<'a> {
    ...
    #[doc = "Output logic low to PWM channel n"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(MSKDAT0_A::_0)
    }
    #[doc = "Output logic high to PWM channel n"]
    #[inline(always)]
...
#[doc = "Field `MSKDAT1` reader - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT1` writer - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT2` reader - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT2` writer - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT3` reader - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT3` writer - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT4` reader - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT4` writer - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT5` reader - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
#[doc = "Field `MSKDAT5` writer - PWM Mask Data Bit\nThis data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
...
impl R {
    #[doc = "Bit 0 - PWM Mask Data Bit This data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
    #[inline(always)]
    pub fn mskdat0(&self) -> MSKDAT0_R {
        MSKDAT0_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - PWM Mask Data Bit This data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
    #[inline(always)]
    pub fn mskdat1(&self) -> MSKDAT1_R {
        MSKDAT1_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - PWM Mask Data Bit This data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
    #[inline(always)]
    pub fn mskdat2(&self) -> MSKDAT2_R {
        MSKDAT2_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - PWM Mask Data Bit This data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
    #[inline(always)]
    pub fn mskdat3(&self) -> MSKDAT3_R {
        MSKDAT3_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - PWM Mask Data Bit This data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
    #[inline(always)]
    pub fn mskdat4(&self) -> MSKDAT4_R {
        MSKDAT4_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - PWM Mask Data Bit This data bit control the state of PWMn output pin, if corresponding mask function is enabled. Each bit n controls the corresponding PWM channel n."]
    #[inline(always)]
