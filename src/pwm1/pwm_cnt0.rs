#[doc = "Register `PWM_CNT0` reader"]
pub struct R(crate::R<PWM_CNT0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM_CNT0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWM_CNT0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWM_CNT0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "PWM Counter Register 0\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm_cnt0](index.html) module"]
pub struct PWM_CNT0_SPEC;
impl crate::RegisterSpec for PWM_CNT0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm_cnt0::R](R) reader structure"]
impl crate::Readable for PWM_CNT0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PWM_CNT0 to value 0"]
impl crate::Resettable for PWM_CNT0_SPEC {
    #[inline(always)]
