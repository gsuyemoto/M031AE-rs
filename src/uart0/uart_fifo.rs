...
#[doc = "Field `RXOFF` reader - Receiver Disable Bit\nThe receiver is disabled or not (set 1 to disable receiver).\nNote: This bit is used for RS-485 Normal Multi-drop mode. It should be programmed before RS485NMM (UART_ALTCTL \\[8\\]) is programmed."]
...
#[doc = "Field `RXOFF` writer - Receiver Disable Bit\nThe receiver is disabled or not (set 1 to disable receiver).\nNote: This bit is used for RS-485 Normal Multi-drop mode. It should be programmed before RS485NMM (UART_ALTCTL \\[8\\]) is programmed."]
...
#[doc = "Field `RTSTRGLV` reader - nRTS Trigger Level for Auto-flow Control\nNote: This field is used for auto nRTS flow control."]
...
#[doc = "Field `RTSTRGLV` writer - nRTS Trigger Level for Auto-flow Control\nNote: This field is used for auto nRTS flow control."]
...
impl R {
    #[doc = "Bit 1 - RX Field Software Reset When RXRST (UART_FIFO\\[1\\]) is set, all the byte in the receiver FIFO and RX internal state machine are cleared. Note 1: This bit will automatically clear at least 3 UART peripheral clock cycles. Note 2: Before setting this bit, it should wait for the RXIDLE (UART_FIFOSTS\\[29\\]) be set."]
    #[inline(always)]
    pub fn rxrst(&self) -> RXRST_R {
        RXRST_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - TX Field Software Reset When TXRST (UART_FIFO\\[2\\]) is set, all the byte in the transmit FIFO and TX internal state machine are cleared. Note 1: This bit will automatically clear at least 3 UART peripheral clock cycles. Note 2: Before setting this bit, it should wait for the TXEMPTYF (UART_FIFOSTS\\[28\\]) be set."]
    #[inline(always)]
    pub fn txrst(&self) -> TXRST_R {
        TXRST_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bits 4:7 - RX FIFO Interrupt Trigger Level When the number of bytes in the receive FIFO equals the RFITL, the RDAIF (UART_INTSTS\\[0\\]) will be set (if RDAIEN (UART_INTEN \\[0\\]) enabled, and an interrupt will be generated)."]
    #[inline(always)]
    pub fn rfitl(&self) -> RFITL_R {
        RFITL_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
    #[doc = "Bit 8 - Receiver Disable Bit The receiver is disabled or not (set 1 to disable receiver). Note: This bit is used for RS-485 Normal Multi-drop mode. It should be programmed before RS485NMM (UART_ALTCTL \\[8\\]) is programmed."]
    #[inline(always)]
    pub fn rxoff(&self) -> RXOFF_R {
        RXOFF_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bits 16:19 - nRTS Trigger Level for Auto-flow Control Note: This field is used for auto nRTS flow control."]
    #[inline(always)]
