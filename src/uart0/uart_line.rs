...
impl From<crate::R<UART_LINE_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<UART_LINE_SPEC>> for W {
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PBE_A {
    #[doc = "0: Parity bit generated Disabled"]
    _0 = 0,
...
impl<'a> PBE_W<'a> {
    ...
    #[doc = "Parity bit generated Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
#[doc = "Field `PSS` reader - Parity Bit Source Selection\nThe parity bit can be selected to be generated and checked automatically or by software.\nNote 1: This bit has effect only when PBE (UART_LINE\\[3\\]) is set.\nNote 2: If PSS is 0, the parity bit is transmitted and checked automatically. If PSS is 1, the transmitted parity bit value can be determined by writing PARITY (UART_DAT\\[8\\]) and the parity bit can be read by reading PARITY (UART_DAT\\[8\\])."]
...
#[doc = "Field `PSS` writer - Parity Bit Source Selection\nThe parity bit can be selected to be generated and checked automatically or by software.\nNote 1: This bit has effect only when PBE (UART_LINE\\[3\\]) is set.\nNote 2: If PSS is 0, the parity bit is transmitted and checked automatically. If PSS is 1, the transmitted parity bit value can be determined by writing PARITY (UART_DAT\\[8\\]) and the parity bit can be read by reading PARITY (UART_DAT\\[8\\])."]
pub struct PSS_W<'a> {
    w: &'a mut W,
}
impl<'a> PSS_W<'a> {
    ...
    #[doc = "Parity bit is generated by EPE (UART_LINE\\[4\\]) and SPE (UART_LINE\\[5\\]) setting and checked automatically"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(PSS_A::_0)
    }
    #[doc = "Parity bit generated and checked by software"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "TX Data Inverted\nNote 1: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller.\nNote 2: This bit is valid when FUNCSEL (UART_FUNCSEL\\[1:0\\]) is select UART, LIN or RS485 function.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TXDINV_A {
    #[doc = "0: Transmitted data signal inverted Disabled"]
    _0 = 0,
    #[doc = "1: Transmitted data signal inverted Enabled"]
    _1 = 1,
}
impl From<TXDINV_A> for bool {
    #[inline(always)]
    fn from(variant: TXDINV_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TXDINV` reader - TX Data Inverted\nNote 1: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller.\nNote 2: This bit is valid when FUNCSEL (UART_FUNCSEL\\[1:0\\]) is select UART, LIN or RS485 function."]
pub struct TXDINV_R(crate::FieldReader<bool, TXDINV_A>);
impl TXDINV_R {
    pub(crate) fn new(bits: bool) -> Self {
        TXDINV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> TXDINV_A {
        match self.bits {
            false => TXDINV_A::_0,
            true => TXDINV_A::_1,
        }
...
impl core::ops::Deref for TXDINV_R {
    type Target = crate::FieldReader<bool, TXDINV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `TXDINV` writer - TX Data Inverted\nNote 1: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller.\nNote 2: This bit is valid when FUNCSEL (UART_FUNCSEL\\[1:0\\]) is select UART, LIN or RS485 function."]
pub struct TXDINV_W<'a> {
    w: &'a mut W,
}
impl<'a> TXDINV_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TXDINV_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Transmitted data signal inverted Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(TXDINV_A::_0)
    }
    #[doc = "Transmitted data signal inverted Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(TXDINV_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXDINV_A {
    #[doc = "0: Received data signal inverted Disabled"]
    _0 = 0,
    #[doc = "1: Received data signal inverted Enabled"]
    _1 = 1,
}
impl From<RXDINV_A> for bool {
    #[inline(always)]
    fn from(variant: RXDINV_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `RXDINV` reader - RX Data Inverted\nNote 1: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller.\nNote 2: This bit is valid when FUNCSEL (UART_FUNCSEL\\[1:0\\]) is select UART, LIN or RS485 function."]
pub struct RXDINV_R(crate::FieldReader<bool, RXDINV_A>);
impl RXDINV_R {
    pub(crate) fn new(bits: bool) -> Self {
        RXDINV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> RXDINV_A {
        match self.bits {
            false => RXDINV_A::_0,
            true => RXDINV_A::_1,
        }
...
impl core::ops::Deref for RXDINV_R {
    type Target = crate::FieldReader<bool, RXDINV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `RXDINV` writer - RX Data Inverted\nNote 1: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller.\nNote 2: This bit is valid when FUNCSEL (UART_FUNCSEL\\[1:0\\]) is select UART, LIN or RS485 function."]
pub struct RXDINV_W<'a> {
    w: &'a mut W,
}
impl<'a> RXDINV_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: RXDINV_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Received data signal inverted Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(RXDINV_A::_0)
    }
    #[doc = "Received data signal inverted Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(RXDINV_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    #[doc = "Bits 0:1 - Word Length Selection This field sets UART word length."]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - Parity Bit Enable Bit Note: Parity bit is generated on each outgoing character and is checked on each incoming data."]
    #[inline(always)]
    pub fn pbe(&self) -> PBE_R {
        PBE_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - Even Parity Enable Bit Note: This bit has effect only when PBE (UART_LINE\\[3\\]) is set."]
    #[inline(always)]
    pub fn epe(&self) -> EPE_R {
        EPE_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Stick Parity Enable Bit Note: If PBE (UART_LINE\\[3\\]) and EPE (UART_LINE\\[4\\]) are logic 1, the parity bit is transmitted and checked as logic 0. If PBE (UART_LINE\\[3\\]) is 1 and EPE (UART_LINE\\[4\\]) is 0 then the parity bit is transmitted and checked as 1."]
    #[inline(always)]
    pub fn spe(&self) -> SPE_R {
        SPE_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - Break Control Bit Note: When this bit is set to logic 1, the transmitted serial data output (TX) is forced to the Spacing State (logic 0). This bit acts only on TX line and has no effect on the transmitter logic."]
    #[inline(always)]
    ...
    pub fn pss(&self) -> PSS_R {
        PSS_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    #[doc = "Bit 8 - TX Data Inverted Note 1: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller. Note 2: This bit is valid when FUNCSEL (UART_FUNCSEL\\[1:0\\]) is select UART, LIN or RS485 function."]
    #[inline(always)]
    pub fn txdinv(&self) -> TXDINV_R {
        TXDINV_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - RX Data Inverted Note 1: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller. Note 2: This bit is valid when FUNCSEL (UART_FUNCSEL\\[1:0\\]) is select UART, LIN or RS485 function."]
    #[inline(always)]
    pub fn rxdinv(&self) -> RXDINV_R {
        RXDINV_R::new(((self.bits >> 9) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - Word Length Selection This field sets UART word length."]
    ...
    #[doc = "Bit 8 - TX Data Inverted Note 1: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller. Note 2: This bit is valid when FUNCSEL (UART_FUNCSEL\\[1:0\\]) is select UART, LIN or RS485 function."]
    #[inline(always)]
    pub fn txdinv(&mut self) -> TXDINV_W {
        TXDINV_W { w: self }
    }
    #[doc = "Bit 9 - RX Data Inverted Note 1: Before setting this bit, TXRXDIS (UART_FUNCSEL\\[3\\]) should be set then waited for TXRXACT (UART_FIFOSTS\\[31\\]) is cleared. When the configuration is done, cleared TXRXDIS (UART_FUNCSEL\\[3\\]) to activate UART controller. Note 2: This bit is valid when FUNCSEL (UART_FUNCSEL\\[1:0\\]) is select UART, LIN or RS485 function."]
    #[inline(always)]
    pub fn rxdinv(&mut self) -> RXDINV_W {
        RXDINV_W { w: self }
    }
