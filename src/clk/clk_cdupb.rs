...
impl From<crate::R<CLK_CDUPB_SPEC>> for R {
    #[inline(always)]
...
#[doc = "Field `UPERBD` writer - HXT Clock Frequency Range Detector Upper Boundary Value\nThe bits define the maximum value of frequency range detector window.\nWhen HXT frequency is higher than this maximum frequency value, the HXT Clock Frequency Range Detector Interrupt Flag will be set to 1."]
...
impl R {
    #[doc = "Bits 0:9 - HXT Clock Frequency Range Detector Upper Boundary Value The bits define the maximum value of frequency range detector window. When HXT frequency is higher than this maximum frequency value, the HXT Clock Frequency Range Detector Interrupt Flag will be set to 1."]
    #[inline(always)]
