...
impl From<crate::R<CLK_CLKOCTL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<CLK_CLKOCTL_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:3 - Clock Output Frequency Selection The formula of output frequency is Fin is the input clock frequency. Fout is the frequency of divider output clock. N is the 4-bit value of FREQSEL\\[3:0\\]."]
    #[inline(always)]
