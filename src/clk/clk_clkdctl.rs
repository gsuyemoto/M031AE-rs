...
impl From<crate::R<CLK_CLKDCTL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<CLK_CLKDCTL_SPEC>> for W {
    #[inline(always)]
...
pub enum HXTFDEN_A {
    #[doc = "0: External high speed crystal oscillator (HXT) clock fail detector Disabled"]
    _0 = 0,
    #[doc = "1: External high speed crystal oscillator (HXT) clock fail detector Enabled"]
    _1 = 1,
}
...
impl<'a> HXTFDEN_W<'a> {
    ...
    #[doc = "External high speed crystal oscillator (HXT) clock fail detector Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(HXTFDEN_A::_0)
    }
    #[doc = "External high speed crystal oscillator (HXT) clock fail detector Enabled"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HXTFIEN_A {
    #[doc = "0: External high speed crystal oscillator (HXT) clock fail interrupt Disabled"]
    _0 = 0,
    #[doc = "1: External high speed crystal oscillator (HXT) clock fail interrupt Enabled"]
    _1 = 1,
}
...
impl<'a> HXTFIEN_W<'a> {
    ...
    #[doc = "External high speed crystal oscillator (HXT) clock fail interrupt Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(HXTFIEN_A::_0)
    }
    #[doc = "External high speed crystal oscillator (HXT) clock fail interrupt Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LXTFDEN_A {
    #[doc = "0: External low speed crystal oscillator (LXT) clock fail detector Disabled"]
    _0 = 0,
    #[doc = "1: External low speed crystal oscillator (LXT) clock fail detector Enabled"]
    _1 = 1,
}
...
impl<'a> LXTFDEN_W<'a> {
    ...
    #[doc = "External low speed crystal oscillator (LXT) clock fail detector Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(LXTFDEN_A::_0)
    }
    #[doc = "External low speed crystal oscillator (LXT) clock fail detector Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LXTFIEN_A {
    #[doc = "0: External low speed crystal oscillator (LXT) clock fail interrupt Disabled"]
    _0 = 0,
    #[doc = "1: External low speed crystal oscillator (LXT) clock fail interrupt Enabled"]
    _1 = 1,
}
...
impl<'a> LXTFIEN_W<'a> {
    ...
    #[doc = "External low speed crystal oscillator (LXT) clock fail interrupt Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(LXTFIEN_A::_0)
    }
    #[doc = "External low speed crystal oscillator (LXT) clock fail interrupt Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "HXT Clock Frequency Range Detector Enable Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HXTFQDEN_A {
    #[doc = "0: External high speed crystal oscillator (HXT) clock frequency range detector Disabled"]
    _0 = 0,
    #[doc = "1: External high speed crystal oscillator (HXT) clock frequency range detector Enabled"]
    _1 = 1,
}
...
#[doc = "Field `HXTFQDEN` reader - HXT Clock Frequency Range Detector Enable Bit"]
...
#[doc = "Field `HXTFQDEN` writer - HXT Clock Frequency Range Detector Enable Bit"]
...
impl<'a> HXTFQDEN_W<'a> {
    ...
    #[doc = "External high speed crystal oscillator (HXT) clock frequency range detector Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(HXTFQDEN_A::_0)
    }
    #[doc = "External high speed crystal oscillator (HXT) clock frequency range detector Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "HXT Clock Frequency Range Detector Interrupt Enable Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HXTFQIEN_A {
    #[doc = "0: External high speed crystal oscillator (HXT) clock frequency range detector fail interrupt Disabled"]
    _0 = 0,
    #[doc = "1: External high speed crystal oscillator (HXT) clock frequency range detector fail interrupt Enabled"]
    _1 = 1,
}
...
#[doc = "Field `HXTFQIEN` reader - HXT Clock Frequency Range Detector Interrupt Enable Bit"]
...
#[doc = "Field `HXTFQIEN` writer - HXT Clock Frequency Range Detector Interrupt Enable Bit"]
...
impl<'a> HXTFQIEN_W<'a> {
    ...
    #[doc = "External high speed crystal oscillator (HXT) clock frequency range detector fail interrupt Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(HXTFQIEN_A::_0)
    }
    #[doc = "External high speed crystal oscillator (HXT) clock frequency range detector fail interrupt Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 16 - HXT Clock Frequency Range Detector Enable Bit"]
    #[inline(always)]
    pub fn hxtfqden(&self) -> HXTFQDEN_R {
        HXTFQDEN_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 17 - HXT Clock Frequency Range Detector Interrupt Enable Bit"]
    #[inline(always)]
