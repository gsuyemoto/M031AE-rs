...
impl From<crate::R<CLK_CLKSEL1_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<CLK_CLKSEL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLK_CLKSEL1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Watchdog Timer Clock Source Selection (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register. 2. Will be forced to 11 when CONFIG0\\[31\\], CONFIG0\\[4\\], CONFIG0\\[3\\]
...
pub enum WDTSEL_A {
    #[doc = "0: Reserved."]
    _0 = 0,
    #[doc = "1: Clock source from external low speed crystal oscillator (LXT)"]
    _1 = 1,
    #[doc = "2: Clock source from HCLK/2048"]
    _2 = 2,
    #[doc = "3: Clock source from internal low speed RC oscillator (LIRC)"]
    _3 = 3,
}
...
#[doc = "Window Watchdog Timer Clock Source Selection (Write Protect)\n\nValue on reset: 2"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum WWDTSEL_A {
    #[doc = "2: Clock source from HCLK/2048"]
...
#[doc = "Field `WWDTSEL` reader - Window Watchdog Timer Clock Source Selection (Write Protect)"]
...
#[doc = "Field `WWDTSEL` writer - Window Watchdog Timer Clock Source Selection (Write Protect)"]
...
pub enum CLKOSEL_A {
    ...
    _3 = 3,
    #[doc = "4: Clock source from internal low speed RC oscillator (LIRC)"]
    _4 = 4,
    #[doc = "5: Clock source from internal high speed RC oscillator (HIRC)"]
    _5 = 5,
    #[doc = "6: Clock source from PLL"]
    _6 = 6,
}
...
impl CLKOSEL_R {
    ...
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<CLKOSEL_A> {
        match self.bits {
            0 => Some(CLKOSEL_A::_0),
            1 => Some(CLKOSEL_A::_1),
            2 => Some(CLKOSEL_A::_2),
...
impl<'a> CLKOSEL_W<'a> {
    ...
    pub fn _4(self) -> &'a mut W {
        self.variant(CLKOSEL_A::_4)
    }
    #[doc = "Clock source from internal high speed RC oscillator (HIRC)"]
    #[inline(always)]
    pub fn _5(self) -> &'a mut W {
        self.variant(CLKOSEL_A::_5)
    }
    #[doc = "Clock source from PLL"]
    #[inline(always)]
    pub fn _6(self) -> &'a mut W {
        self.variant(CLKOSEL_A::_6)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub enum TMR0SEL_A {
    ...
    _2 = 2,
    #[doc = "3: Clock source from external clock TM0 pin"]
    _3 = 3,
    #[doc = "5: Clock source from internal low speed RC oscillator (LIRC)"]
    _5 = 5,
    #[doc = "7: Clock source from internal high speed RC oscillator (HIRC)"]
    _7 = 7,
}
...
impl<'a> TMR0SEL_W<'a> {
    ...
    #[doc = "Clock source from external clock TM0 pin"]
    #[inline(always)]
    pub fn _3(self) -> &'a mut W {
...
pub enum TMR1SEL_A {
    ...
    #[doc = "2: Clock source from PCLK0"]
    _2 = 2,
    #[doc = "3: Clock source from external clock TM1 pin"]
    _3 = 3,
    #[doc = "5: Clock source from internal low speed RC oscillator (LIRC)"]
    _5 = 5,
    #[doc = "7: Clock source from internal high speed RC oscillator (HIRC)"]
...
impl<'a> TMR1SEL_W<'a> {
    ...
    #[doc = "Clock source from external clock TM1 pin"]
    #[inline(always)]
    pub fn _3(self) -> &'a mut W {
...
pub enum TMR2SEL_A {
    ...
    _2 = 2,
    #[doc = "3: Clock source from external clock TM2 pin"]
    _3 = 3,
    #[doc = "5: Clock source from internal low speed RC oscillator (LIRC)"]
    _5 = 5,
    #[doc = "7: Clock source from internal high speed RC oscillator (HIRC)"]
...
impl<'a> TMR2SEL_W<'a> {
    ...
    #[doc = "Clock source from external clock TM2 pin"]
    #[inline(always)]
    pub fn _3(self) -> &'a mut W {
...
pub enum TMR3SEL_A {
    ...
    #[doc = "2: Clock source from PCLK1"]
    _2 = 2,
    #[doc = "3: Clock source from external clock TM3 pin"]
    _3 = 3,
    #[doc = "5: Clock source from internal low speed RC oscillator (LIRC)"]
    _5 = 5,
    #[doc = "7: Clock source from internal high speed RC oscillator (HIRC)"]
...
impl<'a> TMR3SEL_W<'a> {
    ...
    #[doc = "Clock source from external clock TM3 pin"]
    #[inline(always)]
    pub fn _3(self) -> &'a mut W {
...
impl From<UART0SEL_A> for u8 {
    #[inline(always)]
    fn from(variant: UART0SEL_A) -> Self {
        variant as _
    }
}
#[doc = "Field `UART0SEL` reader - UART0 Clock Source Selection\nNote: If PLL is not supported, clock source of selection '001' will be changed to PCLK0.\nNote: If LXT or HXT is not supported, clock source of selection '000' or '010' will be stopped. \nPlease refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
pub struct UART0SEL_R(crate::FieldReader<u8, UART0SEL_A>);
impl UART0SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        UART0SEL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<UART0SEL_A> {
        match self.bits {
            0 => Some(UART0SEL_A::_0),
            1 => Some(UART0SEL_A::_1),
            2 => Some(UART0SEL_A::_2),
            3 => Some(UART0SEL_A::_3),
            4 => Some(UART0SEL_A::_4),
            5 => Some(UART0SEL_A::_5),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `_0`"]
...
impl core::ops::Deref for UART0SEL_R {
    type Target = crate::FieldReader<u8, UART0SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `UART0SEL` writer - UART0 Clock Source Selection\nNote: If PLL is not supported, clock source of selection '001' will be changed to PCLK0.\nNote: If LXT or HXT is not supported, clock source of selection '000' or '010' will be stopped. \nPlease refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
pub struct UART0SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> UART0SEL_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: UART0SEL_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "Clock source from external high speed crystal oscillator (HXT)"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(UART0SEL_A::_0)
    }
    #[doc = "Clock source from PLL"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(UART0SEL_A::_1)
    }
    #[doc = "Clock source from external low speed crystal oscillator (LXT)"]
    #[inline(always)]
    pub fn _2(self) -> &'a mut W {
        self.variant(UART0SEL_A::_2)
    }
    #[doc = "Clock source from internal high speed RC oscillator (HIRC)"]
    #[inline(always)]
    pub fn _3(self) -> &'a mut W {
        self.variant(UART0SEL_A::_3)
    }
    #[doc = "Clock source from PCLK0"]
    #[inline(always)]
    pub fn _4(self) -> &'a mut W {
        self.variant(UART0SEL_A::_4)
    }
    #[doc = "Clock source from internal low speed RC oscillator (LIRC)"]
    #[inline(always)]
    pub fn _5(self) -> &'a mut W {
        self.variant(UART0SEL_A::_5)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl From<UART1SEL_A> for u8 {
    #[inline(always)]
    fn from(variant: UART1SEL_A) -> Self {
        variant as _
    }
}
#[doc = "Field `UART1SEL` reader - UART1 Clock Source Selection\nNote: If PLL is not supported, clock source of selection '001' will be changed to PCLK1.\nNote: If LXT or HXT is not supported, clock source of selection '000' or '010' will be stopped. \nPlease refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
pub struct UART1SEL_R(crate::FieldReader<u8, UART1SEL_A>);
impl UART1SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        UART1SEL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<UART1SEL_A> {
        match self.bits {
            0 => Some(UART1SEL_A::_0),
            1 => Some(UART1SEL_A::_1),
            2 => Some(UART1SEL_A::_2),
            3 => Some(UART1SEL_A::_3),
            4 => Some(UART1SEL_A::_4),
            5 => Some(UART1SEL_A::_5),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `_0`"]
...
impl core::ops::Deref for UART1SEL_R {
    type Target = crate::FieldReader<u8, UART1SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `UART1SEL` writer - UART1 Clock Source Selection\nNote: If PLL is not supported, clock source of selection '001' will be changed to PCLK1.\nNote: If LXT or HXT is not supported, clock source of selection '000' or '010' will be stopped. \nPlease refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
pub struct UART1SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> UART1SEL_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: UART1SEL_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "Clock source from external high speed crystal oscillator (HXT)"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(UART1SEL_A::_0)
    }
    #[doc = "Clock source from PLL"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(UART1SEL_A::_1)
    }
    #[doc = "Clock source from external low speed crystal oscillator (LXT)"]
    #[inline(always)]
    pub fn _2(self) -> &'a mut W {
        self.variant(UART1SEL_A::_2)
    }
    #[doc = "Clock source from internal high speed RC oscillator (HIRC)"]
    #[inline(always)]
    pub fn _3(self) -> &'a mut W {
        self.variant(UART1SEL_A::_3)
    }
    #[doc = "Clock source from PCLK1"]
    #[inline(always)]
    pub fn _4(self) -> &'a mut W {
        self.variant(UART1SEL_A::_4)
    }
    #[doc = "Clock source from internal low speed RC oscillator (LIRC)"]
    #[inline(always)]
    pub fn _5(self) -> &'a mut W {
        self.variant(UART1SEL_A::_5)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    #[doc = "Bits 0:1 - Watchdog Timer Clock Source Selection (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register. 2. Will be forced to 11 when CONFIG0\\[31\\], CONFIG0\\[4\\], CONFIG0\\[3\\]
are all ones. Note: If LXT is not supported, clock source of selection '01' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn wdtsel(&self) -> WDTSEL_R {
        WDTSEL_R::new((self.bits & 0x03) as u8)
    }
    #[doc = "Bits 2:3 - Window Watchdog Timer Clock Source Selection (Write Protect)"]
    #[inline(always)]
    pub fn wwdtsel(&self) -> WWDTSEL_R {
        WWDTSEL_R::new(((self.bits >> 2) & 0x03) as u8)
    }
    #[doc = "Bits 4:6 - Clock Divider Clock Source Selection Note: If PLL is not supported, clock source of selection '110' will be changed to HIRC. Note: If LXT or HXT is not supported, clock source of selection '000' or '001' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn clkosel(&self) -> CLKOSEL_R {
        CLKOSEL_R::new(((self.bits >> 4) & 0x07) as u8)
    }
    #[doc = "Bits 8:10 - TIMER0 Clock Source Selection Note: If LXT or HXT is not supported, clock source of selection '000' or '001' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn tmr0sel(&self) -> TMR0SEL_R {
        TMR0SEL_R::new(((self.bits >> 8) & 0x07) as u8)
    }
    #[doc = "Bits 12:14 - TIMER1 Clock Source Selection Note: If LXT or HXT is not supported, clock source of selection '000' or '001' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn tmr1sel(&self) -> TMR1SEL_R {
        TMR1SEL_R::new(((self.bits >> 12) & 0x07) as u8)
    }
    #[doc = "Bits 16:18 - TIMER2 Clock Source Selection Note: If LXT or HXT is not supported, clock source of selection '000' or '001' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn tmr2sel(&self) -> TMR2SEL_R {
        TMR2SEL_R::new(((self.bits >> 16) & 0x07) as u8)
    }
    #[doc = "Bits 20:22 - TIMER3 Clock Source Selection Note: If LXT or HXT is not supported, clock source of selection '000' or '001' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn tmr3sel(&self) -> TMR3SEL_R {
        TMR3SEL_R::new(((self.bits >> 20) & 0x07) as u8)
    }
    #[doc = "Bits 24:26 - UART0 Clock Source Selection Note: If PLL is not supported, clock source of selection '001' will be changed to PCLK0. Note: If LXT or HXT is not supported, clock source of selection '000' or '010' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn uart0sel(&self) -> UART0SEL_R {
        UART0SEL_R::new(((self.bits >> 24) & 0x07) as u8)
    }
    #[doc = "Bits 28:30 - UART1 Clock Source Selection Note: If PLL is not supported, clock source of selection '001' will be changed to PCLK1. Note: If LXT or HXT is not supported, clock source of selection '000' or '010' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn uart1sel(&self) -> UART1SEL_R {
        UART1SEL_R::new(((self.bits >> 28) & 0x07) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - Watchdog Timer Clock Source Selection (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register. 2. Will be forced to 11 when CONFIG0\\[31\\], CONFIG0\\[4\\], CONFIG0\\[3\\]
are all ones. Note: If LXT is not supported, clock source of selection '01' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    ...
    #[doc = "Bits 24:26 - UART0 Clock Source Selection Note: If PLL is not supported, clock source of selection '001' will be changed to PCLK0. Note: If LXT or HXT is not supported, clock source of selection '000' or '010' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn uart0sel(&mut self) -> UART0SEL_W {
        UART0SEL_W { w: self }
    }
    #[doc = "Bits 28:30 - UART1 Clock Source Selection Note: If PLL is not supported, clock source of selection '001' will be changed to PCLK1. Note: If LXT or HXT is not supported, clock source of selection '000' or '010' will be stopped. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn uart1sel(&mut self) -> UART1SEL_W {
        UART1SEL_W { w: self }
    }
...
#[doc = "`reset()` method sets CLK_CLKSEL1 to value 0x4477_773b"]
