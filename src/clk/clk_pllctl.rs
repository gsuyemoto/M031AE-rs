...
impl From<crate::R<CLK_PLLCTL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<CLK_PLLCTL_SPEC>> for W {
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PLLSRC_A {
    #[doc = "0: PLL source clock from external high-speed crystal oscillator (HXT)"]
    _0 = 0,
    #[doc = "1: PLL source clock from 48 MHz internal high-speed oscillator (HIRC/4)"]
    _1 = 1,
}
...
impl<'a> PLLSRC_W<'a> {
    ...
    #[doc = "PLL source clock from external high-speed crystal oscillator (HXT)"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(PLLSRC_A::_0)
    }
    #[doc = "PLL source clock from 48 MHz internal high-speed oscillator (HIRC/4)"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
pub enum STBSEL_A {
    ...
    _0 = 0,
    #[doc = "1: PLL stable time is 16128 PLL source clock (suitable for source clock is larger than 12 MHz)"]
    _1 = 1,
}
...
impl<'a> STBSEL_W<'a> {
    ...
    #[doc = "PLL stable time is 16128 PLL source clock (suitable for source clock is larger than 12 MHz)"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bits 0:8 - PLL Feedback Divider Control (Write Protect) Refer to the formulas below the table. Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn fbdiv(&self) -> FBDIV_R {
        FBDIV_R::new((self.bits & 0x01ff) as u16)
    }
    #[doc = "Bits 9:13 - PLL Input Divider Control (Write Protect) Refer to the formulas below the table. Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn indiv(&self) -> INDIV_R {
        INDIV_R::new(((self.bits >> 9) & 0x1f) as u8)
    }
    #[doc = "Bits 14:15 - PLL Output Divider Control (Write Protect) Refer to the formulas below the table. Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn outdiv(&self) -> OUTDIV_R {
        OUTDIV_R::new(((self.bits >> 14) & 0x03) as u8)
    }
    #[doc = "Bit 16 - Power-down Mode (Write Protect) If set the PDEN bit to 1 in CLK_PWRCTL register, the PLL will enter Power-down mode, too. Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn pd(&self) -> PD_R {
        PD_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 17 - PLL Bypass Control (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn bp(&self) -> BP_R {
        BP_R::new(((self.bits >> 17) & 0x01) != 0)
    }
    #[doc = "Bit 18 - PLL OE (FOUT Enable) Pin Control (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn oe(&self) -> OE_R {
        OE_R::new(((self.bits >> 18) & 0x01) != 0)
    }
    #[doc = "Bit 19 - PLL Source Clock Selection (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn pllsrc(&self) -> PLLSRC_R {
        PLLSRC_R::new(((self.bits >> 19) & 0x01) != 0)
    }
    #[doc = "Bit 23 - PLL Stable Counter Selection (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
...
#[doc = "`reset()` method sets CLK_PLLCTL to value 0x0005_c25e"]
