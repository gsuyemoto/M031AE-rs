...
impl From<crate::R<CLK_CLKDSTS_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<CLK_CLKDSTS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLK_CLKDSTS_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "HXT Clock Fail Interrupt Flag (Write Protect)\nNote: Write 1 to clear the bit to 0.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HXTFIF_A {
    #[doc = "0: External high speed crystal oscillator (HXT) clock is normal"]
    _0 = 0,
    #[doc = "1: External high speed crystal oscillator (HXT) clock stops"]
    _1 = 1,
}
...
#[doc = "Field `HXTFIF` reader - HXT Clock Fail Interrupt Flag (Write Protect)\nNote: Write 1 to clear the bit to 0."]
...
#[doc = "Field `HXTFIF` writer - HXT Clock Fail Interrupt Flag (Write Protect)\nNote: Write 1 to clear the bit to 0."]
...
impl<'a> HXTFIF_W<'a> {
    ...
    #[doc = "External high speed crystal oscillator (HXT) clock is normal"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(HXTFIF_A::_0)
    }
    #[doc = "External high speed crystal oscillator (HXT) clock stops"]
    #[inline(always)]
...
#[doc = "LXT Clock Fail Interrupt Flag (Write Protect)\nNote: Write 1 to clear the bit to 0.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LXTFIF_A {
    #[doc = "0: External low speed crystal oscillator (LXT) clock is normal"]
    _0 = 0,
    #[doc = "1: External low speed crystal oscillator (LXT) stops"]
    _1 = 1,
}
...
#[doc = "Field `LXTFIF` reader - LXT Clock Fail Interrupt Flag (Write Protect)\nNote: Write 1 to clear the bit to 0."]
...
#[doc = "Field `LXTFIF` writer - LXT Clock Fail Interrupt Flag (Write Protect)\nNote: Write 1 to clear the bit to 0."]
...
impl<'a> LXTFIF_W<'a> {
    ...
    #[doc = "External low speed crystal oscillator (LXT) clock is normal"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(LXTFIF_A::_0)
    }
    #[doc = "External low speed crystal oscillator (LXT) stops"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "HXT Clock Frequency Range Detector Interrupt Flag (Write Protect)\nNote: Write 1 to clear the bit to 0.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HXTFQIF_A {
    #[doc = "0: External high speed crystal oscillator (HXT) clock frequency is normal"]
    _0 = 0,
    #[doc = "1: External high speed crystal oscillator (HXT) clock frequency is abnormal"]
    _1 = 1,
}
...
#[doc = "Field `HXTFQIF` reader - HXT Clock Frequency Range Detector Interrupt Flag (Write Protect)\nNote: Write 1 to clear the bit to 0."]
...
#[doc = "Field `HXTFQIF` writer - HXT Clock Frequency Range Detector Interrupt Flag (Write Protect)\nNote: Write 1 to clear the bit to 0."]
...
impl<'a> HXTFQIF_W<'a> {
    ...
    #[doc = "External high speed crystal oscillator (HXT) clock frequency is normal"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(HXTFQIF_A::_0)
    }
    #[doc = "External high speed crystal oscillator (HXT) clock frequency is abnormal"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - HXT Clock Fail Interrupt Flag (Write Protect) Note: Write 1 to clear the bit to 0."]
    #[inline(always)]
    pub fn hxtfif(&self) -> HXTFIF_R {
        HXTFIF_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - LXT Clock Fail Interrupt Flag (Write Protect) Note: Write 1 to clear the bit to 0."]
    #[inline(always)]
    pub fn lxtfif(&self) -> LXTFIF_R {
        LXTFIF_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 8 - HXT Clock Frequency Range Detector Interrupt Flag (Write Protect) Note: Write 1 to clear the bit to 0."]
    #[inline(always)]
