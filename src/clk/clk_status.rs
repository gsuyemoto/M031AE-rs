...
impl From<crate::R<CLK_STATUS_SPEC>> for R {
    #[inline(always)]
...
pub enum HXTSTB_A {
    #[doc = "0: External high speed crystal oscillator (HXT) clock is not stable or disabled"]
    _0 = 0,
    #[doc = "1: External high speed crystal oscillator (HXT) clock is stable and enabled"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LXTSTB_A {
    #[doc = "0: External low speed crystal oscillator (LXT) clock is not stable or disabled"]
    _0 = 0,
    #[doc = "1: External low speed crystal oscillator (LXT) clock is stabled and enabled"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LIRCSTB_A {
    #[doc = "0: Internal low speed RC oscillator (LIRC) clock is not stable or disabled"]
    _0 = 0,
    #[doc = "1: Internal low speed RC oscillator (LIRC) clock is stable and enabled"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HIRCSTB_A {
    #[doc = "0: Internal high speed RC oscillator (HIRC) clock is not stable or disabled"]
    _0 = 0,
    #[doc = "1: Internal high speed RC oscillator (HIRC) clock is stable and enabled"]
    _1 = 1,
}
...
impl R {
    #[doc = "Bit 0 - HXT Clock Source Stable Flag (Read Only) Note: If HXT is not supported, this bit field will be invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn hxtstb(&self) -> HXTSTB_R {
        HXTSTB_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - LXT Clock Source Stable Flag (Read Only) Note: If LXT is not supported, this bit field will be invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    pub fn lxtstb(&self) -> LXTSTB_R {
        LXTSTB_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Internal PLL Clock Source Stable Flag (Read Only) Note: If PLL is not supported, this bit field will be invalid. Please refer to section 3.2 NuMicro M031/M032 Series Selection Guide for detailed information."]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - Clock Switching Fail Flag (Read Only) This bit is updated when software switches system clock source. If switch target clock is stable, this bit will be set to 0. If switch target clock is not stable, this bit will be set to 1. Note: Write 1 to clear the bit to 0."]
    #[inline(always)]
