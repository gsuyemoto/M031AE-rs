...
impl From<crate::R<UART_TOUT_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<UART_TOUT_SPEC>> for W {
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 8:15 - TX Delay Time Value This field is used to programming the transfer delay time between the last stop bit and next start bit. The unit is bit time."]
    #[inline(always)]
