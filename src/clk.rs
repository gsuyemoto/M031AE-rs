...
pub struct RegisterBlock {
    ...
    _reserved9: [u8; 0x0c],
    #[doc = "0x30 - Clock Divider Number Register 4"]
    pub clk_clkdiv4: crate::Reg<clk_clkdiv4::CLK_CLKDIV4_SPEC>,
    #[doc = "0x34 - APB Clock Divider Register"]
    pub clk_pclkdiv: crate::Reg<clk_pclkdiv::CLK_PCLKDIV_SPEC>,
    _reserved11: [u8; 0x08],
    ...
    #[doc = "0x78 - Clock Frequency Range Detector Upper Boundary Register"]
    pub clk_cdupb: crate::Reg<clk_cdupb::CLK_CDUPB_SPEC>,
    #[doc = "0x7c - Clock Frequency Range Detector Lower Boundary Register"]
    pub clk_cdlowb: crate::Reg<clk_cdlowb::CLK_CDLOWB_SPEC>,
    #[doc = "0x80 - LDO Control Register"]
    pub clk_ldoctl: crate::Reg<clk_ldoctl::CLK_LDOCTL_SPEC>,
    _reserved19: [u8; 0x30],
    #[doc = "0xb4 - HXT Filter Select Control Register"]
    pub clk_hxtfsel: crate::Reg<clk_hxtfsel::CLK_HXTFSEL_SPEC>,
}
...
pub mod clk_clkdiv0;
#[doc = "CLK_CLKDIV4 register accessor: an alias for `Reg<CLK_CLKDIV4_SPEC>`"]
pub type CLK_CLKDIV4 = crate::Reg<clk_clkdiv4::CLK_CLKDIV4_SPEC>;
#[doc = "Clock Divider Number Register 4"]
pub mod clk_clkdiv4;
#[doc = "CLK_PCLKDIV register accessor: an alias for `Reg<CLK_PCLKDIV_SPEC>`"]
pub type CLK_PCLKDIV = crate::Reg<clk_pclkdiv::CLK_PCLKDIV_SPEC>;
...
#[doc = "Clock Frequency Range Detector Upper Boundary Register"]
pub mod clk_cdupb;
...
#[doc = "Clock Frequency Range Detector Lower Boundary Register"]
pub mod clk_cdlowb;
#[doc = "CLK_LDOCTL register accessor: an alias for `Reg<CLK_LDOCTL_SPEC>`"]
pub type CLK_LDOCTL = crate::Reg<clk_ldoctl::CLK_LDOCTL_SPEC>;
#[doc = "LDO Control Register"]
pub mod clk_ldoctl;
#[doc = "CLK_HXTFSEL register accessor: an alias for `Reg<CLK_HXTFSEL_SPEC>`"]
pub type CLK_HXTFSEL = crate::Reg<clk_hxtfsel::CLK_HXTFSEL_SPEC>;
