...
impl From<crate::R<NMISTS_SPEC>> for R {
    #[inline(always)]
...
#[doc = "Clock Fail Detected or IRC Auto Trim Interrupt Flag (Read Only)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CLKFAIL_A {
    #[doc = "0: Clock fail detected or IRC Auto Trim interrupt is deasserted"]
    _0 = 0,
    #[doc = "1: Clock fail detected or IRC Auto Trim interrupt is asserted"]
    _1 = 1,
}
...
#[doc = "Field `CLKFAIL` reader - Clock Fail Detected or IRC Auto Trim Interrupt Flag (Read Only)"]
...
#[doc = "External Interrupt From PA.6 or PB.5 Pin Interrupt Flag (Read Only)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT0_A {
    #[doc = "0: External Interrupt from PA.6 or PB.5 interrupt is deasserted"]
    _0 = 0,
    #[doc = "1: External Interrupt from PA.6 or PB.5 interrupt is asserted"]
    _1 = 1,
}
...
#[doc = "Field `EINT0` reader - External Interrupt From PA.6 or PB.5 Pin Interrupt Flag (Read Only)"]
...
#[doc = "External Interrupt From PA.7, PB.4 or PD.15 Pin Interrupt Flag (Read Only)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT1_A {
    #[doc = "0: External Interrupt from PA.7, PB.4 or PD.15 interrupt is deasserted"]
    _0 = 0,
    #[doc = "1: External Interrupt from PA.7, PB.4 or PD.15 interrupt is asserted"]
    _1 = 1,
}
...
#[doc = "Field `EINT1` reader - External Interrupt From PA.7, PB.4 or PD.15 Pin Interrupt Flag (Read Only)"]
...
#[doc = "External Interrupt From PB.3 or PC.6 Pin Interrupt Flag (Read Only)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT2_A {
    #[doc = "0: External Interrupt from PB.3 or PC.6 interrupt is deasserted"]
    _0 = 0,
    #[doc = "1: External Interrupt from PB.3 or PC.6 interrupt is asserted"]
    _1 = 1,
}
...
#[doc = "Field `EINT2` reader - External Interrupt From PB.3 or PC.6 Pin Interrupt Flag (Read Only)"]
...
#[doc = "External Interrupt From PB.2 or PC.7 Pin Interrupt Flag (Read Only)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT3_A {
    #[doc = "0: External Interrupt from PB.2 or PC.7 interrupt is deasserted"]
    _0 = 0,
    #[doc = "1: External Interrupt from PB.2 or PC.7 interrupt is asserted"]
    _1 = 1,
}
...
#[doc = "Field `EINT3` reader - External Interrupt From PB.2 or PC.7 Pin Interrupt Flag (Read Only)"]
...
#[doc = "External Interrupt From PA.8, PB.6 or PF.15 Pin Interrupt Flag (Read Only)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT4_A {
    #[doc = "0: External Interrupt from PA.8, PB.6 or PF.15 interrupt is deasserted"]
    _0 = 0,
    #[doc = "1: External Interrupt from PA.8, PB.6 or PF.15 interrupt is asserted"]
    _1 = 1,
}
...
#[doc = "Field `EINT4` reader - External Interrupt From PA.8, PB.6 or PF.15 Pin Interrupt Flag (Read Only)"]
...
#[doc = "External Interrupt From PB.7 or PF.14 Pin Interrupt Flag (Read Only)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT5_A {
    #[doc = "0: External Interrupt from PB.7 or PF.14 interrupt is deasserted"]
    _0 = 0,
    #[doc = "1: External Interrupt from PB.7 or PF.14 interrupt is asserted"]
    _1 = 1,
}
...
#[doc = "Field `EINT5` reader - External Interrupt From PB.7 or PF.14 Pin Interrupt Flag (Read Only)"]
...
impl R {
    ...
    #[doc = "Bit 4 - Clock Fail Detected or IRC Auto Trim Interrupt Flag (Read Only)"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - External Interrupt From PA.6 or PB.5 Pin Interrupt Flag (Read Only)"]
    #[inline(always)]
    pub fn eint0(&self) -> EINT0_R {
        EINT0_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - External Interrupt From PA.7, PB.4 or PD.15 Pin Interrupt Flag (Read Only)"]
    #[inline(always)]
    pub fn eint1(&self) -> EINT1_R {
        EINT1_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 10 - External Interrupt From PB.3 or PC.6 Pin Interrupt Flag (Read Only)"]
    #[inline(always)]
    pub fn eint2(&self) -> EINT2_R {
        EINT2_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    #[doc = "Bit 11 - External Interrupt From PB.2 or PC.7 Pin Interrupt Flag (Read Only)"]
    #[inline(always)]
    pub fn eint3(&self) -> EINT3_R {
        EINT3_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 12 - External Interrupt From PA.8, PB.6 or PF.15 Pin Interrupt Flag (Read Only)"]
    #[inline(always)]
    pub fn eint4(&self) -> EINT4_R {
        EINT4_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 13 - External Interrupt From PB.7 or PF.14 Pin Interrupt Flag (Read Only)"]
    #[inline(always)]
