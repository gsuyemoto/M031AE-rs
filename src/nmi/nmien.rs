...
#[doc = "Clock Fail Detected and IRC Auto Trim Interrupt NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CLKFAIL_A {
    #[doc = "0: Clock fail detected and IRC Auto Trim interrupt NMI source Disabled"]
    _0 = 0,
    #[doc = "1: Clock fail detected and IRC Auto Trim interrupt NMI source Enabled"]
    _1 = 1,
}
...
#[doc = "Field `CLKFAIL` reader - Clock Fail Detected and IRC Auto Trim Interrupt NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
#[doc = "Field `CLKFAIL` writer - Clock Fail Detected and IRC Auto Trim Interrupt NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
impl<'a> CLKFAIL_W<'a> {
    ...
    #[doc = "Clock fail detected and IRC Auto Trim interrupt NMI source Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(CLKFAIL_A::_0)
    }
    #[doc = "Clock fail detected and IRC Auto Trim interrupt NMI source Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "External Interrupt From PA.6 or PB.5 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT0_A {
    #[doc = "0: External interrupt from PA.6 or PB.5 pin NMI source Disabled"]
    _0 = 0,
    #[doc = "1: External interrupt from PA.6 or PB.5 pin NMI source Enabled"]
    _1 = 1,
}
...
#[doc = "Field `EINT0` reader - External Interrupt From PA.6 or PB.5 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
#[doc = "Field `EINT0` writer - External Interrupt From PA.6 or PB.5 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
impl<'a> EINT0_W<'a> {
    ...
    #[doc = "External interrupt from PA.6 or PB.5 pin NMI source Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(EINT0_A::_0)
    }
    #[doc = "External interrupt from PA.6 or PB.5 pin NMI source Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "External Interrupt From PA.7, PB.4 or PD.15 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT1_A {
    #[doc = "0: External interrupt from PA.7, PB.4 or PD.15 pin NMI source Disabled"]
    _0 = 0,
    #[doc = "1: External interrupt from PA.7, PB.4 or PD.15 pin NMI source Enabled"]
    _1 = 1,
}
...
#[doc = "Field `EINT1` reader - External Interrupt From PA.7, PB.4 or PD.15 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
#[doc = "Field `EINT1` writer - External Interrupt From PA.7, PB.4 or PD.15 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
impl<'a> EINT1_W<'a> {
    ...
    #[doc = "External interrupt from PA.7, PB.4 or PD.15 pin NMI source Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(EINT1_A::_0)
    }
    #[doc = "External interrupt from PA.7, PB.4 or PD.15 pin NMI source Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "External Interrupt From PB.3 or PC.6 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT2_A {
    #[doc = "0: External interrupt from PB.3 or PC.6 pin NMI source Disabled"]
    _0 = 0,
    #[doc = "1: External interrupt from PB.3 or PC.6 pin NMI source Enabled"]
    _1 = 1,
}
...
#[doc = "Field `EINT2` reader - External Interrupt From PB.3 or PC.6 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
#[doc = "Field `EINT2` writer - External Interrupt From PB.3 or PC.6 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
impl<'a> EINT2_W<'a> {
    ...
    #[doc = "External interrupt from PB.3 or PC.6 pin NMI source Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(EINT2_A::_0)
    }
    #[doc = "External interrupt from PB.3 or PC.6 pin NMI source Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "External Interrupt From PB.2 or PC.7 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT3_A {
    #[doc = "0: External interrupt from PB.2 or PC.7 pin NMI source Disabled"]
    _0 = 0,
    #[doc = "1: External interrupt from PB.2 or PC.7 pin NMI source Enabled"]
    _1 = 1,
}
...
#[doc = "Field `EINT3` reader - External Interrupt From PB.2 or PC.7 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
#[doc = "Field `EINT3` writer - External Interrupt From PB.2 or PC.7 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
impl<'a> EINT3_W<'a> {
    ...
    #[doc = "External interrupt from PB.2 or PC.7 pin NMI source Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(EINT3_A::_0)
    }
    #[doc = "External interrupt from PB.2 or PC.7 pin NMI source Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "External Interrupt From PA.8, PB.6 or PF.15 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT4_A {
    #[doc = "0: External interrupt from PA.8, PB.6 or PF.15 pin NMI source Disabled"]
    _0 = 0,
    #[doc = "1: External interrupt from PA.8, PB.6 or PF.15 pin NMI source Enabled"]
    _1 = 1,
}
...
#[doc = "Field `EINT4` reader - External Interrupt From PA.8, PB.6 or PF.15 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
#[doc = "Field `EINT4` writer - External Interrupt From PA.8, PB.6 or PF.15 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
impl<'a> EINT4_W<'a> {
    ...
    #[doc = "External interrupt from PA.8, PB.6 or PF.15 pin NMI source Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(EINT4_A::_0)
    }
    #[doc = "External interrupt from PA.8, PB.6 or PF.15 pin NMI source Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "External Interrupt From PB.7, PD.12 or PF.14 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EINT5_A {
    #[doc = "0: External interrupt from PB.7, PD.12 or PF.14 pin NMI source Disabled"]
    _0 = 0,
    #[doc = "1: External interrupt from PB.7, PD.12 or PF.14 pin NMI source Enabled"]
    _1 = 1,
}
...
#[doc = "Field `EINT5` reader - External Interrupt From PB.7, PD.12 or PF.14 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
#[doc = "Field `EINT5` writer - External Interrupt From PB.7, PD.12 or PF.14 Pin NMI Source Enable (Write Protect)\nNote: This bit is write protected. Refer to the SYS_REGLCTL register."]
...
impl<'a> EINT5_W<'a> {
    ...
    #[doc = "External interrupt from PB.7, PD.12 or PF.14 pin NMI source Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(EINT5_A::_0)
    }
    #[doc = "External interrupt from PB.7, PD.12 or PF.14 pin NMI source Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - BOD NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn bodout(&self) -> BODOUT_R {
        BODOUT_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - IRC TRIM NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn irc_int(&self) -> IRC_INT_R {
        IRC_INT_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Power-down Mode Wake-up NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn pwrwu_int(&self) -> PWRWU_INT_R {
        PWRWU_INT_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - SRAM ParityCheck Error NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn sram_perr(&self) -> SRAM_PERR_R {
        SRAM_PERR_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - Clock Fail Detected and IRC Auto Trim Interrupt NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn clkfail(&self) -> CLKFAIL_R {
        CLKFAIL_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 6 - RTC NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn rtc_int(&self) -> RTC_INT_R {
        RTC_INT_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 8 - External Interrupt From PA.6 or PB.5 Pin NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn eint0(&self) -> EINT0_R {
        EINT0_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - External Interrupt From PA.7, PB.4 or PD.15 Pin NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn eint1(&self) -> EINT1_R {
        EINT1_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 10 - External Interrupt From PB.3 or PC.6 Pin NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn eint2(&self) -> EINT2_R {
        EINT2_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    #[doc = "Bit 11 - External Interrupt From PB.2 or PC.7 Pin NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn eint3(&self) -> EINT3_R {
        EINT3_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 12 - External Interrupt From PA.8, PB.6 or PF.15 Pin NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn eint4(&self) -> EINT4_R {
        EINT4_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 13 - External Interrupt From PB.7, PD.12 or PF.14 Pin NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn eint5(&self) -> EINT5_R {
        EINT5_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    #[doc = "Bit 14 - UART0 NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
    pub fn uart0_int(&self) -> UART0_INT_R {
        UART0_INT_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    #[doc = "Bit 15 - UART1 NMI Source Enable (Write Protect) Note: This bit is write protected. Refer to the SYS_REGLCTL register."]
    #[inline(always)]
