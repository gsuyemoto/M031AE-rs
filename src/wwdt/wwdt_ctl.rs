...
impl From<crate::R<WWDT_CTL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<WWDT_CTL_SPEC>> for W {
    #[inline(always)]
...
pub enum WWDTEN_A {
    ...
    _0 = 0,
    #[doc = "1: WWDT counter starts counting"]
    _1 = 1,
}
...
#[doc = "Field `WWDTEN` reader - WWDT Enable Bit"]
...
#[doc = "Field `WWDTEN` writer - WWDT Enable Bit"]
...
impl<'a> WWDTEN_W<'a> {
    ...
    #[doc = "WWDT counter starts counting"]
    #[inline(always)]
...
#[doc = "Field `INTEN` reader - WWDT Interrupt Enable Bit\nIf this bit is enabled, the WWDT counter compare match interrupt signal is generated and inform to CPU."]
...
#[doc = "Field `INTEN` writer - WWDT Interrupt Enable Bit\nIf this bit is enabled, the WWDT counter compare match interrupt signal is generated and inform to CPU."]
...
#[doc = "Field `ICEDEBUG` reader - ICE Debug Mode Acknowledge Disable Bit\nNote: WWDT down counter will keep going no matter CPU is held by ICE or not."]
...
#[doc = "Field `ICEDEBUG` writer - ICE Debug Mode Acknowledge Disable Bit\nNote: WWDT down counter will keep going no matter CPU is held by ICE or not."]
...
impl R {
    #[doc = "Bit 0 - WWDT Enable Bit"]
    #[inline(always)]
    pub fn wwdten(&self) -> WWDTEN_R {
        WWDTEN_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - WWDT Interrupt Enable Bit If this bit is enabled, the WWDT counter compare match interrupt signal is generated and inform to CPU."]
    #[inline(always)]
    ...
    #[doc = "Bits 16:21 - WWDT Window Compare Register Set this register to adjust the valid reload window. Note: User can only write WWDT_RLDCNT register to reload WWDT counter value when current WWDT counter value between 0 and CMPDAT. If user writes WWDT_RLDCNT register when current WWDT counter value larger than CMPDAT, WWDT reset signal will generate immediately."]
    #[inline(always)]
    pub fn cmpdat(&self) -> CMPDAT_R {
        CMPDAT_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
    #[doc = "Bit 31 - ICE Debug Mode Acknowledge Disable Bit Note: WWDT down counter will keep going no matter CPU is held by ICE or not."]
    #[inline(always)]
