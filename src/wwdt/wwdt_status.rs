...
impl From<crate::R<WWDT_STATUS_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<WWDT_STATUS_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - WWDT Compare Match Interrupt Flag This bit indicates the interrupt flag status of WWDT while WWDT counter value matches CMPDAT (WWDT_CTL\\[21:16\\]). Note: This bit is cleared by writing 1 to it."]
    #[inline(always)]
    pub fn wwdtif(&self) -> WWDTIF_R {
        WWDTIF_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - WWDT Timer-out Reset Flag This bit indicates the system has been reset by WWDT time-out reset or not. Note: This bit is cleared by writing 1 to it."]
    #[inline(always)]
