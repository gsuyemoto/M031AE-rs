#[doc = "Register `UUART_LINECTL` reader"]
pub struct R(crate::R<UUART_LINECTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UUART_LINECTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UUART_LINECTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UUART_LINECTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UUART_LINECTL` writer"]
pub struct W(crate::W<UUART_LINECTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UUART_LINECTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UUART_LINECTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UUART_LINECTL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DATOINV_A {
    #[doc = "0: The value of USCIx_DAT1 is equal to the data shift register"]
    _0 = 0,
    #[doc = "1: The value of USCIx_DAT1 is the inversion of data shift register"]
    _1 = 1,
}
...
impl<'a> DATOINV_W<'a> {
    ...
    #[doc = "The value of USCIx_DAT1 is equal to the data shift register"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(DATOINV_A::_0)
    }
    #[doc = "The value of USCIx_DAT1 is the inversion of data shift register"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 5 - Data Output Inverse Selection This bit defines the relation between the internal shift data value and the output data signal of USCIx_DAT1 pin."]
    #[inline(always)]
    pub fn datoinv(&self) -> DATOINV_R {
        DATOINV_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 7 - Control Signal Output Inverse Selection This bit defines the relation between the internal control signal and the output control signal. Note: In UART protocol, the control signal means nRTS signal."]
    #[inline(always)]
...
#[doc = "USCI Line Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uuart_linectl](index.html) module"]
pub struct UUART_LINECTL_SPEC;
impl crate::RegisterSpec for UUART_LINECTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uuart_linectl::R](R) reader structure"]
impl crate::Readable for UUART_LINECTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uuart_linectl::W](W) writer structure"]
impl crate::Writable for UUART_LINECTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UUART_LINECTL to value 0"]
impl crate::Resettable for UUART_LINECTL_SPEC {
    #[inline(always)]
