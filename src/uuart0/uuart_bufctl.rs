#[doc = "Register `UUART_BUFCTL` reader"]
pub struct R(crate::R<UUART_BUFCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UUART_BUFCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UUART_BUFCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UUART_BUFCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UUART_BUFCTL` writer"]
pub struct W(crate::W<UUART_BUFCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UUART_BUFCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UUART_BUFCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UUART_BUFCTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum TXCLR_A {
    #[doc = "0: No effect"]
    _0 = 0,
    #[doc = "1: The transmit buffer is cleared (filling level is cleared and output pointer is set to input pointer value). Should only be used while the buffer is not taking part in data traffic"]
    _1 = 1,
}
...
impl<'a> TXCLR_W<'a> {
    ...
    #[doc = "The transmit buffer is cleared (filling level is cleared and output pointer is set to input pointer value). Should only be used while the buffer is not taking part in data traffic"]
    #[inline(always)]
...
#[doc = "Receive Buffer Overrun Error Interrupt Enable Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXOVIEN_A {
...
#[doc = "Field `RXOVIEN` reader - Receive Buffer Overrun Error Interrupt Enable Bit"]
...
#[doc = "Field `RXOVIEN` writer - Receive Buffer Overrun Error Interrupt Enable Bit"]
...
pub enum RXCLR_A {
    #[doc = "0: No effect"]
    _0 = 0,
    #[doc = "1: The receive buffer is cleared (filling level is cleared and output pointer is set to input pointer value). Should only be used while the buffer is not taking part in data traffic"]
    _1 = 1,
}
...
impl<'a> RXCLR_W<'a> {
    ...
    #[doc = "The receive buffer is cleared (filling level is cleared and output pointer is set to input pointer value). Should only be used while the buffer is not taking part in data traffic"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 14 - Receive Buffer Overrun Error Interrupt Enable Bit"]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - Transmit Reset Note: It is cleared automatically after one PCLK cycle."]
    #[inline(always)]
    pub fn txrst(&self) -> TXRST_R {
        TXRST_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 17 - Receive Reset Note 1: It is cleared automatically after one PCLK cycle. Note 2: It is suggested to check the RXBUSY (UUART_PROTSTS\\[10\\]) before this bit will be set to 1."]
    #[inline(always)]
...
#[doc = "USCI Transmit/Receive Buffer Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uuart_bufctl](index.html) module"]
pub struct UUART_BUFCTL_SPEC;
impl crate::RegisterSpec for UUART_BUFCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uuart_bufctl::R](R) reader structure"]
impl crate::Readable for UUART_BUFCTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uuart_bufctl::W](W) writer structure"]
impl crate::Writable for UUART_BUFCTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UUART_BUFCTL to value 0"]
impl crate::Resettable for UUART_BUFCTL_SPEC {
    #[inline(always)]
