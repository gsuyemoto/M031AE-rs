#[doc = "Register `UUART_CLKIN` reader"]
pub struct R(crate::R<UUART_CLKIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UUART_CLKIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UUART_CLKIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UUART_CLKIN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UUART_CLKIN` writer"]
pub struct W(crate::W<UUART_CLKIN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UUART_CLKIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UUART_CLKIN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UUART_CLKIN_SPEC>) -> Self {
        W(writer)
    }
}
...
impl R {
    #[doc = "Bit 0 - Input Synchronization Signal Selection This bit selects if the un-synchronized input signal or the synchronized (and optionally filtered) signal can be used as input for the data shift unit."]
    #[inline(always)]
...
#[doc = "USCI Input Clock Signal Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uuart_clkin](index.html) module"]
pub struct UUART_CLKIN_SPEC;
impl crate::RegisterSpec for UUART_CLKIN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uuart_clkin::R](R) reader structure"]
impl crate::Readable for UUART_CLKIN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uuart_clkin::W](W) writer structure"]
impl crate::Writable for UUART_CLKIN_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UUART_CLKIN to value 0"]
impl crate::Resettable for UUART_CLKIN_SPEC {
    #[inline(always)]
