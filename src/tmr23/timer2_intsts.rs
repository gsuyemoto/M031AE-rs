#[doc = "Register `TIMER2_INTSTS` reader"]
pub struct R(crate::R<TIMER2_INTSTS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMER2_INTSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMER2_INTSTS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMER2_INTSTS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMER2_INTSTS` writer"]
pub struct W(crate::W<TIMER2_INTSTS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMER2_INTSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMER2_INTSTS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMER2_INTSTS_SPEC>) -> Self {
        W(writer)
    }
}
...
impl R {
    #[doc = "Bit 0 - Timer Interrupt Flag This bit indicates the interrupt flag status of Timer while 24-bit timer up counter CNT (TIMERx_CNT\\[23:0\\]) value reaches CMPDAT (TIMERx_CMP\\[23:0\\]) value. Note: This bit is cleared by writing 1 to it."]
    #[inline(always)]
    pub fn tif(&self) -> TIF_R {
        TIF_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Timer Wake-up Flag This bit indicates the interrupt wake-up flag status of timer. Note: This bit is cleared by writing 1 to it."]
    #[inline(always)]
...
#[doc = "Timer2 Interrupt Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timer2_intsts](index.html) module"]
pub struct TIMER2_INTSTS_SPEC;
impl crate::RegisterSpec for TIMER2_INTSTS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timer2_intsts::R](R) reader structure"]
impl crate::Readable for TIMER2_INTSTS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timer2_intsts::W](W) writer structure"]
impl crate::Writable for TIMER2_INTSTS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TIMER2_INTSTS to value 0"]
impl crate::Resettable for TIMER2_INTSTS_SPEC {
    #[inline(always)]
