#[doc = "Register `TIMER2_CNT` reader"]
pub struct R(crate::R<TIMER2_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMER2_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMER2_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMER2_CNT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Timer2 Data Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timer2_cnt](index.html) module"]
pub struct TIMER2_CNT_SPEC;
impl crate::RegisterSpec for TIMER2_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timer2_cnt::R](R) reader structure"]
impl crate::Readable for TIMER2_CNT_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TIMER2_CNT to value 0"]
impl crate::Resettable for TIMER2_CNT_SPEC {
    #[inline(always)]
