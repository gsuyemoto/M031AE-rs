#[doc = "Register `TIMER1_CAP` reader"]
pub struct R(crate::R<TIMER1_CAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMER1_CAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMER1_CAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMER1_CAP_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Timer1 Capture Data Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timer1_cap](index.html) module"]
pub struct TIMER1_CAP_SPEC;
impl crate::RegisterSpec for TIMER1_CAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timer1_cap::R](R) reader structure"]
impl crate::Readable for TIMER1_CAP_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TIMER1_CAP to value 0"]
impl crate::Resettable for TIMER1_CAP_SPEC {
    #[inline(always)]
