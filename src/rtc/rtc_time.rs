...
#[doc = "Field `SEC` reader - 1-Sec Time Digit (0~9)"]
...
#[doc = "Field `SEC` writer - 1-Sec Time Digit (0~9)"]
pub struct SEC_W<'a> {
    w: &'a mut W,
}
impl<'a> SEC_W<'a> {
...
#[doc = "Field `TENSEC` reader - 10-Sec Time Digit (0~5)"]
...
#[doc = "Field `TENSEC` writer - 10-Sec Time Digit (0~5)"]
...
#[doc = "Field `MIN` reader - 1-Min Time Digit (0~9)"]
...
#[doc = "Field `MIN` writer - 1-Min Time Digit (0~9)"]
pub struct MIN_W<'a> {
    w: &'a mut W,
}
impl<'a> MIN_W<'a> {
...
#[doc = "Field `TENMIN` reader - 10-Min Time Digit (0~5)"]
...
#[doc = "Field `TENMIN` writer - 10-Min Time Digit (0~5)"]
...
#[doc = "Field `HR` reader - 1-Hour Time Digit (0~9)"]
...
#[doc = "Field `HR` writer - 1-Hour Time Digit (0~9)"]
pub struct HR_W<'a> {
    w: &'a mut W,
}
impl<'a> HR_W<'a> {
...
#[doc = "Field `TENHR` reader - 10-Hour Time Digit (0~2)When RTC runs as 12-hour time scale mode, RTC_TIME\\[21\\]
(the high bit of TENHR\\[1:0\\]) means AM/PM indication (If RTC_TIME\\[21\\]
is 1, it indicates PM time message.)"]
...
#[doc = "Field `TENHR` writer - 10-Hour Time Digit (0~2)When RTC runs as 12-hour time scale mode, RTC_TIME\\[21\\]
(the high bit of TENHR\\[1:0\\]) means AM/PM indication (If RTC_TIME\\[21\\]
is 1, it indicates PM time message.)"]
...
impl R {
    ...
    #[doc = "Bits 20:21 - 10-Hour Time Digit (0~2)When RTC runs as 12-hour time scale mode, RTC_TIME\\[21\\]
(the high bit of TENHR\\[1:0\\]) means AM/PM indication (If RTC_TIME\\[21\\]
is 1, it indicates PM time message.)"]
    #[inline(always)]
