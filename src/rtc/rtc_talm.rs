...
impl From<crate::R<RTC_TALM_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<RTC_TALM_SPEC>> for W {
    #[inline(always)]
...
#[doc = "Field `TENHR` reader - 10-Hour Time Digit of Alarm Setting (0~2)When RTC runs as 12-hour time scale mode, RTC_TIME\\[21\\]
...
#[doc = "Field `TENHR` writer - 10-Hour Time Digit of Alarm Setting (0~2)When RTC runs as 12-hour time scale mode, RTC_TIME\\[21\\]
(the high bit of TENHR\\[1:0\\]) means AM/PM indication (If RTC_TIME\\[21\\]
is 1, it indicates PM time message.)"]
...
impl R {
    ...
    #[doc = "Bits 20:21 - 10-Hour Time Digit of Alarm Setting (0~2)When RTC runs as 12-hour time scale mode, RTC_TIME\\[21\\]
(the high bit of TENHR\\[1:0\\]) means AM/PM indication (If RTC_TIME\\[21\\]
is 1, it indicates PM time message.)"]
    #[inline(always)]
