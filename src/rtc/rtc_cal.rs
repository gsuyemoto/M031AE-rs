#[doc = "Register `RTC_CAL` reader"]
pub struct R(crate::R<RTC_CAL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_CAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_CAL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_CAL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_CAL` writer"]
pub struct W(crate::W<RTC_CAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_CAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_CAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_CAL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DAY` reader - 1-Day Calendar Digit (0~9)"]
...
#[doc = "Field `DAY` writer - 1-Day Calendar Digit (0~9)"]
pub struct DAY_W<'a> {
    w: &'a mut W,
}
impl<'a> DAY_W<'a> {
...
#[doc = "Field `TENDAY` reader - 10-Day Calendar Digit (0~3)"]
...
#[doc = "Field `TENDAY` writer - 10-Day Calendar Digit (0~3)"]
...
#[doc = "Field `MON` reader - 1-Month Calendar Digit (0~9)"]
...
#[doc = "Field `MON` writer - 1-Month Calendar Digit (0~9)"]
pub struct MON_W<'a> {
    w: &'a mut W,
}
impl<'a> MON_W<'a> {
...
#[doc = "Field `TENMON` reader - 10-Month Calendar Digit (0~1)"]
...
#[doc = "Field `TENMON` writer - 10-Month Calendar Digit (0~1)"]
...
#[doc = "Field `YEAR` reader - 1-Year Calendar Digit (0~9)"]
...
#[doc = "Field `YEAR` writer - 1-Year Calendar Digit (0~9)"]
pub struct YEAR_W<'a> {
    w: &'a mut W,
}
impl<'a> YEAR_W<'a> {
...
#[doc = "Field `TENYEAR` reader - 10-Year Calendar Digit (0~9)"]
...
#[doc = "Field `TENYEAR` writer - 10-Year Calendar Digit (0~9)"]
...
#[doc = "RTC Calendar Loading Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_cal](index.html) module"]
pub struct RTC_CAL_SPEC;
impl crate::RegisterSpec for RTC_CAL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_cal::R](R) reader structure"]
impl crate::Readable for RTC_CAL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_cal::W](W) writer structure"]
impl crate::Writable for RTC_CAL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_CAL to value 0x0015_0808"]
impl crate::Resettable for RTC_CAL_SPEC {
    #[inline(always)]
