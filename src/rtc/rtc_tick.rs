...
impl From<crate::R<RTC_TICK_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<RTC_TICK_SPEC>> for W {
    #[inline(always)]
...
pub enum TICK_A {
    ...
    _6 = 6,
    #[doc = "7: Time tick is 1/128 second"]
    _7 = 7,
}
...
impl R {
    #[doc = "Bits 0:2 - Time Tick Register These bits are used to select RTC time tick period for Periodic Time Tick Interrupt request."]
    #[inline(always)]
