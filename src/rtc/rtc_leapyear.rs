...
impl From<crate::R<RTC_LEAPYEAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_LEAPYEAR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Leap Year Indication (Read Only)\n\nValue on reset: 0"]
...
#[doc = "Field `LEAPYEAR` reader - Leap Year Indication (Read Only)"]
...
impl R {
    #[doc = "Bit 0 - Leap Year Indication (Read Only)"]
    #[inline(always)]
