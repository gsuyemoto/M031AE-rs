...
impl From<crate::R<RTC_INTEN_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<RTC_INTEN_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Alarm Interrupt Enable Bit Set ALMIEN to 1 can also enable chip wake-up function when RTC alarm interrupt event is generated."]
    #[inline(always)]
    pub fn almien(&self) -> ALMIEN_R {
        ALMIEN_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Time Tick Interrupt Enable Bit Set TICKIEN to 1 can also enable chip wake-up function when RTC tick interrupt event is generated."]
    #[inline(always)]
