...
impl From<crate::R<RTC_CLKFMT_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<RTC_CLKFMT_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - 24-hour / 12-hour Time Scale Selection Indicates that RTC_TIME and RTC_TALM are in 24-hour time scale or 12-hour time scale"]
    #[inline(always)]
