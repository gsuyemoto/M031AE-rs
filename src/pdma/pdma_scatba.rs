...
impl From<crate::R<PDMA_SCATBA_SPEC>> for R {
    #[inline(always)]
...
#[doc = "Field `SCATBA` writer - PDMA Scatter-gather Descriptor Table Address\nIn Scatter-Gather mode, this is the base address for calculating the next link - list address. The next link address equation is \nNote: Only useful in Scatter-Gather mode."]
...
impl R {
    #[doc = "Bits 16:31 - PDMA Scatter-gather Descriptor Table Address In Scatter-Gather mode, this is the base address for calculating the next link - list address. The next link address equation is Note: Only useful in Scatter-Gather mode."]
    #[inline(always)]
