#[doc = "Register `PDMA_DSCT2_CTL` reader"]
pub struct R(crate::R<PDMA_DSCT2_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PDMA_DSCT2_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PDMA_DSCT2_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PDMA_DSCT2_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PDMA_DSCT2_CTL` writer"]
pub struct W(crate::W<PDMA_DSCT2_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PDMA_DSCT2_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PDMA_DSCT2_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PDMA_DSCT2_CTL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "PDMA Operation Mode Selection\nNote: Before filling new transfer task in the Descriptor Table, user must check the PDMA_INTSTS\\[1\\]
to make sure the curren task is complete.\n\nValue on reset: 0"]
...
pub enum OPMODE_A {
    ...
    _0 = 0,
    #[doc = "1: Basic mode: The descriptor table only has one task. When this task is finished, the PDMA_INTSTS\\[1\\]
will be asserted"]
    _1 = 1,
...
impl<'a> OPMODE_W<'a> {
    ...
    #[doc = "Basic mode: The descriptor table only has one task. When this task is finished, the PDMA_INTSTS\\[1\\]
will be asserted"]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:1 - PDMA Operation Mode Selection Note: Before filling new transfer task in the Descriptor Table, user must check the PDMA_INTSTS\\[1\\]
to make sure the curren task is complete."]
    #[inline(always)]
    ...
    #[doc = "Bits 4:6 - Burst Size Note: This field is only useful in burst transfer type."]
    #[inline(always)]
    pub fn bursize(&self) -> BURSIZE_R {
        BURSIZE_R::new(((self.bits >> 4) & 0x07) as u8)
    }
    #[doc = "Bit 7 - Table Interrupt Disable Bit This field can be used to decide whether to enable table interrupt or not. If the TBINTDIS bit is enabled it will not generates TDIFn(PDMA_TDSTS\\[8:0\\]) when PDMA controller finishes transfer task. Note: This function only for scatter-gather mode."]
    #[inline(always)]
    pub fn tbintdis(&self) -> TBINTDIS_R {
        TBINTDIS_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    #[doc = "Bits 8:9 - Source Address Increment This field is used to set the source address increment size. Note: The fixed address function is not supported in memory to memory transfer type."]
    #[inline(always)]
    pub fn sainc(&self) -> SAINC_R {
        SAINC_R::new(((self.bits >> 8) & 0x03) as u8)
    }
    #[doc = "Bits 10:11 - Destination Address Increment This field is used to set the destination address increment size. Note: The fixed address function is not supported in memory to memory transfer type."]
    #[inline(always)]
    pub fn dainc(&self) -> DAINC_R {
        DAINC_R::new(((self.bits >> 10) & 0x03) as u8)
    }
    #[doc = "Bits 12:13 - Transfer Width Selection This field is used for transfer width. Note: The PDMA transfer source address (PDMA_DSCT_SA) and PDMA transfer destination address (PDMA_DSCT_DA) should be alignment under the TXWIDTH selection"]
    #[inline(always)]
    pub fn txwidth(&self) -> TXWIDTH_R {
        TXWIDTH_R::new(((self.bits >> 12) & 0x03) as u8)
    }
    #[doc = "Bits 16:31 - Transfer Count The TXCNT represents the required number of PDMA transfer, the real transfer count is (TXCNT + 1); The maximum transfer count is 16384, every transfer may be byte, half-word or word that is dependent on TXWIDTH field. Note: When PDMA finish each transfer data, this field will be decrease immediately."]
    #[inline(always)]
    pub fn txcnt(&self) -> TXCNT_R {
        TXCNT_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:1 - PDMA Operation Mode Selection Note: Before filling new transfer task in the Descriptor Table, user must check the PDMA_INTSTS\\[1\\]
...
#[doc = "Descriptor Table Control Register of PDMA Channel n\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pdma_dsct2_ctl](index.html) module"]
pub struct PDMA_DSCT2_CTL_SPEC;
impl crate::RegisterSpec for PDMA_DSCT2_CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pdma_dsct2_ctl::R](R) reader structure"]
impl crate::Readable for PDMA_DSCT2_CTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pdma_dsct2_ctl::W](W) writer structure"]
impl crate::Writable for PDMA_DSCT2_CTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PDMA_DSCT2_CTL to value 0"]
impl crate::Resettable for PDMA_DSCT2_CTL_SPEC {
    #[inline(always)]
