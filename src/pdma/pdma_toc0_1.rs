...
impl From<crate::R<PDMA_TOC0_1_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PDMA_TOC0_1_SPEC>> for W {
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Time-out Counter for Channel 1 This controls the period of time-out function for channel 1. The calculation unit is based on TOUTPSC1 (PDMA_TOUTPSC\\[6:4\\]) clock. The example of time-out period can refer TOC0 bit description."]
    #[inline(always)]
