...
impl From<crate::R<PDMA_REQSEL4_7_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PDMA_REQSEL4_7_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:5 - Channel 4 Request Source Selection This filed defines which peripheral is connected to PDMA channel 4. User can configure the peripheral setting by REQSRC4. Note: The channel configuration is the same as REQSRC0 field. Please refer to the explanation of REQSRC0."]
    #[inline(always)]
    pub fn reqsrc4(&self) -> REQSRC4_R {
        REQSRC4_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 8:13 - Channel 5 Request Source Selection This filed defines which peripheral is connected to PDMA channel 5. User can configure the peripheral setting by REQSRC5. Note: The channel configuration is the same as REQSRC0 field. Please refer to the explanation of REQSRC0."]
    #[inline(always)]
    pub fn reqsrc5(&self) -> REQSRC5_R {
        REQSRC5_R::new(((self.bits >> 8) & 0x3f) as u8)
    }
    #[doc = "Bits 16:21 - Channel 6 Request Source Selection This filed defines which peripheral is connected to PDMA channel 6. User can configure the peripheral setting by REQSRC6. Note: The channel configuration is the same as REQSRC0 field. Please refer to the explanation of REQSRC0."]
    #[inline(always)]
    pub fn reqsrc6(&self) -> REQSRC6_R {
        REQSRC6_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
    #[doc = "Bits 24:29 - Channel 7 Request Source Selection This filed defines which peripheral is connected to PDMA channel 7. User can configure the peripheral setting by REQSRC7. Note: The channel configuration is the same as REQSRC0 field. Please refer to the explanation of REQSRC0."]
    #[inline(always)]
    pub fn reqsrc7(&self) -> REQSRC7_R {
        REQSRC7_R::new(((self.bits >> 24) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - Channel 4 Request Source Selection This filed defines which peripheral is connected to PDMA channel 4. User can configure the peripheral setting by REQSRC4. Note: The channel configuration is the same as REQSRC0 field. Please refer to the explanation of REQSRC0."]
...
#[doc = "`reset()` method sets PDMA_REQSEL4_7 to value 0"]
