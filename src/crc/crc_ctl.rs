...
#[doc = "Checksum Initialization\nNote: This bit will be cleared automatically.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CHKSINIT_A {
    #[doc = "0: No effect"]
    _0 = 0,
    #[doc = "1: Initial checksum value by auto reload CRC_SEED register value to CRC_CHECKSUM register value"]
    _1 = 1,
}
impl From<CHKSINIT_A> for bool {
    #[inline(always)]
    fn from(variant: CHKSINIT_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CHKSINIT` reader - Checksum Initialization\nNote: This bit will be cleared automatically."]
pub struct CHKSINIT_R(crate::FieldReader<bool, CHKSINIT_A>);
impl CHKSINIT_R {
    pub(crate) fn new(bits: bool) -> Self {
        CHKSINIT_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> CHKSINIT_A {
        match self.bits {
            false => CHKSINIT_A::_0,
            true => CHKSINIT_A::_1,
        }
...
impl core::ops::Deref for CHKSINIT_R {
    type Target = crate::FieldReader<bool, CHKSINIT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `CHKSINIT` writer - Checksum Initialization\nNote: This bit will be cleared automatically."]
pub struct CHKSINIT_W<'a> {
    w: &'a mut W,
}
impl<'a> CHKSINIT_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CHKSINIT_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "No effect"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(CHKSINIT_A::_0)
    }
    #[doc = "Initial checksum value by auto reload CRC_SEED register value to CRC_CHECKSUM register value"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(CHKSINIT_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 1 - Checksum Initialization Note: This bit will be cleared automatically."]
    #[inline(always)]
    pub fn chksinit(&self) -> CHKSINIT_R {
        CHKSINIT_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 24 - Write Data Bit Order Reverse This bit is used to enable the bit order reverse function per byte for write data value in CRC_DAT register. Note: If the write data is 0xAABBCCDD, the bit order reverse for CRC write data in is 0x55DD33BB."]
    #[inline(always)]
    pub fn datrev(&self) -> DATREV_R {
        DATREV_R::new(((self.bits >> 24) & 0x01) != 0)
    }
    #[doc = "Bit 25 - Checksum Bit Order Reverse This bit is used to enable the bit order reverse function for checksum result in CRC_CHECKSUM register. Note: If the checksum result is 0xDD7B0F2E, the bit order reverse for CRC checksum is 0x74F0DEBB."]
    #[inline(always)]
    pub fn chksrev(&self) -> CHKSREV_R {
        CHKSREV_R::new(((self.bits >> 25) & 0x01) != 0)
    }
    #[doc = "Bit 26 - Write Data 1's Complement This bit is used to enable the 1's complement function for write data value in CRC_DAT register."]
    #[inline(always)]
    pub fn datfmt(&self) -> DATFMT_R {
        DATFMT_R::new(((self.bits >> 26) & 0x01) != 0)
    }
    #[doc = "Bit 27 - Checksum 1's Complement This bit is used to enable the 1's complement function for checksum result in CRC_CHECKSUM register."]
    #[inline(always)]
    pub fn chksfmt(&self) -> CHKSFMT_R {
        CHKSFMT_R::new(((self.bits >> 27) & 0x01) != 0)
    }
    #[doc = "Bits 28:29 - CPU Write Data Length This field indicates the write data length. Note: When the write data length is 8-bit mode, the valid data in CRC_DAT register is only DATA\\[7:0\\]
bits; if the write data length is 16-bit mode, the valid data in CRC_DAT register is only DATA\\[15:0\\]."]
    #[inline(always)]
    pub fn datlen(&self) -> DATLEN_R {
        DATLEN_R::new(((self.bits >> 28) & 0x03) as u8)
    }
    #[doc = "Bits 30:31 - CRC Polynomial Mode This field indicates the CRC operation polynomial mode."]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 1 - Checksum Initialization Note: This bit will be cleared automatically."]
    #[inline(always)]
    pub fn chksinit(&mut self) -> CHKSINIT_W {
        CHKSINIT_W { w: self }
    }
    #[doc = "Bit 24 - Write Data Bit Order Reverse This bit is used to enable the bit order reverse function per byte for write data value in CRC_DAT register. Note: If the write data is 0xAABBCCDD, the bit order reverse for CRC write data in is 0x55DD33BB."]
    #[inline(always)]
