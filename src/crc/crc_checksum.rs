...
impl From<crate::R<CRC_CHECKSUM_SPEC>> for R {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:31 - CRC Checksum Results This field indicates the CRC checksum result."]
    #[inline(always)]
...
#[doc = "`reset()` method sets CRC_CHECKSUM to value 0xffff_ffff"]
