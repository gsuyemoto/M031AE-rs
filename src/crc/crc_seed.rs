...
impl From<crate::R<CRC_SEED_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<CRC_SEED_SPEC>> for W {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:31 - CRC Seed Value This field indicates the CRC seed value. Note: This field will be reloaded as checksum initial value (CRC_CHECKSUM register) after perform CHKSINIT (CRC_CTL\\[1\\])."]
    #[inline(always)]
