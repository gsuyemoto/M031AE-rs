#[doc = "Register `QSPIx_FIFOCTL` reader"]
pub struct R(crate::R<QSPIX_FIFOCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<QSPIX_FIFOCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<QSPIX_FIFOCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<QSPIX_FIFOCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `QSPIx_FIFOCTL` writer"]
pub struct W(crate::W<QSPIX_FIFOCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<QSPIX_FIFOCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<QSPIX_FIFOCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<QSPIX_FIFOCTL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Receive Reset\n\nValue on reset: 0"]
...
#[doc = "Receive Time-out Interrupt Enable Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXTOIEN_A {
...
#[doc = "Field `RXTOIEN` reader - Receive Time-out Interrupt Enable Bit"]
...
#[doc = "Field `RXTOIEN` writer - Receive Time-out Interrupt Enable Bit"]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TXUFPOL_A {
    #[doc = "0: The QSPI data out is keep 0 if there is TX underflow event in Slave mode"]
    _0 = 0,
    #[doc = "1: The QSPI data out is keep 1 if there is TX underflow event in Slave mode"]
    _1 = 1,
}
...
impl<'a> TXUFPOL_W<'a> {
    ...
    #[doc = "The QSPI data out is keep 0 if there is TX underflow event in Slave mode"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(TXUFPOL_A::_0)
    }
    #[doc = "The QSPI data out is keep 1 if there is TX underflow event in Slave mode"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 1 - Transmit Reset Note: If TX underflow event occurs in QSPI Slave mode, this bit can be used to make QSPI return to idle state."]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Receive Time-out Interrupt Enable Bit"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - TX Underflow Data Polarity Note 1: The TX underflow event occurs if there is no any data in TX FIFO when the slave selection signal is active. Note 2: When TX underflow event occurs, QSPIx_MISO pin state will be determined by this setting even though TX FIFO is not empty afterward. Data stored in TX FIFO will be sent through QSPIx_MISO pin in the next transfer frame."]
    #[inline(always)]
    pub fn txufpol(&self) -> TXUFPOL_R {
        TXUFPOL_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 7 - TX Underflow Interrupt Enable Bit When TX underflow event occurs in Slave mode, TXUFIF (QSPIx_STATUS\\[19\\]) will be set to 1. This bit is used to enable the TX underflow interrupt."]
    #[inline(always)]
    pub fn txufien(&self) -> TXUFIEN_R {
        TXUFIEN_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    #[doc = "Bit 8 - Receive FIFO Buffer Clear Note: The RX shift register will not be cleared."]
    #[inline(always)]
    pub fn rxfbclr(&self) -> RXFBCLR_R {
        RXFBCLR_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - Transmit FIFO Buffer Clear Note: The TX shift register will not be cleared."]
    #[inline(always)]
    pub fn txfbclr(&self) -> TXFBCLR_R {
        TXFBCLR_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bits 24:26 - Receive FIFO Threshold If the valid data count of the receive FIFO buffer is larger than the RXTH setting, the RXTHIF bit will be set to 1, else the RXTHIF bit will be cleared to 0."]
    #[inline(always)]
    pub fn rxth(&self) -> RXTH_R {
        RXTH_R::new(((self.bits >> 24) & 0x07) as u8)
    }
    #[doc = "Bits 28:30 - Transmit FIFO Threshold If the valid data count of the transmit FIFO buffer is less than or equal to the TXTH setting, the TXTHIF bit will be set to 1, else the TXTHIF bit will be cleared to 0."]
    #[inline(always)]
...
#[doc = "QSPI FIFO Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [qspix_fifoctl](index.html) module"]
pub struct QSPIX_FIFOCTL_SPEC;
impl crate::RegisterSpec for QSPIX_FIFOCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [qspix_fifoctl::R](R) reader structure"]
impl crate::Readable for QSPIX_FIFOCTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [qspix_fifoctl::W](W) writer structure"]
impl crate::Writable for QSPIX_FIFOCTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets QSPIx_FIFOCTL to value 0x4400_0000"]
impl crate::Resettable for QSPIX_FIFOCTL_SPEC {
    #[inline(always)]
