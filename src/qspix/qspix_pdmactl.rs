#[doc = "Register `QSPIx_PDMACTL` reader"]
pub struct R(crate::R<QSPIX_PDMACTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<QSPIX_PDMACTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<QSPIX_PDMACTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<QSPIX_PDMACTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `QSPIx_PDMACTL` writer"]
pub struct W(crate::W<QSPIX_PDMACTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<QSPIX_PDMACTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<QSPIX_PDMACTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<QSPIX_PDMACTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum PDMARST_A {
    #[doc = "0: No effect"]
    _0 = 0,
    #[doc = "1: Reset the PDMA control logic of the QSPI controller. This bit will be automatically cleared to 0"]
    _1 = 1,
}
...
impl<'a> PDMARST_W<'a> {
    ...
    #[doc = "Reset the PDMA control logic of the QSPI controller. This bit will be automatically cleared to 0"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - Transmit PDMA Enable Bit Note: In QSPI Master mode with full duplex transfer, if both TX and RX PDMA functions are enabled, RX PDMA function cannot be enabled prior to TX PDMA function. User can enable TX PDMA function firstly or enable both functions simultaneously."]
    #[inline(always)]
...
#[doc = "QSPI PDMA Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [qspix_pdmactl](index.html) module"]
pub struct QSPIX_PDMACTL_SPEC;
impl crate::RegisterSpec for QSPIX_PDMACTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [qspix_pdmactl::R](R) reader structure"]
impl crate::Readable for QSPIX_PDMACTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [qspix_pdmactl::W](W) writer structure"]
impl crate::Writable for QSPIX_PDMACTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets QSPIx_PDMACTL to value 0"]
impl crate::Resettable for QSPIX_PDMACTL_SPEC {
    #[inline(always)]
