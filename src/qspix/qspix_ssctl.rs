#[doc = "Register `QSPIx_SSCTL` reader"]
pub struct R(crate::R<QSPIX_SSCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<QSPIX_SSCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<QSPIX_SSCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<QSPIX_SSCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `QSPIx_SSCTL` writer"]
pub struct W(crate::W<QSPIX_SSCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<QSPIX_SSCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<QSPIX_SSCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<QSPIX_SSCTL_SPEC>) -> Self {
        W(writer)
    }
}
...
impl<'a> SS_W<'a> {
    ...
    #[doc = "set the QSPIx_SS line to inactive state.\nKeep the QSPIx_SS line at inactive state"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SS_A::_0)
    }
    #[doc = "set the QSPIx_SS line to active state.\nQSPIx_SS line will be automatically driven to active state for the duration of data transfer, and will be driven to inactive state for the rest of the time. The active state of QSPIx_SS is specified in SSACTPOL (QSPIx_SSCTL\\[2\\])"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SSACTPOL_A {
    #[doc = "0: The slave selection signal QSPIx_SS is active low"]
    _0 = 0,
    #[doc = "1: The slave selection signal QSPIx_SS is active high"]
    _1 = 1,
}
...
impl<'a> SSACTPOL_W<'a> {
    ...
    #[doc = "The slave selection signal QSPIx_SS is active low"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SSACTPOL_A::_0)
    }
    #[doc = "The slave selection signal QSPIx_SS is active high"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum AUTOSS_A {
    #[doc = "0: Automatic slave selection function Disabled. Slave selection signal will be asserted/de-asserted according to SS (QSPIx_SSCTL\\[0\\])"]
    _0 = 0,
...
impl<'a> AUTOSS_W<'a> {
    ...
    #[doc = "Automatic slave selection function Disabled. Slave selection signal will be asserted/de-asserted according to SS (QSPIx_SSCTL\\[0\\])"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
#[doc = "Field `SLV3WIRE` reader - Slave 3-wire Mode Enable Bit\nIn Slave 3-wire mode, the QSPI controller can work with 3-wire interface including QSPIx_CLK, QSPIx_MISO and QSPIx_MOSI pins."]
...
#[doc = "Field `SLV3WIRE` writer - Slave 3-wire Mode Enable Bit\nIn Slave 3-wire mode, the QSPI controller can work with 3-wire interface including QSPIx_CLK, QSPIx_MISO and QSPIx_MOSI pins."]
...
#[doc = "Slave Mode Time-out Interrupt Enable Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SLVTOIEN_A {
...
#[doc = "Field `SLVTOIEN` reader - Slave Mode Time-out Interrupt Enable Bit"]
...
#[doc = "Field `SLVTOIEN` writer - Slave Mode Time-out Interrupt Enable Bit"]
...
#[doc = "Slave Mode Time-out Reset Control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SLVTORST_A {
...
#[doc = "Field `SLVTORST` reader - Slave Mode Time-out Reset Control"]
...
#[doc = "Field `SLVTORST` writer - Slave Mode Time-out Reset Control"]
...
#[doc = "Field `SLVTOCNT` writer - Slave Mode Time-out Period\nIn Slave mode, these bits indicate the time-out period when there is bus clock input during slave select active. The clock source of the time-out counter is Slave peripheral clock. If the value is 0, it indicates the slave mode time-out function is disabled."]
...
impl R {
    ...
    #[doc = "Bit 2 - Slave Selection Active Polarity This bit defines the active polarity of slave selection signal (QSPIx_SS)."]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Slave 3-wire Mode Enable Bit In Slave 3-wire mode, the QSPI controller can work with 3-wire interface including QSPIx_CLK, QSPIx_MISO and QSPIx_MOSI pins."]
    #[inline(always)]
    pub fn slv3wire(&self) -> SLV3WIRE_R {
        SLV3WIRE_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Slave Mode Time-out Interrupt Enable Bit"]
    #[inline(always)]
    pub fn slvtoien(&self) -> SLVTOIEN_R {
        SLVTOIEN_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - Slave Mode Time-out Reset Control"]
    #[inline(always)]
    ...
    #[doc = "Bits 16:31 - Slave Mode Time-out Period In Slave mode, these bits indicate the time-out period when there is bus clock input during slave select active. The clock source of the time-out counter is Slave peripheral clock. If the value is 0, it indicates the slave mode time-out function is disabled."]
    #[inline(always)]
...
#[doc = "QSPI Slave Select Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [qspix_ssctl](index.html) module"]
pub struct QSPIX_SSCTL_SPEC;
impl crate::RegisterSpec for QSPIX_SSCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [qspix_ssctl::R](R) reader structure"]
impl crate::Readable for QSPIX_SSCTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [qspix_ssctl::W](W) writer structure"]
impl crate::Writable for QSPIX_SSCTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets QSPIx_SSCTL to value 0"]
impl crate::Resettable for QSPIX_SSCTL_SPEC {
    #[inline(always)]
