#[doc = "Register `QSPIx_STATUS` reader"]
pub struct R(crate::R<QSPIX_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<QSPIX_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<QSPIX_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<QSPIX_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `QSPIx_STATUS` writer"]
pub struct W(crate::W<QSPIX_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<QSPIX_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<QSPIX_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<QSPIX_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum BUSY_A {
    #[doc = "0: QSPI controller is in idle state"]
    _0 = 0,
    #[doc = "1: QSPI controller is in busy state"]
    _1 = 1,
}
...
pub enum UNITIF_A {
    ...
    _0 = 0,
    #[doc = "1: QSPI controller has finished one unit transfer"]
    _1 = 1,
}
...
impl<'a> UNITIF_W<'a> {
    ...
    #[doc = "QSPI controller has finished one unit transfer"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SSACTIF_A {
    #[doc = "0: Slave select active interrupt was cleared or not occurred"]
    _0 = 0,
    #[doc = "1: Slave select active interrupt event occurred"]
    _1 = 1,
}
...
impl<'a> SSACTIF_W<'a> {
    ...
    #[doc = "Slave select active interrupt was cleared or not occurred"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SSACTIF_A::_0)
    }
    #[doc = "Slave select active interrupt event occurred"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SSINAIF_A {
    #[doc = "0: Slave select inactive interrupt was cleared or not occurred"]
    _0 = 0,
    #[doc = "1: Slave select inactive interrupt event occurred"]
    _1 = 1,
}
...
impl<'a> SSINAIF_W<'a> {
    ...
    #[doc = "Slave select inactive interrupt was cleared or not occurred"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SSINAIF_A::_0)
    }
    #[doc = "Slave select inactive interrupt event occurred"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "Field `SLVTOIF` reader - Slave Time-out Interrupt Flag \nWhen the slave select is active and the value of SLVTOCNT is not 0, if the bus clock is detected, the slave time-out counter in QSPI controller logic will be started. When the value of time-out counter is greater than or equal to the value of SLVTOCNT (QSPIx_SSCTL\\[31:16\\]) before one transaction is done, the slave time-out interrupt event will be asserted.\nNote: This bit will be cleared by writing 1 to it."]
...
#[doc = "Field `SLVTOIF` writer - Slave Time-out Interrupt Flag \nWhen the slave select is active and the value of SLVTOCNT is not 0, if the bus clock is detected, the slave time-out counter in QSPI controller logic will be started. When the value of time-out counter is greater than or equal to the value of SLVTOCNT (QSPIx_SSCTL\\[31:16\\]) before one transaction is done, the slave time-out interrupt event will be asserted.\nNote: This bit will be cleared by writing 1 to it."]
...
pub enum SLVBEIF_A {
    ...
    _0 = 0,
    #[doc = "1: Slave mode bit count error event occurred"]
    _1 = 1,
}
...
impl<'a> SLVBEIF_W<'a> {
    ...
    #[doc = "Slave mode bit count error event occurred"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
pub enum SLVURIF_A {
    ...
    _0 = 0,
    #[doc = "1: Slave TX under run event occurred"]
    _1 = 1,
}
...
impl<'a> SLVURIF_W<'a> {
    ...
    #[doc = "Slave TX under run event occurred"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXTHIF_A {
    #[doc = "0: The valid data count within the receive FIFO buffer is smaller than or equal to the setting value of RXTH"]
    _0 = 0,
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXOVIF_A {
    #[doc = "0: No FIFO is overrun"]
    _0 = 0,
    #[doc = "1: Receive FIFO is overrun"]
    _1 = 1,
}
...
impl<'a> RXOVIF_W<'a> {
    ...
    #[doc = "No FIFO is overrun"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(RXOVIF_A::_0)
    }
    #[doc = "Receive FIFO is overrun"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
pub enum RXTOIF_A {
    ...
    _0 = 0,
    #[doc = "1: Receive FIFO buffer is not empty and no read operation on receive FIFO buffer over 64 QSPI peripheral clock periods in Master mode or over 576 QSPI peripheral clock periods in Slave mode. When the received FIFO buffer is read by software, the time-out status will be cleared automatically"]
    _1 = 1,
}
...
impl<'a> RXTOIF_W<'a> {
    ...
    #[doc = "Receive FIFO buffer is not empty and no read operation on receive FIFO buffer over 64 QSPI peripheral clock periods in Master mode or over 576 QSPI peripheral clock periods in Slave mode. When the received FIFO buffer is read by software, the time-out status will be cleared automatically"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "Field `SPIENSTS` reader - QSPI Enable Status (Read Only)\nNote: The QSPI peripheral clock is asynchronous with the system clock. In order to make sure the QSPI control logic is disabled, this bit indicates the real status of QSPI controller."]
...
impl R {
    ...
    #[doc = "Bit 1 - Unit Transfer Interrupt Flag Note: This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    pub fn unitif(&self) -> UNITIF_R {
        UNITIF_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Slave Select Active Interrupt Flag Note: Only available in Slave mode. This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    pub fn ssactif(&self) -> SSACTIF_R {
        SSACTIF_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - Slave Select Inactive Interrupt Flag Note: Only available in Slave mode. This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    pub fn ssinaif(&self) -> SSINAIF_R {
        SSINAIF_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - Slave Select Line Bus Status (Read Only) Note: This bit is only available in Slave mode. If SSACTPOL (QSPIx_SSCTL\\[2\\]) is set 0, and the SSLINE is 1, the QSPI slave select is in inactive status."]
    #[inline(always)]
    pub fn ssline(&self) -> SSLINE_R {
        SSLINE_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Slave Time-out Interrupt Flag When the slave select is active and the value of SLVTOCNT is not 0, if the bus clock is detected, the slave time-out counter in QSPI controller logic will be started. When the value of time-out counter is greater than or equal to the value of SLVTOCNT (QSPIx_SSCTL\\[31:16\\]) before one transaction is done, the slave time-out interrupt event will be asserted. Note: This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    pub fn slvtoif(&self) -> SLVTOIF_R {
        SLVTOIF_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - Slave Mode Bit Count Error Interrupt Flag In Slave mode, when the slave select line goes to inactive state, if bit counter is mismatch with DWIDTH, this interrupt flag will be set to 1. Note: If the slave select active but there is no any bus clock input, the SLVBEIF also active when the slave select goes to inactive state. This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    pub fn slvbeif(&self) -> SLVBEIF_R {
        SLVBEIF_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 7 - Slave Mode TX Under Run Interrupt Flag In Slave mode, if TX underflow event occurs and the slave select line goes to inactive state, this interrupt flag will be set to 1. Note: This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - Receive FIFO Overrun Interrupt Flag When the receive FIFO buffer is full, the follow-up data will be dropped and this bit will be set to 1. Note: This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    pub fn rxovif(&self) -> RXOVIF_R {
        RXOVIF_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 12 - Receive Time-out Interrupt Flag Note: This bit will be cleared by writing 1 to it."]
    #[inline(always)]
    pub fn rxtoif(&self) -> RXTOIF_R {
        RXTOIF_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 15 - QSPI Enable Status (Read Only) Note: The QSPI peripheral clock is asynchronous with the system clock. In order to make sure the QSPI control logic is disabled, this bit indicates the real status of QSPI controller."]
    #[inline(always)]
...
#[doc = "QSPI Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [qspix_status](index.html) module"]
pub struct QSPIX_STATUS_SPEC;
impl crate::RegisterSpec for QSPIX_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [qspix_status::R](R) reader structure"]
impl crate::Readable for QSPIX_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [qspix_status::W](W) writer structure"]
impl crate::Writable for QSPIX_STATUS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets QSPIx_STATUS to value 0x0005_0110"]
impl crate::Resettable for QSPIX_STATUS_SPEC {
    #[inline(always)]
