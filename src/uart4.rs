...
pub struct RegisterBlock {
    ...
    #[doc = "0x24 - UART Baud Rate Divider Register"]
    ...
    _reserved13: [u8; 0x08],
    #[doc = "0x3c - UART Baud Rate Compensation Register"]
    pub uart_brcomp: crate::Reg<uart_brcomp::UART_BRCOMP_SPEC>,
    #[doc = "0x40 - UART Wake-up Control Register"]
    pub uart_wkctl: crate::Reg<uart_wkctl::UART_WKCTL_SPEC>,
    #[doc = "0x44 - UART Wake-up Status Register"]
    pub uart_wksts: crate::Reg<uart_wksts::UART_WKSTS_SPEC>,
    #[doc = "0x48 - UART Incoming Data Wake-up Compensation Register"]
    pub uart_dwkcomp: crate::Reg<uart_dwkcomp::UART_DWKCOMP_SPEC>,
}
...
#[doc = "UART_BRCOMP register accessor: an alias for `Reg<UART_BRCOMP_SPEC>`"]
pub type UART_BRCOMP = crate::Reg<uart_brcomp::UART_BRCOMP_SPEC>;
#[doc = "UART Baud Rate Compensation Register"]
pub mod uart_brcomp;
#[doc = "UART_WKCTL register accessor: an alias for `Reg<UART_WKCTL_SPEC>`"]
pub type UART_WKCTL = crate::Reg<uart_wkctl::UART_WKCTL_SPEC>;
#[doc = "UART Wake-up Control Register"]
pub mod uart_wkctl;
#[doc = "UART_WKSTS register accessor: an alias for `Reg<UART_WKSTS_SPEC>`"]
pub type UART_WKSTS = crate::Reg<uart_wksts::UART_WKSTS_SPEC>;
#[doc = "UART Wake-up Status Register"]
pub mod uart_wksts;
#[doc = "UART_DWKCOMP register accessor: an alias for `Reg<UART_DWKCOMP_SPEC>`"]
pub type UART_DWKCOMP = crate::Reg<uart_dwkcomp::UART_DWKCOMP_SPEC>;
#[doc = "UART Incoming Data Wake-up Compensation Register"]
pub mod uart_dwkcomp;
