#[doc = "Register `BPWM_MSKEN` reader"]
pub struct R(crate::R<BPWM_MSKEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BPWM_MSKEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BPWM_MSKEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BPWM_MSKEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BPWM_MSKEN` writer"]
pub struct W(crate::W<BPWM_MSKEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BPWM_MSKEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BPWM_MSKEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BPWM_MSKEN_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MSKEN0_A {
    #[doc = "0: BPWM output signal is non-masked"]
    _0 = 0,
    #[doc = "1: BPWM output signal is masked and output MSKDATn data"]
    _1 = 1,
}
...
#[doc = "Field `MSKEN0` reader - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN0` writer - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
impl<'a> MSKEN0_W<'a> {
    ...
    #[doc = "BPWM output signal is non-masked"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(MSKEN0_A::_0)
    }
    #[doc = "BPWM output signal is masked and output MSKDATn data"]
    #[inline(always)]
...
#[doc = "Field `MSKEN1` reader - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN1` writer - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN2` reader - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN2` writer - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN3` reader - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN3` writer - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN4` reader - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN4` writer - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN5` reader - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
#[doc = "Field `MSKEN5` writer - BPWM Mask Enable Bits\nEach bit n controls the corresponding BPWM channel n.\nThe BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
...
impl R {
    #[doc = "Bit 0 - BPWM Mask Enable Bits Each bit n controls the corresponding BPWM channel n. The BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
    #[inline(always)]
    pub fn msken0(&self) -> MSKEN0_R {
        MSKEN0_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - BPWM Mask Enable Bits Each bit n controls the corresponding BPWM channel n. The BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
    #[inline(always)]
    pub fn msken1(&self) -> MSKEN1_R {
        MSKEN1_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - BPWM Mask Enable Bits Each bit n controls the corresponding BPWM channel n. The BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
    #[inline(always)]
    pub fn msken2(&self) -> MSKEN2_R {
        MSKEN2_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - BPWM Mask Enable Bits Each bit n controls the corresponding BPWM channel n. The BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
    #[inline(always)]
    pub fn msken3(&self) -> MSKEN3_R {
        MSKEN3_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - BPWM Mask Enable Bits Each bit n controls the corresponding BPWM channel n. The BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
    #[inline(always)]
    pub fn msken4(&self) -> MSKEN4_R {
        MSKEN4_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - BPWM Mask Enable Bits Each bit n controls the corresponding BPWM channel n. The BPWM output signal will be masked when this bit is enabled. The corresponding BPWM channel n will output MSKDATn (BPWM_MSK\\[5:0\\]) data."]
    #[inline(always)]
...
#[doc = "BPWM Mask Enable Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [bpwm_msken](index.html) module"]
pub struct BPWM_MSKEN_SPEC;
impl crate::RegisterSpec for BPWM_MSKEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [bpwm_msken::R](R) reader structure"]
impl crate::Readable for BPWM_MSKEN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [bpwm_msken::W](W) writer structure"]
impl crate::Writable for BPWM_MSKEN_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets BPWM_MSKEN to value 0"]
impl crate::Resettable for BPWM_MSKEN_SPEC {
    #[inline(always)]
