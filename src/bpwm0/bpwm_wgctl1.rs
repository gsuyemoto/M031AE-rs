#[doc = "Register `BPWM_WGCTL1` reader"]
pub struct R(crate::R<BPWM_WGCTL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BPWM_WGCTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BPWM_WGCTL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BPWM_WGCTL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BPWM_WGCTL1` writer"]
pub struct W(crate::W<BPWM_WGCTL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BPWM_WGCTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BPWM_WGCTL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BPWM_WGCTL1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum CMPUCTL0_A {
    #[doc = "0: Do nothing"]
    _0 = 0,
    #[doc = "1: BPWM compare up point output Low"]
    _1 = 1,
    #[doc = "2: BPWM compare up point output High"]
    _2 = 2,
    #[doc = "3: BPWM compare up point output Toggle"]
    _3 = 3,
}
...
#[doc = "Field `CMPUCTL0` reader - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL0` writer - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
impl<'a> CMPUCTL0_W<'a> {
    ...
    #[doc = "BPWM compare up point output Low"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(CMPUCTL0_A::_1)
    }
    #[doc = "BPWM compare up point output High"]
    #[inline(always)]
    pub fn _2(self) -> &'a mut W {
        self.variant(CMPUCTL0_A::_2)
    }
    #[doc = "BPWM compare up point output Toggle"]
    #[inline(always)]
...
#[doc = "Field `CMPUCTL1` reader - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL1` writer - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL2` reader - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL2` writer - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL3` reader - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL3` writer - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL4` reader - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL4` writer - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL5` reader - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "Field `CMPUCTL5` writer - BPWM Compare Up Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter up count to CMPDAT."]
...
#[doc = "BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum CMPDCTL0_A {
    #[doc = "0: Do nothing"]
    _0 = 0,
    #[doc = "1: BPWM compare down point output Low"]
    _1 = 1,
    #[doc = "2: BPWM compare down point output High"]
    _2 = 2,
    #[doc = "3: BPWM compare down point output Toggle"]
    _3 = 3,
}
...
#[doc = "Field `CMPDCTL0` reader - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL0` writer - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
impl<'a> CMPDCTL0_W<'a> {
    ...
    #[doc = "BPWM compare down point output Low"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(CMPDCTL0_A::_1)
    }
    #[doc = "BPWM compare down point output High"]
    #[inline(always)]
    pub fn _2(self) -> &'a mut W {
        self.variant(CMPDCTL0_A::_2)
    }
    #[doc = "BPWM compare down point output Toggle"]
    #[inline(always)]
    pub fn _3(self) -> &'a mut W {
...
#[doc = "Field `CMPDCTL1` reader - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL1` writer - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL2` reader - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL2` writer - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL3` reader - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL3` writer - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL4` reader - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL4` writer - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL5` reader - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
#[doc = "Field `CMPDCTL5` writer - BPWM Compare Down Point Control\nEach bit n controls the corresponding BPWM channel n.\nBPWM can control output level when BPWM counter down count to CMPDAT."]
...
impl R {
    #[doc = "Bits 0:1 - BPWM Compare Up Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter up count to CMPDAT."]
    #[inline(always)]
    pub fn cmpuctl0(&self) -> CMPUCTL0_R {
        CMPUCTL0_R::new((self.bits & 0x03) as u8)
    }
    #[doc = "Bits 2:3 - BPWM Compare Up Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter up count to CMPDAT."]
    #[inline(always)]
    pub fn cmpuctl1(&self) -> CMPUCTL1_R {
        CMPUCTL1_R::new(((self.bits >> 2) & 0x03) as u8)
    }
    #[doc = "Bits 4:5 - BPWM Compare Up Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter up count to CMPDAT."]
    #[inline(always)]
    pub fn cmpuctl2(&self) -> CMPUCTL2_R {
        CMPUCTL2_R::new(((self.bits >> 4) & 0x03) as u8)
    }
    #[doc = "Bits 6:7 - BPWM Compare Up Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter up count to CMPDAT."]
    #[inline(always)]
    pub fn cmpuctl3(&self) -> CMPUCTL3_R {
        CMPUCTL3_R::new(((self.bits >> 6) & 0x03) as u8)
    }
    #[doc = "Bits 8:9 - BPWM Compare Up Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter up count to CMPDAT."]
    #[inline(always)]
    pub fn cmpuctl4(&self) -> CMPUCTL4_R {
        CMPUCTL4_R::new(((self.bits >> 8) & 0x03) as u8)
    }
    #[doc = "Bits 10:11 - BPWM Compare Up Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter up count to CMPDAT."]
    #[inline(always)]
    pub fn cmpuctl5(&self) -> CMPUCTL5_R {
        CMPUCTL5_R::new(((self.bits >> 10) & 0x03) as u8)
    }
    #[doc = "Bits 16:17 - BPWM Compare Down Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter down count to CMPDAT."]
    #[inline(always)]
    pub fn cmpdctl0(&self) -> CMPDCTL0_R {
        CMPDCTL0_R::new(((self.bits >> 16) & 0x03) as u8)
    }
    #[doc = "Bits 18:19 - BPWM Compare Down Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter down count to CMPDAT."]
    #[inline(always)]
    pub fn cmpdctl1(&self) -> CMPDCTL1_R {
        CMPDCTL1_R::new(((self.bits >> 18) & 0x03) as u8)
    }
    #[doc = "Bits 20:21 - BPWM Compare Down Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter down count to CMPDAT."]
    #[inline(always)]
    pub fn cmpdctl2(&self) -> CMPDCTL2_R {
        CMPDCTL2_R::new(((self.bits >> 20) & 0x03) as u8)
    }
    #[doc = "Bits 22:23 - BPWM Compare Down Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter down count to CMPDAT."]
    #[inline(always)]
    pub fn cmpdctl3(&self) -> CMPDCTL3_R {
        CMPDCTL3_R::new(((self.bits >> 22) & 0x03) as u8)
    }
    #[doc = "Bits 24:25 - BPWM Compare Down Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter down count to CMPDAT."]
    #[inline(always)]
    pub fn cmpdctl4(&self) -> CMPDCTL4_R {
        CMPDCTL4_R::new(((self.bits >> 24) & 0x03) as u8)
    }
    #[doc = "Bits 26:27 - BPWM Compare Down Point Control Each bit n controls the corresponding BPWM channel n. BPWM can control output level when BPWM counter down count to CMPDAT."]
    #[inline(always)]
...
#[doc = "BPWM Generation Register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [bpwm_wgctl1](index.html) module"]
pub struct BPWM_WGCTL1_SPEC;
impl crate::RegisterSpec for BPWM_WGCTL1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [bpwm_wgctl1::R](R) reader structure"]
impl crate::Readable for BPWM_WGCTL1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [bpwm_wgctl1::W](W) writer structure"]
impl crate::Writable for BPWM_WGCTL1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets BPWM_WGCTL1 to value 0"]
impl crate::Resettable for BPWM_WGCTL1_SPEC {
    #[inline(always)]
