...
impl From<crate::R<UART_ALTCTL_SPEC>> for R {
    #[inline(always)]
...
#[doc = "Field `BRKFL` writer - UART LIN Break Field Length\nThis field indicates a 4-bit LIN TX break field count.\nNote 1: This break field length is BRKFL + 1."]
...
#[doc = "Field `LINRXEN` reader - LIN RX Enable Bit"]
...
#[doc = "Field `LINRXEN` writer - LIN RX Enable Bit"]
...
#[doc = "Field `LINTXEN` reader - LIN TX Break Mode Enable Bit\nNote: When TX break field transfer operation finished, this bit will be cleared automatically."]
...
#[doc = "Field `LINTXEN` writer - LIN TX Break Mode Enable Bit\nNote: When TX break field transfer operation finished, this bit will be cleared automatically."]
...
impl core::ops::Deref for ABRIF_R {
    type Target = crate::FieldReader<bool, ABRIF_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl R {
    #[doc = "Bits 0:3 - UART LIN Break Field Length This field indicates a 4-bit LIN TX break field count. Note 1: This break field length is BRKFL + 1."]
    #[inline(always)]
    pub fn brkfl(&self) -> BRKFL_R {
        BRKFL_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bit 6 - LIN RX Enable Bit"]
    #[inline(always)]
    pub fn linrxen(&self) -> LINRXEN_R {
        LINRXEN_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 7 - LIN TX Break Mode Enable Bit Note: When TX break field transfer operation finished, this bit will be cleared automatically."]
    #[inline(always)]
    pub fn lintxen(&self) -> LINTXEN_R {
        LINTXEN_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    #[doc = "Bit 8 - RS-485 Normal Multi-drop Operation Mode (NMM) Note: It cannot be active with RS-485_AAD operation mode."]
    #[inline(always)]
    pub fn rs485nmm(&self) -> RS485NMM_R {
        RS485NMM_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - RS-485 Auto Address Detection Operation Mode (AAD) Note: It cannot be active with RS-485_NMM operation mode."]
    #[inline(always)]
    pub fn rs485aad(&self) -> RS485AAD_R {
        RS485AAD_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 10 - RS-485 Auto Direction Function (AUD) Note: It can be active with RS-485_AAD or RS-485_NMM operation mode."]
    #[inline(always)]
    pub fn rs485aud(&self) -> RS485AUD_R {
        RS485AUD_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    #[doc = "Bit 15 - RS-485 Address Detection Enable Bit This bit is used to enable RS-485 Address Detection mode. Note: This bit is used for RS-485 any operation mode."]
    #[inline(always)]
    pub fn addrden(&self) -> ADDRDEN_R {
        ADDRDEN_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    #[doc = "Bit 17 - Auto-baud Rate Interrupt Flag (Read Only) This bit is set when auto-baud rate detection function finished or the auto-baud rate counter was overflow and if ABRIEN(UART_INTEN \\[18\\]) is set then the auto-baud rate interrupt will be generated. Note: This bit is read only, but it can be cleared by writing '1' to ABRDTOIF (UART_FIFOSTS\\[2\\]) and ABRDIF(UART_FIFOSTS\\[1\\])."]
    #[inline(always)]
    pub fn abrif(&self) -> ABRIF_R {
        ABRIF_R::new(((self.bits >> 17) & 0x01) != 0)
    }
    #[doc = "Bit 18 - Auto-baud Rate Detect Enable Bit Note : This bit is cleared automatically after auto-baud detection is finished."]
    #[inline(always)]
    pub fn abrden(&self) -> ABRDEN_R {
        ABRDEN_R::new(((self.bits >> 18) & 0x01) != 0)
    }
    #[doc = "Bits 19:20 - Auto-baud Rate Detect Bit Length Note : The calculation of bit number includes the START bit."]
    #[inline(always)]
    pub fn abrdbits(&self) -> ABRDBITS_R {
        ABRDBITS_R::new(((self.bits >> 19) & 0x03) as u8)
    }
    #[doc = "Bits 24:31 - Address Match Value This field contains the RS-485 address match values. Note: This field is used for RS-485 auto address detection mode."]
    #[inline(always)]
