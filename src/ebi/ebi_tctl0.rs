#[doc = "Register `EBI_TCTL0` reader"]
pub struct R(crate::R<EBI_TCTL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EBI_TCTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EBI_TCTL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EBI_TCTL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EBI_TCTL0` writer"]
pub struct W(crate::W<EBI_TCTL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EBI_TCTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EBI_TCTL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EBI_TCTL0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum RAHDOFF_A {
    #[doc = "0: Data Access Hold Time (tAHD) during EBI reading Enabled"]
    _0 = 0,
    #[doc = "1: Data Access Hold Time (tAHD) during EBI reading Disabled"]
    _1 = 1,
}
...
impl<'a> RAHDOFF_W<'a> {
    ...
    #[doc = "Data Access Hold Time (tAHD) during EBI reading Enabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(RAHDOFF_A::_0)
    }
    #[doc = "Data Access Hold Time (tAHD) during EBI reading Disabled"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum WAHDOFF_A {
    #[doc = "0: Data Access Hold Time (tAHD) during EBI writing Enabled"]
    _0 = 0,
    #[doc = "1: Data Access Hold Time (tAHD) during EBI writing Disabled"]
    _1 = 1,
}
...
impl<'a> WAHDOFF_W<'a> {
    ...
    #[doc = "Data Access Hold Time (tAHD) during EBI writing Enabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(WAHDOFF_A::_0)
    }
    #[doc = "Data Access Hold Time (tAHD) during EBI writing Disabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bits 3:7 - EBI Data Access Time TACC defines data access time (tACC)."]
    #[inline(always)]
    pub fn tacc(&self) -> TACC_R {
        TACC_R::new(((self.bits >> 3) & 0x1f) as u8)
    }
    #[doc = "Bits 8:10 - EBI Data Access Hold Time TAHD defines data access hold time (tAHD)."]
    #[inline(always)]
    pub fn tahd(&self) -> TAHD_R {
        TAHD_R::new(((self.bits >> 8) & 0x07) as u8)
    }
    #[doc = "Bits 12:15 - Idle Cycle After Write This field defines the number of W2X idle cycle. Note: When write action is finished, W2X idle cycle is inserted and EBI_nCS return to idle state."]
    #[inline(always)]
    ...
    #[doc = "Bits 24:27 - Idle Cycle Between Read-to-read This field defines the number of R2R idle cycle. Note: When read action is finished and the next action is going to read, R2R idle cycle is inserted and EBI_nCS return to idle state."]
    #[inline(always)]
...
#[doc = "External Bus Interface Bank0 Timing Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ebi_tctl0](index.html) module"]
pub struct EBI_TCTL0_SPEC;
impl crate::RegisterSpec for EBI_TCTL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ebi_tctl0::R](R) reader structure"]
impl crate::Readable for EBI_TCTL0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ebi_tctl0::W](W) writer structure"]
impl crate::Writable for EBI_TCTL0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets EBI_TCTL0 to value 0"]
impl crate::Resettable for EBI_TCTL0_SPEC {
    #[inline(always)]
