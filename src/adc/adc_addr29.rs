#[doc = "Register `ADC_ADDR29` reader"]
pub struct R(crate::R<ADC_ADDR29_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ADC_ADDR29_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ADC_ADDR29_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ADC_ADDR29_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "ADC Data Register 29\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [adc_addr29](index.html) module"]
pub struct ADC_ADDR29_SPEC;
impl crate::RegisterSpec for ADC_ADDR29_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [adc_addr29::R](R) reader structure"]
impl crate::Readable for ADC_ADDR29_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ADC_ADDR29 to value 0"]
impl crate::Resettable for ADC_ADDR29_SPEC {
    #[inline(always)]
