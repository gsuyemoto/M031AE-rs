#[doc = "Register `ADC_ADDR12` reader"]
pub struct R(crate::R<ADC_ADDR12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ADC_ADDR12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ADC_ADDR12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ADC_ADDR12_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "ADC Data Register 12\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [adc_addr12](index.html) module"]
pub struct ADC_ADDR12_SPEC;
impl crate::RegisterSpec for ADC_ADDR12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [adc_addr12::R](R) reader structure"]
impl crate::Readable for ADC_ADDR12_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ADC_ADDR12 to value 0"]
impl crate::Resettable for ADC_ADDR12_SPEC {
    #[inline(always)]
